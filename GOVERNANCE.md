...
| **SEMBAWANG** — *Severe-accident Evolution and Melt Behaviour Analysis Workbench for Advanced Nuclear Geometries* | Severe accident progression — melt behaviour, relocation, vessel failure, MCCI, hydrogen, aerosols, source term. *"What gets released?"* | Reserved name |
