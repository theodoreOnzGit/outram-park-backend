...
- **Commits (non-merge):** 1417
- **Token coverage:** 464/1417 commits carry an `API-Usage-Since-Last-Commit` trailer. Commits before the token-accounting hooks existed (or made outside a Claude session) contribute 0 and are counted here as *no token data* — that is correct, not missing data.
...
| Metric | Lines | KLOC |
|---|--:|--:|
| Added (all files) | 8,197,096 | 8197.1 |
| Removed (all files) | 475,687 | 475.7 |
| **Net (all files)** | **7,721,409** | **7721.4** |
| Added (Rust `.rs`) | 1,249,370 | 1249.4 |
| Net (Rust `.rs`) | 994,030 | 994.0 |
...
| input | 151,159 |
| output | 25,856,223 |
| cache_read | 10,763,594,810 |
| cache_write | 199,191,737 |
| **total** | **10,988,793,929** |
...
| `njoy-outram-park-fork` | 1,873,144 |
| `outram-park-fork-dwsim-libs` | 193,147 |
| `outram-mc-libs` | 150,965 |
| `tampines-steam-tables` | 149,080 |
| `outram-park-digital-twin-engine` | 147,993 |
| `tuas_boussinesq_solver` | 104,342 |
| `outram-park-fork-offbeat` | 96,123 |
| `outram-park-fork-coolprop` | 95,939 |
| `outram-foam-basic-lib` | 89,933 |
| `kovan-literature` | 83,624 |
| `outram-foam-appbuilder-lib` | 72,609 |
| `bedok` | 64,936 |
| `kovan` | 57,162 |
| `outram-blender` | 55,594 |
| `outram-park-fork-pflotran` | 48,239 |
| `tampines` | 46,008 |
| `boon-lay` | 39,862 |
| `openfoam-basic-lib` | 31,842 |
| `outram-foam-mesh` | 20,395 |
...
| 2026-08-17 | `52075bd0c` | docs: remove superseded bedok scoping docs | 0 | 475 | 2,910,015 |
| 2026-08-17 | `dd7de27bd` | bedok is now excluseively Yan ren's project | 1 | 1 | 5,423,020 |
| 2026-08-17 | `a72517da7` | htgr_sim_v1: hardcode the HTR-10 R-Z benchmark zone geometry ... | 448 | 0 | 9,626,640 |
| 2026-08-17 | `efebbd527` | htr10_rz_geometry: split volume 4 into 82/30 at z=114.7 (main... | 36 | 13 | 4,984,536 |
| 2026-08-17 | `0c5a49d04` | htgr_sim_v1: helium gas volumes from the R-Z geometry, wire b... | 256 | 7 | 13,326,320 |
| 2026-08-17 | `b8714b1b2` | htgr_sim_v1: fix tests broken by the feedwater default AUTO -... | 87 | 55 | 24,482,479 |
| 2026-08-17 | `6c3aa9ce0` | added scaffold of single node implict matrix | 269 | 0 | 4,032,848 |
| 2026-08-17 | `f50444630` | htgr_sim_v1: implement PebbleBedPorousMediaNode's implicit 2x... | 329 | 83 | 26,676,690 |
| 2026-08-17 | `1003251fe` | htgr_sim_v1: wire PebbleBedPorousMediaNode in as a new Reacto... | 109 | 9 | 10,314,513 |
| 2026-08-17 | `5fc597f2c` | htgr_sim_v1: OneNodePorousMedia is now default; delete old On... | 321 | 809 | 224,118,817 |
| 2026-08-17 | `c1ef05b10` | htgr sim v1 fixed, and added fast forward | 1,121 | 11 | 0 |
| 2026-08-18 | `e8843121d` | htgr_sim_v1: add an HTR-10 Geometry tab drawing the R-Z bench... | 399 | 18 | 43,648,082 |
| 2026-08-18 | `f7bae9e64` | app_scaffold: add csv_display -- one copyable CSV box, "Copy ... | 173 | 0 | 26,075,888 |
| 2026-08-18 | `f8cc108d1` | htr10_rz_geometry: move volumes 82/30 under 29, restore volum... | 47 | 37 | 19,286,052 |
| 2026-08-18 | `48f5ce43c` | htr10_rz_geometry: 29 shrinks, not 31 -- correct the 82/30 pl... | 41 | 41 | 11,820,426 |
| 2026-08-18 | `9bd5b30ea` | htr10_rz_geometry/geometry_tab: TopReflector material + schem... | 103 | 5 | 36,512,974 |
| 2026-08-18 | `f0a9da662` | geometry_tab: fixed pixel scale (not fit-to-viewport), port v... | 42 | 18 | 10,471,723 |
| 2026-08-18 | `0e863e39e` | htgr_sim_v1: CSV side panel for Time-History Plots, toggled b... | 185 | 12 | 33,794,819 |
| 2026-08-18 | `70afac2d3` | app_scaffold: CsvSnapshotPanel -- snapshot-on-click, interval... | 350 | 49 | 36,745,149 |
| 2026-08-18 | `c8a955fe2` | added csv logging too | 11 | 18 | 1,994,836 |
| 2026-08-18 | `92226a8f4` | csv_display: MAX_CSV_ROWS 1000 -> 4000 (maintainer), measure ... | 72 | 8 | 17,476,871 |
| 2026-08-18 | `c92a051d8` | geometry_tab: zoom in/out/reset buttons; schematic: note the ... | 185 | 24 | 57,106,865 |
| 2026-08-18 | `dd85f4008` | htr10_rz_geometry: volumes 17/46/55/64/72 confirmed Boronated... | 12 | 4 | 21,672,515 |
| 2026-08-18 | `60878e8a4` | geometry_tab: draw same-volume zones as one continuous region... | 156 | 79 | 40,800,824 |
| 2026-08-18 | `11f74c4e0` | CLAUDE.md: add 170-char file-path-length hard rule (Windows M... | 33 | 0 | 49,296,940 |
| 2026-08-18 | `087836707` | tampines-steam-tables, tuas_boussinesq_solver: fix 53 file-pa... | 228 | 162 | 87,041,892 |
| 2026-08-18 | `e8d2ff215` | tuas_boussinesq_solver: migrate all downstream references to ... | 615 | 637 | 26,537,545 |
| 2026-08-19 | `cf342e3fd` | Ingest Zhu (2014) SiC thermal-scattering thesis into kovan-li... | 2,853 | 5 | — |
| 2026-08-20 | `8933cdbfe` | LEAPR: implement generalized coherent-elastic formulation, cl... | 1,225 | 32 | — |
| 2026-08-20 | `672077538` | tampines-steam-tables: interactive T-p/p-h/T-s/h-s steam-tabl... | 10,782 | 1 | — |
| 2026-08-20 | `e11560dd9` | tampines-steam-tables: fix x_ph_flash near-critical Region-3 ... | 30 | 2 | — |
| 2026-08-20 | `5e00e0e0d` | tampines-steam-tables: rename to tampines-steam-tables-gui, t... | 2,597 | 548 | 0 |
| 2026-08-21 | `1a904fc59` | njoy LEAPR: select the temperature block that belongs to the ... | 336 | 8 | — |
| 2026-08-21 | `5a91ecf72` | njoy LEAPR: opt-in CachePolicy for regeneration, per maintain... | 282 | 41 | — |
| 2026-08-21 | `7634ae96e` | tampines-steam-tables: TabulatedData library type + custom qu... | 3,657 | 3,153 | — |
| 2026-08-21 | `33cc638a6` | tampines-steam-tables GUI: replace all-or-nothing isobar/isot... | 297 | 41 | — |
| 2026-08-21 | `fa83715ef` | njoy: root-cause the SiC coherent-elastic residual to the pub... | 892 | 122 | — |
| 2026-08-21 | `12616d8a6` | tampines-steam-tables-gui: top tab bar (Graph/Evaluation/Cita... | 1,248 | 203 | 128,339,892 |
| 2026-08-21 | `caefcd7d5` | tampines-steam-tables-gui: fix tabulated single-phase filter ... | 257 | 24 | 42,997,357 |
| 2026-08-21 | `4779f1652` | tampines-steam-tables-gui: full tabulated isobar/isotherm val... | 467 | 230 | 68,328,627 |
| 2026-08-21 | `73f9d1b25` | added compile examples for windows | 42 | 0 | 9,228,475 |
| 2026-08-21 | `cdf584901` | WORK IN PROGRESS due to token limit: consolidate kovan gui,tu... | 10,043 | 750 | 0 |
| 2026-08-21 | `499922ea2` | kovan: finish crate consolidation, remove old crates, fix sta... | 36 | 12,495 | 0 |
| 2026-08-21 | `e51431a17` | njoy: implement Zhu's exact per-atom-type Debye-Waller option... | 715 | 23 | — |
| 2026-08-21 | `b083cea75` | kovan: relicense to AGPL-3.0-only, add kopitiam-pdf as a crat... | 814 | 2 | — |
| 2026-08-21 | `b38cd88b5` | kovan: relocate the graph digitiser from kovan-literature, de... | 268 | 4,421 | — |
| 2026-08-21 | `e1802fd18` | kovan: restructure to 3 binaries (kovan/kovan-cli/kovan-tui) ... | 1,885 | 1,336 | — |
| 2026-08-21 | `fe240134d` | kovan: PDF rendering engine decision, Gruvbox theming, file p... | 1,370 | 765 | — |
| 2026-08-22 | `454826d15` | githooks: point kovan-bin.sh at kovan-cli, not the GUI binary... | 678 | 144 | 0 |
| 2026-08-22 | `f3c0fa017` | kovan-cli: token savings — cost/outline/slice/skill-gen (GitH... | 515 | 4 | 0 |
| 2026-08-22 | `7eafb645c` | kovan-cli: def/sig/refs -- rust-analyzer-backed semantic quer... | 537 | 10 | 0 |
| 2026-08-22 | `a9f1b6ea1` | kovan-cli: keep-warm rust-analyzer daemon for def/sig/refs (o... | 583 | 142 | 0 |
| 2026-08-23 | `b970b2409` | kovan-gui: fix silent Auto-trace failure, decide OCR engine, ... | 1,882 | 62 | — |
| 2026-08-23 | `a1aad7c4a` | kovan-gui: table digitiser (OCR) + BibTeX parser closing the ... | 12,095 | 49 | — |
| 2026-08-24 | `ebf85ba32` | kovan-gui: unified box interactions, annotation-to-markdown, ... | 1,735 | 323 | — |
| 2026-08-24 | `b2962e7ac` | kovan-gui: parallelogram calibration as an enum sibling of re... | 1,490 | 194 | — |
| 2026-08-25 | `ba9598913` | kovan-gui: upgrade kopitiam-pdf (Type1 glyph fix), PDF reader... | 299 | 18 | — |
| 2026-08-25 | `cf67ecdc4` | kovan: crates.io publish prep for batch 1 (common/discovery/c... | 4,071 | 15 | — |
| 2026-08-25 | `df966e4f9` | kovan: bump kopitiam-pdf 0.2.6 -> 0.2.7 (mandatory hayro fall... | 254 | 9 | 0 |
| 2026-08-25 | `8975b176d` | kovan-gui: PDF reader renders embedded /Annots (Okular highli... | 726 | 0 | 0 |
| 2026-08-25 | `0ea169c3b` | kovan-gui: annotation-visibility diagnostics; root-caused to ... | 454 | 0 | — |
| 2026-08-31 | `b7a9f5671` | tampines-steam-tables: experimental Chebyshev backward correl... | 4,066 | 2 | — |
| 2026-08-31 | `b565c17ea` | tampines-steam-tables: close the Region 4 p(rho,h) test gap; ... | 287 | 24 | — |
| 2026-08-31 | `017f6ba19` | tampines-steam-tables: diagnostics now emit markdown V&V reports | 626 | 18 | — |
| 2026-08-31 | `e7e4faaf8` | tampines-steam-tables: commit the generated V&V reports; keep... | 247 | 25 | — |
| 2026-08-31 | `5e504e3f9` | moved kovan to use v0.3.1 of kopitiam pdf | 733 | 93 | — |
| 2026-08-31 | `7e766a7dc` | kovan: keep/adapt/replace map for the issue #35 wiki redesign | 117 | 0 | — |
| 2026-08-31 | `080bffad1` | kovan: correct the migration map -- the BibTeX parser already... | 30 | 9 | — |
| 2026-08-31 | `c09c1e904` | kovan: fix the library's Android build -- drop kopitiam-pdf d... | 1 | 1 | 36,381,783 |
| 2026-08-31 | `8a7390665` | kovan: KovanRoot -- the Git-backed library root abstraction (... | 613 | 0 | 0 |
| 2026-08-31 | `a708a1732` | kovan: create a Kovan library -- skeleton, .gitignore, git in... | 291 | 0 | 6,319,181 |
| 2026-08-31 | `884fc139d` | kovan: papers, topics and projects as entities (issue #35 ste... | 874 | 0 | 3,764,895 |
| 2026-08-31 | `3c4ccdd99` | kovan: fenced-TOML artifact parser (issue #35 step 12) | 910 | 0 | 5,459,296 |
| 2026-08-31 | `c38e057a8` | Cargo.lock: dedupe eframe/egui/wgpu/ab_glyph/bit-set to singl... | 74 | 709 | — |
| 2026-08-31 | `ba3bea65e` | kovan redesign: root/wiki startup + repository index + PDF in... | 1,298 | 4 | — |
| 2026-09-01 | `a51219faf` | kovan redesign: PaperSession, ResearchRecordIndex, fine-grain... | 2,116 | 43 | — |
| 2026-09-01 | `798f39740` | kovan redesign: citation/wiki autocomplete, PDF<->Markdown Sy... | 1,482 | 6 | — |
| 2026-09-01 | `a67650422` | Bump egui/eframe/wgpu/naga to 0.36/30.0.1 workspace-wide (op-... | 361 | 302 | — |
| 2026-09-01 | `1b88834cc` | kovan: integrate kopitiam-pdf's reusable reader (op-9vo6.11) | 312 | 1,698 | — |
| 2026-09-01 | `e7759d5a2` | kovan: unify Kovan root + active-paper context (op-sr4n.1/.2/... | 297 | 16 | — |
| 2026-09-01 | `91cb7594a` | kovan: fix kvim drag bug, Wiki right-click sort, retire Markd... | 370 | 37 | — |
| 2026-09-01 | `aa111fd9f` | kovan: wire the Save Repository backend to a button (op-nswf) | 35 | 3 | — |
| 2026-09-01 | `8b9cffe5e` | kovan: migrate bibliography.rs onto KovanRoot, retire markdow... | 125 | 459 | — |
| 2026-09-01 | `b790e02df` | kovan: PDF Reader page-context panel as a real artifact list ... | 158 | 31 | — |
| 2026-09-01 | `944e73ab7` | kovan: fix disappearing-paper bug, PDF mode page-state, Annot... | 219 | 0 | — |
| 2026-09-01 | `f8f58d099` | kovan: shared knowledge state, Bibliography row merge, Save R... | 355 | 164 | — |
| 2026-09-01 | `cbb8c7b59` | kovan: wire egui_graphs into the Mindmap, fix its Android-por... | 285 | 107 | — |
| 2026-09-01 | `cebe79e0c` | kovan: move app shell from digitiser::gui::desktop to crate::... | 52 | 15 | — |
| 2026-09-01 | `b64a250ad` | kovan-semantics: add a typed scientific-concept ontology laye... | 3,809 | 146 | — |
| 2026-09-02 | `2c7cfae86` | kovan: decouple document access rights from git storage mode ... | 131 | 2 | — |
| 2026-09-02 | `283b5b569` | kovan: configure a private literature submodule in kovan_root... | 196 | 20 | — |
| 2026-09-02 | `c28afc6c3` | kovan: submodule-aware Save Repository sequencing (op-3gxp) | 335 | 42 | — |
| 2026-09-02 | `1a5b557ec` | kovan: report an unavailable source PDF instead of a silent f... | 164 | 5 | — |
| 2026-09-02 | `4a74851dc` | kovan: digitiser UI dogfooding feedback (op-g864) | 559 | 88 | — |
| 2026-09-02 | `e55f53d8a` | kovan: page-context panel dogfooding — read-only preview, dou... | 1,192 | 189 | — |
| 2026-09-02 | `d18a33978` | kovan: PDF-reader annotation dogfooding fixes (op-9vo6) | 166 | 82 | — |
| 2026-09-02 | `cb9a2881f` | docs: record kopitiam-pdf #106 / #107 in the kopitiam-issues ... | 2 | 0 | — |
| 2026-09-02 | `817019f62` | kovan: continuous multi-page canvas with always-visible, clic... | 484 | 186 | — |
| 2026-09-02 | `fe4237b77` | kovan: a focused kvim editor consumes its keystrokes (op-9vo6) | 20 | 6 | — |
| 2026-09-02 | `ecf8da763` | kovan: drop the embedded reader, one continuous canvas with i... | 273 | 245 | — |
| 2026-09-02 | `e70987754` | kovan: double-click a box to edit; keep the edit panel from v... | 22 | 14 | — |
| 2026-09-02 | `a58479e21` | kovan: hold the page in view across a zoom change (op-9vo6) | 23 | 0 | — |
| 2026-09-02 | `f6acf420a` | kovan: re-render pages at higher DPI on zoom; keep the viewpo... | 74 | 35 | — |
| 2026-09-02 | `6a1da4bf5` | kovan: pointer-anchored zoom, and stop the mouse re-pointing ... | 136 | 32 | — |
| 2026-09-02 | `14c771cda` | kovan: restore the page-thumbnail strip; Ctrl+D/U page step; ... | 200 | 1 | — |
| 2026-09-02 | `3e073e512` | kovan: page jumps set the scroll offset outright, so a view s... | 16 | 9 | — |
| 2026-09-02 | `cc4c7a946` | kovan: Copy button on each bibliography entry (op-9vo6) | 16 | 0 | — |
| 2026-09-02 | `632740414` | kovan: digitiser export UX, page-ordered notes, autocomplete ... | 334 | 71 | — |
| 2026-09-02 | `8145709aa` | kovan-gui: PDF reader — single-click block edit, Pan tool, dr... | 108 | 24 | — |
| 2026-09-02 | `96978974c` | outram-blender: mesh selection + topology adjacency (op-hzs.5... | 1,929 | 0 | — |
| 2026-09-02 | `d21246ea6` | outram-blender: selection — similar/grow/shrink + by-trait (o... | 630 | 4 | — |
| 2026-09-02 | `87fa933a5` | outram-blender: loop cut + knife (op-hzs.54.5, .6) | 677 | 0 | — |
| 2026-09-02 | `71966b066` | outram-blender: edge/vertex slide + N-cut subdivide (op-hzs.5... | 772 | 0 | — |
| 2026-09-02 | `15133949f` | outram-blender: bevel parity + extrude family (op-hzs.54.9, .10) | 637 | 0 | — |
| 2026-09-03 | `682ac3377` | outram-blender: merge modes + rip/split/separate (op-hzs.54.1... | 583 | 0 | — |
| 2026-09-03 | `106fabc74` | outram-blender: dissolve + delete matrix (op-hzs.54.13) | 364 | 0 | — |
| 2026-09-03 | `c0822922d` | outram-blender: bridge edge loops + fill operators (op-hzs.54... | 548 | 0 | — |
| 2026-09-03 | `4974b087b` | outram-blender: connect / poke+quads / edge tools (op-hzs.54.... | 782 | 0 | — |
| 2026-09-03 | `97bf31523` | outram-blender: transform toolset + proportional editing (op-... | 655 | 0 | — |
| 2026-09-03 | `00dac97b8` | outram-blender: mesh symmetry + spin/screw (op-hzs.54.21, .22) | 498 | 0 | — |
| 2026-09-03 | `cc190abfb` | outram-blender: transform-input model + snapping engine (op-h... | 874 | 0 | — |
| 2026-09-03 | `7c6b992cf` | outram-blender: 3D cursor/pivots + measurement & inspection (... | 916 | 0 | — |
| 2026-09-03 | `a31076dca` | outram-blender: normals toolset + attribute layer (op-hzs.54.... | 689 | 19 | — |
| 2026-09-03 | `a0b70a999` | outram-blender: generate modifiers pt.1 (op-hzs.54.29) | 186 | 3 | — |
| 2026-09-03 | `61d59bdac` | outram-blender: voxel remesh + generate modifiers pt.2 (op-hz... | 454 | 0 | — |
| 2026-09-03 | `b9a695a88` | outram-blender: deform modifiers pt.1 (op-hzs.54.31) | 465 | 0 | — |
| 2026-09-03 | `3af0aeec1` | outram-blender: deform modifiers pt.2 + stack semantics (op-h... | 709 | 12 | — |
| 2026-09-03 | `35fbc1182` | outram-blender: curve authoring + curve->surface (op-hzs.54.3... | 950 | 0 | — |
| 2026-09-03 | `eedbced76` | outram-blender: curve<->mesh + NURBS surfaces (op-hzs.54.36, ... | 626 | 0 | — |
| 2026-09-03 | `94a1562aa` | outram-blender: text->geometry + extra mesh primitives (op-hz... | 897 | 0 | — |
| 2026-09-03 | `27282806f` | outram-blender: extra-objects generators + interactive draw t... | 930 | 1 | — |
| 2026-09-03 | `b1b957f29` | outram-blender: LoopTools + Snap Utilities Line (op-hzs.54.42... | 891 | 0 | — |
| 2026-09-03 | `1bd630f86` | outram-blender: Precision Drawing Tools + Bool Tool (op-hzs.5... | 708 | 0 | — |
| 2026-09-03 | `8ad385214` | outram-blender: fill/mirror helpers + object-mode CAD ops (op... | 758 | 0 | — |
| 2026-09-03 | `9c396a490` | outram-blender: array patterns — radial / object-offset / alo... | 362 | 0 | — |
| 2026-09-03 | `da75c3d69` | outram-blender 0.0.3 -> 0.0.4, tampines-steam-tables 0.2.6 ->... | 11 | 11 | — |
| 2026-09-03 | `7da053309` | docs: working-hours guardrail — drop the mandatory per-sessio... | 37 | 34 | — |
| 2026-09-03 | `4d7bdf9f7` | outram-foam: lift the CLI case-driving glue into a reusable l... | 733 | 295 | — |
| 2026-09-03 | `0270f65ba` | outram-foam-basic-lib: real WGSL kernels for the LDU sparse p... | 1,738 | 8 | — |
| 2026-09-03 | `941bb07f9` | outram-foam-basic-lib: WGSL kernels for closed-form polynomia... | 447 | 0 | — |
| 2026-09-03 | `2c3c1ac64` | outram-foam-basic-lib: data-level CPU/GPU co-execution planne... | 339 | 0 | — |
| 2026-09-04 | `56fba8fc0` | workspace: wasm32-unknown-unknown support — 20/36 -> 27/36 cr... | 522 | 56 | — |
| 2026-09-04 | `58d85e96f` | workspace: wasm32-unknown-unknown gate — 30/30 in-scope crate... | 324 | 6 | — |
| 2026-09-04 | `5fb885571` | workspace: wasm RUNTIME smoke tests — Edwards, helium SG, and... | 787 | 8 | — |
| 2026-09-04 | `403946450` | dwsim: crude distillation from a black-oil characterisation (... | 997 | 0 | — |
| 2026-09-04 | `a54fcee57` | dwsim: record the headless/GUI boundary for the crude sim (op... | 7 | 0 | — |
| 2026-09-04 | `8b6a12b93` | dwsim: the crude column now converges to a physical CDU profi... | 190 | 83 | — |
| 2026-09-04 | `169438455` | dwsim: wire PR78 into CubicEos and PropertyPackageModel (op-1... | 157 | 6 | — |
| 2026-09-04 | `44a200133` | crude epic op-190j: fix the cubic-package solve, add the tran... | 1,215 | 126 | — |
| 2026-09-04 | `5cab9ef75` | mc + njoy: the derives and the concrete seam the Python bindi... | 80 | 3 | — |
| 2026-09-04 | `aad7946ee` | style: workspace-wide `cargo fmt --all` | 7,222 | 2,654 | — |
| 2026-09-04 | `fb94deefe` | dwsim: re-measure the crude column on PR78 — my recorded valu... | 50 | 17 | — |
| 2026-09-04 | `1e8ddb746` | CLAUDE.md: dogfood the Python API on a small model, as a hard... | 60 | 0 | — |
| 2026-09-04 | `6b49dcac0` | CLAUDE.md: "if it's too complex for Haiku, it's a bad API", e... | 18 | 0 | — |
| 2026-09-04 | `5b7f9814e` | CLAUDE.md: point the trait-diagnostics rule at its own bead | 10 | 1 | — |
| 2026-09-04 | `4e5273e02` | tampines: record real-time-via-surrogate as the design intent... | 44 | 0 | — |
| 2026-09-05 | `4e802927e` | Expose the local-ENDF seam, and make the prelude the taught path | 608 | 5 | — |
| 2026-09-05 | `00dbf66c3` | Gate the API-dogfooding rule behind a per-crate maturity decl... | 67 | 2 | — |
| 2026-09-05 | `7d4a70533` | Declare eight crates mature, and fix the preludes that declar... | 373 | 0 | — |
| 2026-09-05 | `e86242890` | Verify every declared crate's test count, and correct the tam... | 56 | 22 | — |
| 2026-09-05 | `50f0d10bd` | tampines: mark the Peng-Robinson EOS gap out of scope | 5 | 3 | — |
| 2026-09-05 | `d1083280b` | teh-o-prke: tutorial example for a reactivity insertion trans... | 283 | 0 | — |
| 2026-09-05 | `d065d1913` | outram-mc-libs: tally tutorial, and the API docs its friction... | 887 | 1 | — |
| 2026-09-05 | `cbb29b65c` | njoy: resonance/Doppler tutorial, corrected physics, prelude ... | 273 | 116 | — |
...
| 2026-09-10 | `fd833197d` | njoy: port NRO=1 scattering radius for LRU=2; verify UNRESR/P... | 440 | 39 | — |
| 2026-09-10 | `9df9cc9c4` | njoy: THERMR temperature interpolation on evaluated quantitie... | 292 | 65 | — |
| 2026-09-10 | `32c1aadf4` | njoy: split heatr/mod.rs and wmp.rs under the file-size cap (... | 2,901 | 2,792 | — |
| 2026-09-10 | `b1b7c80ac` | njoy: first GROUPR golden-file validation vs an NJOY2016 GEND... | 1,056 | 5 | — |
| 2026-09-10 | `95664653d` | njoy: GROUPR URR self-shielding validated vs NJOY GENDF; fix ... | 645 | 25 | — |
| 2026-09-10 | `660e97714` | njoy: GROUPR flux calculator validated vs NJOY GENDF; three g... | 694 | 20 | — |
| 2026-09-10 | `15986d0d0` | njoy: make the U-238 Doppler RRR L1 a hard gate, re-baselined... | 77 | 47 | — |
| 2026-09-10 | `a131f4f0f` | njoy: split purr/mod.rs at the ladder/unrest boundary (op-cjw.8) | 1,477 | 1,361 | — |
| 2026-09-10 | `142bd953b` | njoy: ERRORR MF=33 path ported end to end, validated vs nine ... | 49,605 | 61 | — |
| 2026-09-10 | `21e251ef0` | njoy: BROADR adaptive grid (broadn) + ENDF E-exponent parser ... | 776 | 60 | — |
| 2026-09-10 | `582beeced` | njoy: ERRORR covout writes sub-eps interior elements verbatim... | 10 | 4 | — |
...
| 2026-09-11 | `2d8a8158e` | farrer-park: vendor upstreams, record provenance, correct the... | 1,016 | 43 | — |
| 2026-09-11 | `8eaf6c1b7` | WIP farrer-park: locking scratch harness (agent mid-flight, o... | 176 | 1 | — |
| 2026-09-11 | `2c32b45ae` | farrer-park: B-bar locking treatment and plane stress, both v... | 2,254 | 135 | — |
| 2026-09-11 | `05f1ebf95` | farrer-park: finish B-bar and plane stress; record the two ne... | 192 | 9 | — |
| 2026-09-11 | `c68c8f8ab` | WIP farrer-park: crystal-plasticity core (agent mid-flight, s... | 2,400 | 4 | — |
| 2026-09-11 | `475d15a62` | farrer-park: crystal-plasticity verification suite; tangent q... | 1,515 | 175 | — |
| 2026-09-11 | `2b81c46af` | WIP farrer-park: Fatemi-Socie FIP module (agent mid-flight, s... | 856 | 7 | — |
| 2026-09-11 | `e95556e16` | outram-mc: generalise the NJOY PENDF oracle, and add a nu-bar... | 29 | 5 | — |
| 2026-09-11 | `d055dbbb4` | farrer-park: crystal plasticity done, fatigue partial; docs a... | 942 | 26 | — |
...
| 2026-09-11 | `c356cf255` | outram-mc: sample free-gas target motion (op-50vu), and three... | 1,744 | 261 | — |
| 2026-09-11 | `1572497ff` | outram-mc: the explicit pebble was packed 2.6% over the deck ... | 455 | 141 | — |
| 2026-09-11 | `3f19593c3` | outram-mc: report the six factors in OpenMC's two-group conve... | 34 | 7 | — |
| 2026-09-11 | `a64af039e` | outram-mc: test resonance SELF-SHIELDING, and match the deck'... | 325 | 6 | — |
| 2026-09-11 | `3cef3bb87` | outram-mc: exclude the last two mechanisms — resonance shape,... | 220 | 33 | — |
| 2026-09-11 | `6927f9e54` | ring-rpt V&V: the thermal-benchmark blocker is the spec, not ... | 20 | 4 | — |
| 2026-09-11 | `86df672a8` | outram-mc: rebuild NJOY2016 and verify every remaining nuclid... | 61 | 10 | — |
| 2026-09-11 | `9b5180169` | outram-mc: check the graphite S(a,b) KERNEL against NJOY, not... | 301 | 13 | — |
| 2026-09-11 | `646d4d248` | ring-rpt V&V: localise the residual to one scalar, and check ... | 53 | 6 | — |
| 2026-09-11 | `97b2eacb3` | ring-rpt V&V: close the moderating-power branch, and record t... | 87 | 7 | — |
| 2026-09-11 | `ea635dd3f` | outram-mc: a THERMAL criticality benchmark — HEU-SOL-THERM-00... | 37,495 | 29 | — |
| 2026-09-11 | `54cc84adf` | outram-mc: a U-238-DOMINATED criticality benchmark — Jemima, ... | 335 | 11 | — |
| 2026-09-11 | `ec865ef34` | outram-mc: the +4004 pcm is OURS — LEU-COMP-THERM-008, +2950 ... | 13,451 | 23 | — |
| 2026-09-11 | `d5908bf63` | outram-mc: the hunt's lessons as regression tests — and the r... | 2,114 | 5 | — |
| 2026-09-11 | `d4b0da78f` | outram-mc: the SPATIAL half is sound too — and a boundary con... | 847 | 2 | — |
| 2026-09-11 | `ecda597cf` | outram-mc: the residual is NOT U-238 resonance escape — it tr... | 2,217 | 52 | — |
| 2026-09-11 | `00a095d8d` | outram-mc: ROOT CAUSE — our H-in-H2O thermal KERNEL moves neu... | 346 | 5 | — |
| 2026-09-11 | `fe2458d74` | outram-mc: every NJOY/analytic oracle from the hunt, as golde... | 1,098 | 3 | — |
| 2026-09-11 | `2a4343afc` | outram-mc: every oracle example asserts its comparison, not j... | 3,021 | 239 | — |
| 2026-09-11 | `667f335cb` | outram-mc: gate the ring-RPT, fingerprint and remaining Godiv... | 426 | 4 | — |
| 2026-09-11 | `0d948a209` | outram-mc: size the lump-scan gate from its own statistics, n... | 17 | 2 | — |
| 2026-09-11 | `0a49852f9` | njoy-fork: the oracle examples assert too, and the gate helpe... | 1,355 | 421 | — |
| 2026-09-11 | `de3910fbf` | njoy-fork: assert the GPU WMP path agrees with the trusted CP... | 55 | 0 | — |
| 2026-09-11 | `2714d4134` | V&V examples: two that couldn't run here, could all along | 172 | 69 | — |
