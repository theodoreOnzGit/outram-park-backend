...
| `dover` | **DOVER** (*Deck-based Open-source Visualisation Engine for Reactors*) — the **low-fidelity counterpart of `dhoby-ghaut`** (maintainer, 2026-09-25; details undecided); **empty skeleton** (added 2026-09-25, after this table was split out; maintainer direction). No code, no public API, no dependencies. Nothing beyond that role is to be inferred from the name. See `crates/dover/CLAUDE.md`. | GPL-3.0 |
