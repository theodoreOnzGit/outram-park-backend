...
| Three-array porous-media component | `crates/tuas_boussinesq_solver/src/lib/pre_built_components/non_insulated_porous_media_fluid_components/` | Fluid array, shell, interior solid matrix with real radial nodal conductances. The correct *structural* template for a pebble bed. **Re-verified 2026-08-12** — path unchanged |
...
- The TUAS porous-media component states its own gap: pressure-drop correlations
  ...
  `crates/tuas_boussinesq_solver/src/lib/pre_built_components/non_insulated_porous_media_fluid_components/mod.rs:60-61`.
