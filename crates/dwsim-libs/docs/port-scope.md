...
list, and the bottom-up porting order. Consulted on demand when picking the next
module to port — not per-turn guidance. The crate's design decisions (units,
trait hierarchy) live in CLAUDE.md.
