...
/// number
#[test]
pub fn dimensionless_darcy_loss_correlation_get_be(
    ...
    let bejan_test = flowmeter_dimensionless_correlation
        .get_bejan_number_from_reynolds(reynolds_number)
        .unwrap();

    approx::assert_relative_eq!(bejan_test.value, 154204505.0, max_relative = 0.001);
    ...
    approx::assert_relative_eq!(bejan_test_reverse.value, -154204505.0, max_relative = 0.001);
...
/// number
#[test]
pub fn dimensionless_darcy_loss_correlation_get_re_from_be(
) -> Result<(), crate::tuas_lib_error::TuasLibError> {
    use uom::si::f64::*;
    use uom::si::ratio::ratio;
    use crate::array_control_vol_and_fluid_component_collections::
    ...
    let reynolds_test = flowmeter_dimensionless_correlation
        .get_reynolds_number_from_bejan(bejan_number)
        .unwrap();

    approx::assert_relative_eq!(reynolds_test.value, 4000.0, max_relative = 0.001);
    ...
    approx::assert_relative_eq!(reynolds_test_reverse.value, -4000.0, max_relative = 0.001);
