...
impl SolidColumn {
    ...
    pub fn get_max_timestep(
        ...
        let solid_volume_in_one_node: Volume = self.front_single_cv.volume;
        ...
        // interactions
        let delta_x_axial: Length = self.total_length / number_of_temperature_nodes as f64;

        let cross_sectional_area: Area = solid_volume_in_one_node / delta_x_axial;
        ...
        let max_conduction_timescale: Time =
            max_mesh_fourier_number * delta_x_minimum * delta_x_minimum / thermal_diffusivity_coeff;
