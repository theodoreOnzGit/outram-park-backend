...
impl CartesianConduction1DArray {
    ...
    pub fn new(
        ...
        let vol_frac_array = array_to_return.construct_volume_fraction_array()?;
        ...
        array_to_return.temperature_array_current_timestep = initial_temperature_array.clone();

        array_to_return.temperature_array_next_timestep = initial_temperature_array;
        ...
        let boundary_cv: SingleCVNode = SingleCVNode::new_one_dimension_volume(
            boundary_length,
            material,
    ...
    ///
    ///
    pub(crate) fn construct_volume_fraction_array(&mut self) -> Result<Array1<f64>, TuasLibError> {
        ...
        let volume_fraction_per_inner_node: f64 = (delta_x / self.total_length).value;

        let mut volume_fraction_array: Array1<f64> = Array::zeros(number_of_temperature_nodes);
        ...
        assert_relative_eq!(1.0, vol_fraction_sum, epsilon = 0.001);
    ...
    ///
    #[inline]
    pub fn get_bulk_temperature(&mut self) -> Result<ThermodynamicTemperature, TuasLibError> {
