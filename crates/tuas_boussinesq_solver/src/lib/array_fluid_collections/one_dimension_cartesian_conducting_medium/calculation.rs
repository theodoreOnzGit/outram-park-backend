...
impl CartesianConduction1DArray {
    ...
    pub fn advance_timestep(&mut self, timestep: Time) -> Result<(), TuasLibError> {
        ...
        // temperature array
        let temperature_array_current_timestep_reference = &self.temperature_array_current_timestep;
        ...
        let volumetric_heat_capacity_array = Self::get_current_timestep_rho_cp(
            material,
            temperature_array_current_timestep_reference,
            pressure,
        )?;
        ...
        self.temperature_array_next_timestep = new_temperature_array.clone();
