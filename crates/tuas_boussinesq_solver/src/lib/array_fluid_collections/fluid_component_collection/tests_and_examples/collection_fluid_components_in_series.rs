...
pub fn simple_fluid_collection_example_5() {
    ...
    use crate::boussinesq_thermophysical_properties::{LiquidMaterial, SolidMaterial};
        ...
        use crate::array_control_vol_and_fluid_component_collections::fluid_component_collection::fluid_component_collection::FluidComponentCollectionOreintation;
    ...
    let therminol_pipe_1: FluidComponent = FluidComponent::FluidArray(FluidArray::new_cylinder(
        length,
        hydraulic_diameter,
        initial_temperature,
        initial_pressure,
    ...
    let series_collection_of_therminol_pipes = FluidComponentCollection {
        components: vec![
            therminol_pipe_1.clone(),
    ...
    let series_pipe_pressure_change =
        series_collection_of_therminol_pipes.get_pressure_change(pipe_fluid_flow);
    ...
    let series_pipe_pressure_loss =
        series_collection_of_therminol_pipes.get_pressure_loss(pipe_fluid_flow);

    assert_eq!(-series_pipe_pressure_change, series_pipe_pressure_loss);
