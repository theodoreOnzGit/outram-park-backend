...
pub fn coriolis_flowmeter_empirical_custom_component_example_3(
    ...
    let coriolis_flowmeter_ptr = Arc::new(Mutex::new(coriolis_flowmeter));
    ...
    let mass_flowrate_fwd_mutable = move || {
        ...
        let mass_flowrate_test = coriolis_flowmeter_ptr_clone_five
            .lock()
            .unwrap()
            .deref_mut()
            .get_mass_flowrate();
    ...
    let mass_flworate_backwd_mutable = move || {
        ...
        let mass_flowrate_test = coriolis_flowmeter_ptr_clone_six
            .lock()
            .unwrap()
            .deref_mut()
            .get_mass_flowrate();
    ...
    let pressure_chg_test_fwd_mutable = move || {
        ...
        let pressure_change_forward_test = coriolis_flowmeter_ptr_clone_seven
            .lock()
            .unwrap()
            .deref_mut()
            .get_pressure_change();
    ...
    let pressure_chg_test_backwd_mutable = move || {
        ...
        coriolis_flowmeter_ptr_clone_eight
            ...
            .deref_mut()
            .set_mass_flowrate(mass_flowrate);
        let pressure_change_reverse_test = coriolis_flowmeter_ptr_clone_eight
            .lock()
            .unwrap()
            .deref_mut()
            .get_pressure_change();
