...
/// regression test
#[test]
pub fn test_custom_fluid_component_pressure_loss() -> Result<(), crate::tuas_lib_error::TuasLibError>
{
...

    {
        ...
        let pressure_loss: Pressure = TestComponent::fluid_custom_component_calc_pressure_loss(
            ...
            fluid_viscosity,
            fluid_density,
            test_component_object.loss_correlation,
        )
        .unwrap();

        // expected pressure loss is 1430 pascals
        approx::assert_relative_eq!(1430.0, pressure_loss.get::<pascal>(), max_relative = 0.01);
    }
...
/// regression test
#[test]
pub fn test_custom_fluid_component_mass_flow_from_pressure_loss(
...

    {
        ...
        let mass_flowrate =
            TestComponent::fluid_custom_component_calc_mass_flowrate_from_pressure_loss(
                input_pressure_loss,
                cross_sectional_area,
                hydraulic_diameter,
                fluid_viscosity,
...
/// regression test
#[test]
pub fn test_custom_fluid_component_pressure_change(
) -> Result<(), crate::tuas_lib_error::TuasLibError> {
    // this tests the calc pressure loss for fluid component
    use uom::si::f64::*;
    use uom::ConstZero;
    ...
    // calculate a pressure loss first, then pressure change
    {
        ...
        let pressure_loss: Pressure =
            test_component_object.get_pressure_loss_immutable(fluid_mass_flowrate);
    ...
    // now pressure change
    {
        ...
        let pressure_change: Pressure = TestComponent::fluid_custom_component_calc_pressure_change(
            fluid_mass_flowrate,
            cross_sectional_area,
            hydraulic_diameter,
            fluid_viscosity,
...
/// regression test
#[test]
pub fn test_custom_fluid_component_mass_flowrate_from_pressure_change(
) -> Result<(), crate::tuas_lib_error::TuasLibError> {
    // this tests the calc pressure loss for fluid component
    use uom::si::f64::*;
    use uom::ConstZero;
