...
use super::{
    solid_database::{
        copper::copper_surf_roughness, fiberglass::fiberglass_surf_roughness,
        pyrogel_hps::pyrogel_hps_surf_roughness,
    },
    Material,
};
...
impl SolidMaterial {
    ...
    pub fn surface_roughness(&self) -> Result<Length, TuasLibError> {
        let roughness: Length = match self {
            ...
            SolidMaterial::Copper => copper_surf_roughness(),
            // Value from: Perry's chemical Engineering handbook
            // 8th edition Table 6-1
            ...
            // Perry’s chemical engineers’ handbook,
            // 8th illustrated ed. New York: McGraw-Hill.
            SolidMaterial::Fiberglass => fiberglass_surf_roughness(),
            // Based on:
            ...
            //
            //
            SolidMaterial::PyrogelHPS => pyrogel_hps_surf_roughness(),
