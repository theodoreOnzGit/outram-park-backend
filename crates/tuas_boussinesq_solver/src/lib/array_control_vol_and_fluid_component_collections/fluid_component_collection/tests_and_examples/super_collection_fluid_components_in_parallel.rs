...
pub fn super_fluid_collection_example_7() {
    ...
    let series_collection_of_therminol_pipes_1 = FluidComponentCollection {
        components: vec![
...

    {
        ...
        let super_collection_mass_flowrate =
            super_collection.get_mass_flowrate_from_pressure_change(test_pressure);
        ...
        let super_collection_pressure_change =
            super_collection.get_pressure_change(test_mass_flowrate);
