...
pub fn advance_timestep_solid_cylindrical_core_node_no_axial_conduction(
    ...
    let mut adiabatic_conductance_array: Array1<ThermalConductance> = Array::zeros(number_of_nodes);
    ...
    let mut arbitrary_temperature_conductance_array: Array1<ThermodynamicTemperature> =
