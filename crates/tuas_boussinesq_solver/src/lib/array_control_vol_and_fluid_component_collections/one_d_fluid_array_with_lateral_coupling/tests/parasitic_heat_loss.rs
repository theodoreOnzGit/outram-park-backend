...
pub fn parasitic_heat_loss_integration_test_with_hte_1m() {
    ...
    let mut static_mixer_41_label_6_fluid_arr: HeatTransferEntity = FluidArray::new_cylinder(
        component_length,
        hydraulic_diameter,
        initial_temperature,
        fluid_pressure,
    ...
    let nusselt_correlation: NusseltCorrelation = NusseltCorrelation::FixedNusselt(400.0.into());
    ...
    while max_time > simulation_time {
        ...
        static_mixer_41_label_6_fluid_arr
            .try_set_flowrate_for_fluid_array(mass_flowrate)
            .unwrap();
        {
            ...
            let mut fluid_array_clone: FluidArray = static_mixer_41_label_6_fluid_arr
                .clone()
                .try_into()
                .unwrap();
            ...
            static_mixer_41_label_6_fluid_arr = fluid_array_clone.into();
        }
