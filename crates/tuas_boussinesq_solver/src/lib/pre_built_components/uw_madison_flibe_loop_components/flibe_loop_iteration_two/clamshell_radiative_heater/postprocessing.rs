...
impl ClamshellRadiativeHeater {
    ...
    pub fn pipe_fluid_array_temperature(
        &mut self,
    ) -> Result<Vec<ThermodynamicTemperature>, TuasLibError> {
    ...
    pub fn annular_air_array_temperature(
        &mut self,
    ) -> Result<Vec<ThermodynamicTemperature>, TuasLibError> {
    ...
    pub fn heating_element_array_temperature(
        &mut self,
    ) -> Result<Vec<ThermodynamicTemperature>, TuasLibError> {
    ...
    pub fn get_total_radiant_heat_rate_from_annular_axial_ends(
        &mut self,
    ...
    /// on view factor and such
    pub fn get_front_side_radiant_heat_rate_from_annular_axial_ends(
        &mut self,
    ) -> Result<Power, TuasLibError> {
        todo!()
    }
    ...
    /// heat transfer rate from based
    /// on view factor and such
    pub fn get_back_side_radiant_heat_rate_from_annular_axial_ends(
        &mut self,
    ) -> Result<Power, TuasLibError> {
        todo!()
    }
