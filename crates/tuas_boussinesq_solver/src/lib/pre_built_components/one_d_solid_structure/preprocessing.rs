...
impl SolidStructure {
    ...
    #[inline]
    pub fn link_mixed_boundary_condition_laterally(
        &mut self,
        ...
        // lateral connections
        {
            ...
            let mut solid_array_clone: SolidColumn = self.solid_array.clone().try_into()?;
            ...
            solid_array_clone
                .lateral_link_new_power_vector(total_power_input_into_column, q_frac_arr)?;
    ...
    /// basis (not total)
    #[inline]
    pub fn link_ambient_temperature_boundary_condition_laterally(
        &mut self,
        solid_array_to_ambient_nodal_conductance: ThermalConductance,
        ambient_temp: ThermodynamicTemperature,
    ) -> Result<(), TuasLibError> {
        ...
        // lateral connections
        {
            ...
            // solid array to power interaction
            solid_array_clone.lateral_link_new_power_vector(Power::ZERO, q_frac_arr)?;
    ...
    #[inline]
    pub fn get_ambient_surroundings_to_cylinder_thermal_conductance(
        &mut self,
        ...
        let mut structure_clone: SolidColumn = self.solid_array.clone().try_into()?;
    ...
    /// Conductance is given on a per node basis
    #[inline]
    pub fn get_ambient_surroundings_to_hollow_cylinder_thermal_conductance(
        &mut self,
        h_air_to_pipe_surf: HeatTransfer,
        cylinder_id: Length,
        cylinder_od: Length,
        ...
        let pipe_air_conductance_interaction: HeatTransferInteractionType =
            HeatTransferInteractionType::CylindricalConductionConvectionLiquidOutside(
                ...
                (h_air_to_pipe_surf, cylinder_od.into(), node_length.into()),
            );
