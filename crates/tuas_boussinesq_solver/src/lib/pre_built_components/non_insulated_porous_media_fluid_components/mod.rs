...
impl NonInsulatedPorousMediaFluidComponent {
    ...
    ///
    ///
    pub fn new_dewet_model_heater_v2(
        ...
        let convection_heat_transfer_area_to_interior = heat_transfer_area_heated_length_only;
        // area = PI * inner diameter * L
        let convection_heat_transfer_area_to_pipe: Area = PI * steel_shell_id * heated_length;

        // area = PI * outer diameter * L
        let convection_heat_transfer_area_to_ambient: Area = PI * steel_shell_od * heated_length;
    ...
    pub fn _new_six_watts_per_m2_kelvin_model_heater_v2_model(
        initial_temperature: ThermodynamicTemperature,
        ambient_temperature: ThermodynamicTemperature,
        user_specified_inner_nodes: usize,
    ) -> Self {
        ...
        let mut therminol_array: FluidArray = FluidArray::new_odd_shaped_pipe(
            heated_length,
            hydraulic_diameter,
            flow_area,
            initial_temperature,
        ...
        let convection_heat_transfer_area_to_interior: Area = Area::new::<square_inch>(719.0);
    ...
    /// it was increased to 20 W/(m^2 K) because of the support structures
    /// and other such losses
    pub fn ciet_heater_v2_generic_model(
        initial_temperature: ThermodynamicTemperature,
        ambient_temperature: ThermodynamicTemperature,
        user_specified_inner_nodes: usize,
