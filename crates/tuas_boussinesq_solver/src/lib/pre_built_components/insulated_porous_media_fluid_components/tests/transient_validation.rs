...
pub fn transient_test_stepup_4050s_fig_2_21_zweibaum_thesis_for_heater_v1_eight_nodes_validation() {
    ...
    let final_experimental_outlet_temp = ThermodynamicTemperature::new::<degree_celsius>(97.316);
    ...
    let mut heater_top_head = InsulatedPorousMediaFluidComponent::new_ciet_heater_v1_top_head(
        initial_temperature,
        ambient_air_temp,
        0,
    );

    let mut heater_bottom_head = InsulatedPorousMediaFluidComponent::new_ciet_heater_v1_bottom_head(
        initial_temperature,
        ambient_air_temp,
        0,
    );
    ...
    let main_loop = thread::spawn(move || {
        while max_time > simulation_time {
            ...
            if wait {
                ...
                static_mixer_mx_10_object.lateral_and_miscellaneous_connections_mx10(mass_flowrate);

                static_mixer_mx_10_pipe.lateral_and_miscellaneous_connections_mx10(mass_flowrate);
            ...
            final_outlet_temp = static_mixer_mx_10_pipe
                .pipe_fluid_array
...
pub fn transient_test_stepdown_4050s_fig_2_21_zweibaum_thesis_for_heater_v1_eight_nodes_validation()
{
    ...
    let final_experimental_outlet_temp = ThermodynamicTemperature::new::<degree_celsius>(97.5);
    let inlet_temperature = initial_temperature;
    let ambient_air_temp: ThermodynamicTemperature =
        ThermodynamicTemperature::new::<degree_celsius>(21.76);
