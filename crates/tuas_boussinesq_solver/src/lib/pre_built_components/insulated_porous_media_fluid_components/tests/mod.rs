...
pub fn test_to_assert_if_conductance_from_insulation_to_ambient_is_correct() {
    ...
    let therminol_array_clone: FluidArray = heater_v1_without_inner_annular_pipe
        .pipe_fluid_array
        .clone()
        .try_into()
        .unwrap();
    ...
    // shell to fluid
    {
        ...
        let ambient_to_insulation_conductance_insulated = heater_v1_with_annular_pipe
            .get_ambient_to_insulation_nodal_conductance(htc_to_ambient)
            .unwrap();
...
pub fn regression_heater_v1_porous_and_non_porous_conductance_pipe_to_insulation_arr() {
    ...
    // shell to fluid
    {
        ...
        let pipe_shell_to_insulation_conductance_insulated = heater_v1_with_annular_pipe
            .get_pipe_shell_to_insulation_nodal_conductance()
            .unwrap();

        // at the initial state, both must be the same
        approx::assert_relative_eq!(
            pipe_shell_to_insulation_conductance_without_inner_annular_pipe
                .get::<watt_per_kelvin>(),
...
pub fn regression_heater_v2_insulated_and_non_insulated_conductance_fluid_arr_to_pipe() {
    ...
    // shell to fluid
    {
        ...
        let pipe_shell_to_fluid_conductance_bare = heater_v2_bare
        ...
        let prandtl_wall_correction_setting = false;
        let pipe_shell_to_fluid_conductance_insulated = heater_v2_insulated
            .get_pipe_shell_to_fluid_nodal_conductance(prandtl_wall_correction_setting)
            .unwrap();
...
pub fn regression_heater_v2_insulated_and_non_insulated_conductance_twisted_tape_to_pipe_fluid_array(
    ...
    // shell to fluid
    {
        ...
        let prandtl_wall_correction_setting = false;
        let twisted_tape_to_fluid_conductance_bare = heater_v2_bare
        ...
        let prandtl_wall_correction_setting = false;
        let twisted_tape_to_fluid_conductance_insulated = heater_v2_insulated
            .get_interior_to_fluid_nodal_conductance(prandtl_wall_correction_setting)
            .unwrap();
