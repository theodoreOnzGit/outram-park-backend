...
impl InsulatedPorousMediaFluidComponent {
    ...
    pub fn lateral_and_miscellaneous_connections(
        ...
        let ambient_to_insulation_nodal_conductance: ThermalConductance =
            self.get_ambient_to_insulation_nodal_conductance(heat_transfer_to_ambient)?;
        ...
        let pipe_shell_to_fluid_nodal_conductance: ThermalConductance =
            self.get_pipe_shell_to_fluid_nodal_conductance(prandtl_wall_correction_setting)?;

        let interior_to_fluid_nodal_conductance: ThermalConductance =
            self.get_interior_to_fluid_nodal_conductance(prandtl_wall_correction_setting)?;
        ...
        // now for the lateral linkages
        {
            ...
            let mut interior_solid_array_clone: SolidColumn = self
                .interior_solid_array_for_porous_media
                .clone()
                .try_into()?;
            ...
            //
            pipe_fluid_array_clone.lateral_link_new_temperature_vector_avg_conductance(
            ...
            interior_solid_array_clone.lateral_link_new_temperature_vector_avg_conductance(
                interior_to_fluid_nodal_conductance,
            ...
            pipe_shell_clone
                .lateral_link_new_power_vector(shell_side_steady_state_power, q_frac_arr.clone())
                .unwrap();

            interior_solid_array_clone
                .lateral_link_new_power_vector(porous_media_side_steady_state_power, q_frac_arr)
                .unwrap();
            ...
            self.interior_solid_array_for_porous_media
                .set(interior_solid_array_clone.into())?;
    ...
    #[inline]
    pub fn get_ambient_to_insulation_nodal_conductance(
        &mut self,
        ...
        let mut insulation_clone: SolidColumn = self.insulation_array.clone().try_into().unwrap();
        ...
        let insulation_material_conductivity: ThermalConductivity = insulation_clone
            .material_control_volume
            .try_get_thermal_conductivity(insulation_bulk_temp)?;
        ...
        let nodalised_insulation_side_thermal_conductance: ThermalConductance =
            insulation_conductance_lengthscale * insulation_material_conductivity / number_of_nodes;
    ...
    pub fn get_pipe_shell_to_insulation_nodal_conductance(
        ...
        let pipe_shell_material_conductivity: ThermalConductivity = pipe_shell_clone
            .material_control_volume
            .try_get_thermal_conductivity(pipe_shell_temp)?;
        ...
        let nodalised_pipe_shell_side_thermal_conductance: ThermalConductance =
            pipe_shell_conductance_lengthscale * pipe_shell_material_conductivity / number_of_nodes;
    ...
    pub fn get_pipe_shell_to_fluid_nodal_conductance(
        ...
        let mut pipe_fluid_arr_clone: FluidArray = self.pipe_fluid_array.clone().try_into()?;
        ...
        let mass_flowrate: MassRate = pipe_fluid_arr_clone.get_mass_flowrate();
        ...
        let nusselt_hydraulic_diameter = self.nusselt_correlation_lengthscale_fluid_to_pipe_shell;
        let flow_area: Area = pipe_fluid_arr_clone.get_cross_sectional_area_immutable();
        ...
        let solid_thermal_conductivity: ThermalConductivity =
            solid_material.try_get_thermal_conductivity(wall_temperature)?;
        ...
        let reynolds_number_single_tube: Ratio =
            mass_flowrate / flow_area * nusselt_hydraulic_diameter / viscosity;
        ...
        // if ever an issue
        let correct_prandtl_for_wall_temperatures = prandtl_wall_correction_setting;
        ...
        if correct_prandtl_for_wall_temperatures {
            ...
            wall_prandtl_number = fluid_material
        ...
        // (f_darcy L/D + K)
        let fldk: Ratio = pipe_fluid_arr_clone
            .fluid_component_loss_properties
            .fldk_based_on_darcy_friction_factor(reynolds_number_abs_for_nusselt)
            .unwrap();

        let length_to_diameter: Ratio = pipe_fluid_arr_clone.get_component_length_immutable()
        ...
        let nodalised_fluid_side_conductance: ThermalConductance = (tube_h_to_fluid
            * self.convection_heat_transfer_area_fluid_to_pipe_shell)
            / number_of_temperature_nodes;

        // now solid side nodalised conductance
        let nodalised_solid_side_conductance: ThermalConductance =
            (self.thermal_conductance_lengthscale_pipe_shell_to_fluid * solid_thermal_conductivity)
                / number_of_temperature_nodes;

        let nodalised_pipe_fluid_to_shell_thermal_resistance: ThermalResistance =
            nodalised_solid_side_conductance.recip() + nodalised_fluid_side_conductance.recip();
    ...
    pub fn get_interior_to_fluid_nodal_conductance(
        ...
        let single_tube_mass_flowrate: MassRate = pipe_fluid_arr_clone.get_mass_flowrate();
        ...
        let single_tube_flow_area: Area = pipe_fluid_arr_clone.get_cross_sectional_area_immutable();
        ...
        let solid_material: SolidMaterial = interior_solid_array_clone
            .material_control_volume
            .try_into()?;
        ...
        let solid_thermal_conductivity: ThermalConductivity =
            solid_material.try_get_thermal_conductivity(solid_array_temp)?;
        ...
        //
        let reynolds_number_single_tube: Ratio =
            single_tube_mass_flowrate / single_tube_flow_area * hydraulic_diameter / viscosity;
        ...
        tube_h_to_fluid = nusselt_estimate_tube_side * k_fluid_average / hydraulic_diameter;
        ...
        let nodalised_fluid_side_conductance: ThermalConductance = (tube_h_to_fluid
            * self.convection_heat_transfer_area_fluid_to_interior)
            / number_of_temperature_nodes;
        ...
        let nodalised_solid_side_conductance: ThermalConductance = (self
