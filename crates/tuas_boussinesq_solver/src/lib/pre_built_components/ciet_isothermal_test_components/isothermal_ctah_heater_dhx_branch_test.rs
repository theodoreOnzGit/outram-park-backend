...
pub fn isothermal_dhx_ctah_and_heater_branch_code_to_code_verification_test() {
    ...
    fn verify_mass_flowrate_given_pressure_change(
        ...
        let mut dhx_ctah_and_heater_branches = FluidComponentSuperCollection::default();
        ...
        let mass_flowrate_across_each_branch: Vec<MassRate> = dhx_ctah_and_heater_branches
        ...
        let mut mass_flowrate_test: MassRate = mass_flowrate_across_each_branch[1];
