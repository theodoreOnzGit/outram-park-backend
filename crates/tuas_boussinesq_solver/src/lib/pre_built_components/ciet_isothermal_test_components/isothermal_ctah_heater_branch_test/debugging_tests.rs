...
pub fn heater_branch_pressure_change_regression_test() {
    ...
    let pressure_change_at_zero_kg_per_s = heater_branch.get_pressure_change(MassRate::ZERO);

    // pressure change should be 39041 +/- 1 Pa
    assert_abs_diff_eq!(
        pressure_change_at_zero_kg_per_s.get::<pascal>(),
        39041.0,
        epsilon = 1.0,
    );
...
pub fn ctah_branch_pressure_change_regression_test() {
    ...
    let ctah_branch = ctah_branch_builder_isothermal_test(pump_pressure, test_temperature);

    // pressure change at 0 kg/s
    let pressure_change_at_zero_kg_per_s = ctah_branch.get_pressure_change(MassRate::ZERO);
    ...
    // pressure change at 0 kg/s
    let pressure_change_at_0_18_kg_per_s =
        ctah_branch.get_pressure_change(MassRate::new::<kilogram_per_second>(0.18));
...
pub fn partial_ctah_branch_test() {
    use crate::pre_built_components::ciet_isothermal_test_components::{
        new_branch_17, new_ctah_pump, new_flowmeter_40_14a, new_inactive_ctah_horizontal,
        new_inactive_ctah_vertical, new_pipe_10, new_pipe_11, new_pipe_12, new_pipe_13,
        new_pipe_14, new_pipe_15, new_pipe_16, new_pipe_6a, new_pipe_8a, new_pipe_9,
...
pub fn ctah_pump_should_give_zero_resistance() {
    ...
    approx::assert_abs_diff_eq!(pressure_drop.get::<uom::si::pressure::pascal>(), 0.0,);

    let pressure_change = ctah_pump.get_pressure_change_immutable(mass_rate);

    approx::assert_abs_diff_eq!(pressure_change.get::<uom::si::pressure::pascal>(), 0.0,)
}
...
pub fn isothermal_ctah_and_heater_branch_parallel_associated_functions_regression_test() {
    ...
    use uom::si::mass_rate::kilogram_per_second;
    use uom::si::pressure::pascal;
    use crate::pre_built_components::ciet_isothermal_test_components::ciet_branch_builders_isothermal::*;
    use uom::ConstZero;
    ...
    fn verify_mass_flowrate_given_pressure_change(
        ...
        let pressure_change_across_each_branch =
            ctah_and_heater_branches.get_pressure_change(MassRate::ZERO);
