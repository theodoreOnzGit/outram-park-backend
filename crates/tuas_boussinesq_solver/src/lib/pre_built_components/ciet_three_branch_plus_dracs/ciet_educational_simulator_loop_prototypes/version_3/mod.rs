...
pub fn three_branch_ciet_ver3(
    ...
    use crate::pre_built_components::ciet_isothermal_test_components::*;
        ...
        use crate::pre_built_components::ciet_nat_circ_tests::coupled_dracs_loop_tests::pri_loop_calc_functions::{pri_loop_dhx_shell_temperature_diagnostics, pri_loop_heater_temperature_diagnostics};
    use crate::pre_built_components::
    ciet_nat_circ_tests::dracs_loop_components::*;
    use crate::pre_built_components::ciet_three_branch_plus_dracs::components::{
        new_active_ctah_horizontal, new_active_ctah_vertical,
    };
    use crate::pre_built_components::ciet_three_branch_plus_dracs::solver_functions::{
        ciet_pri_loop_three_branch_link_up_components,
        pri_loop_three_branch_advance_timestep_except_dhx, three_branch_pri_loop_flowrates,
    };
    ...
    let experimental_dhx_br_mass_flowrate =
        MassRate::new::<kilogram_per_second>(experimental_dhx_br_mass_flowrate_kg_per_s);

    let pump_pressure: Pressure = Pressure::new::<pascal>(ctah_pump_pressure_pascals);
    ...
    let mut dhx_pid_controller: AnalogController = AnalogController::new_filtered_pid_controller(
        controller_gain,
        integral_time,
        derivative_time,
        alpha,
    ...
    let mut ctah_pid_controller = AnalogController::new_filtered_pid_controller(
    ...
    while current_simulation_time < max_simulation_time {
        ...
        tchx_heat_transfer_coeff = {
            ...
            let dimensionless_heat_trf_input: Ratio = dhx_pid_controller
        ...
        let pri_flowrate_join_handle = thread::spawn(move || {
            ...
            // this was tested ok
            let (dhx_flow, heater_flow, ctah_flow) = three_branch_pri_loop_flowrates(
                pump_pressure,
                ctah_branch_blocked,
                dhx_branch_blocked,
                &cloned_pipe_4,
