...
pub fn ciet_pri_loop_three_branch_link_up_components(
    ...
    // also set the ambient temperature for each component
    {
        ...
        // ambient temp
        let ambient_temp_user_set = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    ...
    // because DHX sthe requires mass flowrates in both sides of the loop
    {
        ...
        pipe_4
            .lateral_and_miscellaneous_connections_no_wall_correction(heater_flow, zero_power)
            .unwrap();
        pipe_3
            .lateral_and_miscellaneous_connections_no_wall_correction(heater_flow, zero_power)
            .unwrap();
        ...
        // DHX branch
        pipe_5a
            .lateral_and_miscellaneous_connections_no_wall_correction(dhx_flow, zero_power)
            .unwrap();
        ...
        // ctah branch
        pipe_5b
            .lateral_and_miscellaneous_connections_no_wall_correction(ctah_flow, zero_power)
            .unwrap();
        pipe_6a
            .lateral_and_miscellaneous_connections_no_wall_correction(ctah_flow, zero_power)
            .unwrap();
...
pub fn get_mass_flowrate_vector_for_dhx_heater_and_ctah_branches(
    ...
    return (mass_flow_branch_1, mass_flow_branch_2, mass_flow_branch_3);
}
...
///
pub fn three_branch_pri_loop_flowrates_parallel(
    pump_pressure: Pressure,
    ctah_branch_blocked: bool,
    dhx_branch_blocked: bool,
    pipe_4: &InsulatedFluidComponent,
...
pub fn coupled_dracs_loop_link_up_components_sam_tchx_calibration(
    ...
    advection_heat_transfer_interaction = HeatTransferInteractionType::new_advection_interaction(
    ...
    {
        // hot branch
        dhx_tube_side_30a.heat_transfer_to_ambient = ambient_htc;
        dhx_tube_side_30b.heat_transfer_to_ambient = ambient_htc;

        static_mixer_61_label_31.heat_transfer_to_ambient = ambient_htc;
        pipe_31a.heat_transfer_to_ambient = ambient_htc;

        pipe_32.heat_transfer_to_ambient = ambient_htc;
        pipe_33.heat_transfer_to_ambient = ambient_htc;
        pipe_34.heat_transfer_to_ambient = ambient_htc;

        // cold branch
        tchx_35a.heat_transfer_to_ambient = HeatTransfer::ZERO;
        tchx_35b_1.heat_transfer_to_ambient = HeatTransfer::ZERO;
        tchx_35b_2.heat_transfer_to_ambient = tchx_heat_transfer_coeff;

        static_mixer_60_label_36.heat_transfer_to_ambient = ambient_htc;
        pipe_36a.heat_transfer_to_ambient = ambient_htc;

        pipe_37.heat_transfer_to_ambient = ambient_htc;
        pipe_38.heat_transfer_to_ambient = ambient_htc;
        pipe_39.heat_transfer_to_ambient = ambient_htc;
    }
    // add lateral heat losses, lateral connections for dhx not done here
    {
        ...
        tchx_35b_1.ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
        tchx_35b_2.ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
...
pub fn dracs_loop_advance_timestep_except_dhx_sam_tchx_calibration(
    ...
    tchx_35b_1.advance_timestep(timestep).unwrap();
    tchx_35b_2.advance_timestep(timestep).unwrap();
