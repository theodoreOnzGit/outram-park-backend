...
pub fn reactor_branch_test_get_pressure_change_from_mass_flowrate() {
    ...
    let pressure_chg_front = reactor_branch.get_pressure_change(mass_flowrate_front);
    ...
    let pressure_chg_back = reactor_branch.get_pressure_change(mass_flowrate_back);
...
pub fn reactor_branch_test_get_mass_flowrate_from_pressure_change() {
    ...
    let mass_flowrate_back =
        reactor_branch.get_mass_flowrate_from_pressure_change(pressure_chg_back);
...
pub fn ihx_branch_test_get_pressure_change_from_mass_flowrate() {
    ...
    let mut ihx_branch = FluidComponentCollection::new_series_component_collection();
    ...
    let mass_flowrate_front = MassRate::new::<kilogram_per_second>(1200.0);
    // now let's get the pressure change
    let pressure_chg_front = ihx_branch.get_pressure_change(mass_flowrate_front);
    approx::assert_relative_eq!(
        pressure_chg_front.get::<pascal>(),
        -51806.8917,
        max_relative = 1e-5
    ...
    let pressure_chg_back = ihx_branch.get_pressure_change(mass_flowrate_back);
...
pub fn ihx_branch_test_get_mass_flowrate_from_pressure_change() {
    ...
    let mass_flowrate_back = ihx_branch.get_mass_flowrate_from_pressure_change(pressure_chg_back);
