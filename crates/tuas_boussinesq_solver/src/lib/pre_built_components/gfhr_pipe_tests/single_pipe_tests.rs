...
pub fn single_pipe_flibe_pressure_drop_for_mass_flow_1200_kg_per_s() {
    ...
    let mass_flowrate_front =
        pipe_1.get_mass_flowrate_from_pressure_change_immutable(pressure_chg_frontal);
    ...
    let mass_flowrate_back =
        pipe_1.get_mass_flowrate_from_pressure_change_immutable(pressure_chg_back);
...
pub fn single_pipe_flibe_internal_pressure_change_check() {
    ...
    let pressure_chg_hydrostatic = pipe_1.get_pressure_change_immutable(mass_flowrate_zero);
