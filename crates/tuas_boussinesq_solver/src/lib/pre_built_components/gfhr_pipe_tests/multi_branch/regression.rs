...
pub(crate) fn new_reactor_vessel_pipe_1_regression(
...
/// we can scale it down
/// forward flow direction going upwards
pub fn new_downcomer_pipe_2_regression(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
/// forward flow direction going upwards
pub fn new_downcomer_pipe_3_regression(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
pub fn new_fhr_pipe_7_regression(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
