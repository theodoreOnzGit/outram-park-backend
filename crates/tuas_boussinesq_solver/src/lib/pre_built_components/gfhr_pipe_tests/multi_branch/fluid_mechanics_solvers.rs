...
use crate::array_fluid_collections::fluid_component_collection::super_collection_series_and_parallel_functions::FluidComponentSuperCollectionParallelAssociatedFunctions;
...
pub fn four_branch_pri_and_intermediate_loop_fluid_mechanics_only(
    ...
    let mut reactor_branch = FluidComponentCollection::new_series_component_collection();

    reactor_branch.clone_and_add_component(reactor_pipe_1);

    let mut pri_downcomer_branch_1 = FluidComponentCollection::new_series_component_collection();

    pri_downcomer_branch_1.clone_and_add_component(downcomer_pipe_2);

    let mut pri_downcomer_branch_2 = FluidComponentCollection::new_series_component_collection();
    ...
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_11);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_10);
    pri_loop_intermediate_heat_exchanger_branch
        .clone_and_add_component(&fhr_pri_loop_pump_9_with_pressure_set);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_8);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_7);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(&ihx_shell_side_6_clone);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_5);
    pri_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_4);
    ...
    intrmd_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_17);
    ...
    intrmd_loop_intermediate_heat_exchanger_branch.clone_and_add_component(fhr_pipe_12);
    ...
    let mut fhr_intrmd_loop_pump_16_with_pressure_set = fhr_intrmd_loop_pump_16.clone();
    ...
    intrmd_loop_steam_generator_branch
        .clone_and_add_component(&fhr_intrmd_loop_pump_16_with_pressure_set);
    intrmd_loop_steam_generator_branch.clone_and_add_component(fhr_pipe_15);
    intrmd_loop_steam_generator_branch.clone_and_add_component(fhr_steam_generator_shell_side_14);
    intrmd_loop_steam_generator_branch.clone_and_add_component(fhr_pipe_13);
    ...
    pri_loop_branches
        .fluid_component_super_vector
        .push(pri_downcomer_branch_1);
    pri_loop_branches
        .fluid_component_super_vector
        .push(pri_downcomer_branch_2);

    pri_loop_branches
        .fluid_component_super_vector
        .push(pri_loop_intermediate_heat_exchanger_branch);

    let pressure_change_across_each_branch_pri_loop =
        pri_loop_branches.get_pressure_change(MassRate::ZERO);

    let pri_loop_mass_rate_vector = pri_loop_branches
        .get_mass_flowrate_across_each_parallel_branch(pressure_change_across_each_branch_pri_loop);
    ...
    let (
        ...
        pri_loop_mass_rate_vector[0],
        pri_loop_mass_rate_vector[1],
        pri_loop_mass_rate_vector[2],
        pri_loop_mass_rate_vector[3],
    );

    // calculate intermediate loop side fluid mechanics

    let mut intrmd_loop_branches = FluidComponentSuperCollection::default();

    intrmd_loop_branches.set_orientation_to_parallel();

    intrmd_loop_branches
        .fluid_component_super_vector
        .push(intrmd_loop_intermediate_heat_exchanger_branch);
    intrmd_loop_branches
        .fluid_component_super_vector
        .push(intrmd_loop_steam_generator_branch);

    let pressure_change_across_each_branch_intrmd_loop =
        intrmd_loop_branches.get_pressure_change(MassRate::ZERO);

    let intrmd_loop_mass_rate_vector = intrmd_loop_branches
...
pub fn four_branch_pri_loop_flowrates_parallel_debug(
    ...
    let mut downcomer_branch_1 = FluidComponentCollection::new_series_component_collection();

    downcomer_branch_1.clone_and_add_component(downcomer_pipe_2);

    let mut downcomer_branch_2 = FluidComponentCollection::new_series_component_collection();
    ...
    pri_loop_branches
        .fluid_component_super_vector
        .push(downcomer_branch_1);
    pri_loop_branches
        .fluid_component_super_vector
        .push(downcomer_branch_2);
    pri_loop_branches
        .fluid_component_super_vector
        .push(intermediate_heat_exchanger_branch);
    ...
    let (
        ...
        downcomer_branch_2_flow,
        intermediate_heat_exchanger_branch_flow,
    ) = calculate_iterative_mass_flowrate_across_branches_for_fhr_sim_v1(&pri_loop_branches);
...
pub fn four_branch_pri_loop_flowrates_parallel_debug_library(
    ...
    let pressure_change_across_each_branch = pri_loop_branches.get_pressure_change(MassRate::ZERO);

    let mass_rate_vector = pri_loop_branches
        .get_mass_flowrate_across_each_parallel_branch(pressure_change_across_each_branch);
...
pub fn calculate_iterative_mass_flowrate_across_branches_for_fhr_sim_v1(
    ...
    let fluid_component_collection_vector = fluid_component_super_collection.get_immutable_vector();
    ...
    if user_requested_mass_flowrate.value.abs() < 1e-9_f64 {
        ...
        let mut max_mass_flowrate_across_each_branch = MassRate::new::<kilogram_per_second>(5000.0);
        ...
        let new_vector_length = fluid_component_collection_vector.len();
            ...
            fluid_component_collection_vector.iter().enumerate()
        {
            ...
            let fluid_component_collection = &*fluid_component_pointer_collection;
            ...
            let fluid_component_vector =
                fluid_component_collection.get_immutable_fluid_component_vector();
            let fluid_component_mass_flowrate: MassRate;

            if !debugging {
                fluid_component_mass_flowrate = fluid_component_collection
