...
pub fn get_abs_mass_flowrate_across_two_branches(
...
pub fn coupled_dracs_loop_link_up_components_sam_tchx_calibration(
    ...
    // add lateral heat losses, lateral connections for dhx not done here
    {
        ...
        let ua: ThermalConductance = area * tchx_heat_transfer_coeff;
        ...
        let ctah_temperature_difference =
            TemperatureInterval::new::<uom::si::temperature_interval::kelvin>(
                tchx_outlet_temperature.get::<degree_celsius>()
                    - tchx_35b_2.ambient_temperature.get::<degree_celsius>(),
            );
        let _heat_addition_rate_to_tchx: Power = -ua * ctah_temperature_difference;
