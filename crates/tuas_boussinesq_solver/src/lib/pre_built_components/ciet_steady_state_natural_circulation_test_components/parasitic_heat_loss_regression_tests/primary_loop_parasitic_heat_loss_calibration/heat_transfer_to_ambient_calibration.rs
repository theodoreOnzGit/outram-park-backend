...
pub fn hot_leg_htc_to_ambient_calibration_v1_failed() {
    ...
    let set_c1 = thread::Builder::new()
        ...
        .spawn(|| {
            ...
            let regression_ambient_htc_watts_per_sq_m_kelvin = 0.0;

            let dhx_inlet_regression_temperature_degc = 74.31;
...
pub fn hot_leg_htc_to_ambient_calibration_regression_test_v1_failed(
    ...
    let reference_ambient_htc = HeatTransfer::new::<watt_per_square_meter_kelvin>(20.0);
    ...
    while current_simulation_time < max_simulation_time {
        ...
        ambient_heat_transfer_coeff = {
            ...
            let mut ambient_heat_trf_output =
                dimensionless_heat_trf_input * reference_ambient_htc + reference_ambient_htc;

            // make sure it cannot be less than a certain amount
            let ambient_minimum_heat_transfer =
                HeatTransfer::new::<watt_per_square_meter_kelvin>(15.0);
        ...
        heater_top_head_1a.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        static_mixer_10_label_2.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_2a.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_3.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_4.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_5a.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_26.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        pipe_25a.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
        static_mixer_21_label_25.heat_transfer_to_ambient = ambient_heat_transfer_coeff;
