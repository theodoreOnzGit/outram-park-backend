...
pub fn hot_leg_nusselt_calibration_failed() {
    ...
    let set_c1_v1 = thread::Builder::new()
        ...
        .spawn(|| {
            ...
            let dhx_inlet_regression_temperature_degc = 74.5;
...
pub fn hot_leg_nusselt_calibration_regression_test_v2_failed(
    ...
    let mut nusselt_number_multiplicative_coefficient = Ratio::new::<ratio>(1.0);
    ...
    while current_simulation_time < max_simulation_time {
        ...
        nusselt_number_multiplicative_coefficient = {
            ...
            let mut dimensionless_multiplicative_coeff_input: Ratio = pid_controller
                .set_user_input_and_calc(nondimensional_error, current_simulation_time)
                .unwrap();

            let minimum_multiplicative_coefficient = Ratio::new::<ratio>(1.0);
        ...
        fn calibrate_nusselt_correlation_of_heat_transfer_entity(
            ...
            match hte {
                HeatTransferEntity::ControlVolume(CVType::FluidArrayCV(fluid_array)) => {
