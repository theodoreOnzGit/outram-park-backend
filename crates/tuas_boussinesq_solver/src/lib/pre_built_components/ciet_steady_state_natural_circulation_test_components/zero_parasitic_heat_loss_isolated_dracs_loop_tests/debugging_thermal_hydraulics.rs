...
pub fn dracs_hot_branch_builder(
...
pub fn dracs_cold_branch_builder(
    initial_temperature: ThermodynamicTemperature,
) -> FluidComponentCollection {
...
pub fn dracs_branch_pressure_change_test() {
    ...
    let test_temperature = ThermodynamicTemperature::new::<degree_celsius>(21.7);
    ...
    assert_abs_diff_eq!(
        pressure_change_at_zero_kg_per_s_cold_branch.get::<pascal>(),
        pressure_change_at_zero_kg_per_s_hot_branch.get::<pascal>(),
        epsilon = 1.0,
    );
    ...
    dracs_hot_branch =
        dracs_hot_branch_builder(ThermodynamicTemperature::new::<degree_celsius>(80.0));
...
pub fn dracs_natural_circ_thermal_hydraulics_regression_test_prototype_2() {
    ...
    // setup
    let initial_temperature = ThermodynamicTemperature::new::<degree_celsius>(50.0);
    let timestep = Time::new::<second>(0.5);
    let heat_rate_through_dhx = Power::new::<watt>(460.0);
    let tchx_heat_transfer_coeff = HeatTransfer::new::<watt_per_square_meter_kelvin>(300.0);
...
pub fn dracs_natural_circ_thermal_hydraulics_test_prototype_1() {
    ...
    let mut mass_flowrate_initial: MassRate = mass_flowrate_across_each_branch[0];
