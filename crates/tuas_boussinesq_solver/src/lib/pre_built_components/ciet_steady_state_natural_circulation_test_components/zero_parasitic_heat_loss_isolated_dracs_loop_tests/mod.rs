...
pub fn dracs_natural_circ_thermal_hydraulics_pid_test_prototype_2() {
    ...
    // setup
    let initial_temperature = ThermodynamicTemperature::new::<degree_celsius>(40.0);

    let timestep = Time::new::<second>(0.5);
    let heat_rate_through_dhx = Power::new::<watt>(931.8);
    let mut tchx_heat_transfer_coeff: HeatTransfer;

    let reference_tchx_htc = HeatTransfer::new::<watt_per_square_meter_kelvin>(25.0);
    ...
    let tchx_outlet_temperature_set_point = ThermodynamicTemperature::new::<degree_celsius>(46.0);
