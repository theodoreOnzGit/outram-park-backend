...
pub fn du_heat_exchanger_constructor_test() {
    ...
    let du_heat_exchanger_reference = SimpleShellAndTubeHeatExchanger {
    ...
    let du_heat_exchanger_test = SimpleShellAndTubeHeatExchanger::new_du_et_al_sthe();

    assert_eq!(du_heat_exchanger_reference, du_heat_exchanger_test)
}
...
pub fn insulated_sthe_constructor_test() {
    ...
    // dummy insulation array, will not be used,
    // just clone the inner shell
    let dummy_insulation_array = SolidColumn::new_cylindrical_shell(
        pipe_length,
        shell_side_od,
    ...
    let modified_du_heat_exchanger_reference = SimpleShellAndTubeHeatExchanger {
        inner_nodes: number_of_inner_nodes,
        inner_pipe_shell_array_for_single_tube: inner_shell.into(),
        tube_side_fluid_array_for_single_tube: tube_side_fluid_array.into(),
        shell_side_fluid_array: shell_side_fluid_array.into(),
    ...
    let sthe_with_insulation = SimpleShellAndTubeHeatExchanger::_new_sthe_with_insulation(
        number_of_tubes,
        number_of_inner_nodes,
        tube_side_od,
        tube_side_id,
    ...
    assert_eq!(modified_du_heat_exchanger_reference, sthe_with_insulation);
}
