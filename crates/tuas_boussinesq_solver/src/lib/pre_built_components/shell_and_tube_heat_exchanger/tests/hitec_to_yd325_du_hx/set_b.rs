...
pub fn du_test_shell_and_tube_heat_exchanger_set_b() {
    ...
    let vol_flowrate_salt = VolumeRate::new::<cubic_meter_per_hour>(14.63);
    ...
    let (reynolds_num_b1, bulk_prandtl_b1, wall_prandtl_b1, nusselt_number_b1) = test_thread(
        clone_for_test_one,
        tube_inlet_temperature,
        shell_inlet_temperature,
        m_t,
    ...
    assert_relative_eq!(reynolds_num_b1.get::<ratio>(), 4057.0, max_relative = 0.01,);

    assert_relative_eq!(bulk_prandtl_b1.get::<ratio>(), 24.19, max_relative = 0.01,);

    assert_relative_eq!(wall_prandtl_b1.get::<ratio>(), 37.89, max_relative = 0.01,);

    assert_relative_eq!(nusselt_number_b1.get::<ratio>(), 52.56, max_relative = 0.01,);
    ...
    if !one_test_only {
        ...
        let test_two = thread::spawn(move || {
            ...
            let (reynolds_num_b2, bulk_prandtl_b2, wall_prandtl_b2, nusselt_number_b2) =
                test_thread(
                    clone_for_test_two,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_b2.get::<ratio>(), 4422.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b2.get::<ratio>(), 22.13, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b2.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b2.get::<ratio>(), 55.76, max_relative = 0.01,);
        });
        ...
        let test_three = thread::spawn(move || {
            ...
            let (reynolds_num_b3, bulk_prandtl_b3, wall_prandtl_b3, nusselt_number_b3) =
                test_thread(
            ...
            assert_relative_eq!(reynolds_num_b3.get::<ratio>(), 4883.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b3.get::<ratio>(), 20.06, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b3.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b3.get::<ratio>(), 59.39, max_relative = 0.01,);
        });
        ...
        let test_four = thread::spawn(move || {
            ...
            let (reynolds_num_b4, bulk_prandtl_b4, wall_prandtl_b4, nusselt_number_b4) =
                test_thread(
                    clone_for_test_four,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_b4.get::<ratio>(), 4885.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b4.get::<ratio>(), 20.05, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b4.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b4.get::<ratio>(), 59.33, max_relative = 0.01,);
        });
        ...
        let test_five = thread::spawn(move || {
            ...
            let (reynolds_num_b5, bulk_prandtl_b5, wall_prandtl_b5, nusselt_number_b5) =
                test_thread(
                    clone_for_test_five,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_b5.get::<ratio>(), 4067.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b5.get::<ratio>(), 24.05, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b5.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b5.get::<ratio>(), 52.54, max_relative = 0.01,);
        });
        ...
        let test_six = thread::spawn(move || {
            ...
            let (reynolds_num_b6, bulk_prandtl_b6, wall_prandtl_b6, nusselt_number_b6) =
                test_thread(
                    clone_for_test_six,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_b6.get::<ratio>(), 4425.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b6.get::<ratio>(), 22.11, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b6.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b6.get::<ratio>(), 55.73, max_relative = 0.01,);
        });
        ...
        let test_seven = thread::spawn(move || {
            ...
            let (reynolds_num_b7, bulk_prandtl_b7, wall_prandtl_b7, nusselt_number_b7) =
                test_thread(
            ...
            assert_relative_eq!(reynolds_num_b7.get::<ratio>(), 4891.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_b7.get::<ratio>(), 20.02, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_b7.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_b7.get::<ratio>(), 59.27, max_relative = 0.01,);
        });
