...
pub fn du_test_shell_and_tube_heat_exchanger_set_a() {
    ...
    let vol_flowrate_salt = VolumeRate::new::<cubic_meter_per_hour>(12.63);
    ...
    let (reynolds_num_a1, bulk_prandtl_a1, wall_prandtl_a1, nusselt_number_a1) = test_thread(
        clone_for_test_one,
        tube_inlet_temperature,
        shell_inlet_temperature,
        m_t,
    ...
    assert_relative_eq!(reynolds_num_a1.get::<ratio>(), 3496.0, max_relative = 0.01,);

    assert_relative_eq!(bulk_prandtl_a1.get::<ratio>(), 24.16, max_relative = 0.01,);

    assert_relative_eq!(wall_prandtl_a1.get::<ratio>(), 37.89, max_relative = 0.01,);

    assert_relative_eq!(nusselt_number_a1.get::<ratio>(), 42.47, max_relative = 0.01,);
    ...
    if !one_test_only {
        ...
        let test_two = thread::spawn(move || {
            ...
            let (reynolds_num_a2, bulk_prandtl_a2, wall_prandtl_a2, nusselt_number_a2) =
                test_thread(
                    clone_for_test_two,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_a2.get::<ratio>(), 3808.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a2.get::<ratio>(), 22.19, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a2.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a2.get::<ratio>(), 45.52, max_relative = 0.01,);
        });
        ...
        let test_three = thread::spawn(move || {
            ...
            let (reynolds_num_a3, bulk_prandtl_a3, wall_prandtl_a3, nusselt_number_a3) =
                test_thread(
            ...
            assert_relative_eq!(reynolds_num_a3.get::<ratio>(), 4203.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a3.get::<ratio>(), 20.12, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a3.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a3.get::<ratio>(), 48.98, max_relative = 0.01,);
        });
        ...
        let test_four = thread::spawn(move || {
            ...
            let (reynolds_num_a4, bulk_prandtl_a4, wall_prandtl_a4, nusselt_number_a4) =
                test_thread(
                    clone_for_test_four,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_a4.get::<ratio>(), 4205.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a4.get::<ratio>(), 20.11, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a4.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a4.get::<ratio>(), 48.96, max_relative = 0.01,);
        });
        ...
        let test_five = thread::spawn(move || {
            ...
            let (reynolds_num_a5, bulk_prandtl_a5, wall_prandtl_a5, nusselt_number_a5) =
                test_thread(
                    clone_for_test_five,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_a5.get::<ratio>(), 3506.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a5.get::<ratio>(), 24.09, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a5.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a5.get::<ratio>(), 42.51, max_relative = 0.01,);
        });
        ...
        let test_six = thread::spawn(move || {
            ...
            let (reynolds_num_a6, bulk_prandtl_a6, wall_prandtl_a6, nusselt_number_a6) =
                test_thread(
                    clone_for_test_six,
                    tube_inlet_temperature,
                    shell_inlet_temperature,
            ...
            assert_relative_eq!(reynolds_num_a6.get::<ratio>(), 3811.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a6.get::<ratio>(), 22.17, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a6.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a6.get::<ratio>(), 45.52, max_relative = 0.01,);
        });
        ...
        let test_seven = thread::spawn(move || {
            ...
            let (reynolds_num_a7, bulk_prandtl_a7, wall_prandtl_a7, nusselt_number_a7) =
                test_thread(
            ...
            assert_relative_eq!(reynolds_num_a7.get::<ratio>(), 4212.0, max_relative = 0.01,);

            assert_relative_eq!(bulk_prandtl_a7.get::<ratio>(), 20.07, max_relative = 0.01,);

            assert_relative_eq!(wall_prandtl_a7.get::<ratio>(), 37.89, max_relative = 0.01,);

            assert_relative_eq!(nusselt_number_a7.get::<ratio>(), 48.95, max_relative = 0.01,);
        });
