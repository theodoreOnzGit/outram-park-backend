...
impl NonInsulatedPorousMediaFluidComponent {
    ...
    #[inline]
    pub fn ciet_heater_v2_lateral_and_miscellaneous_connections(
        &mut self,
        ...
        let steel_to_air_nodal_conductance: ThermalConductance =
            self.ciet_heater_v2_get_air_steel_nodal_shell_conductance(heat_transfer_to_air);
        ...
        // lateral connections
        {
            ...
            if connect_twisted_tape {
                let mut twisted_tape_array_clone: SolidColumn = self
    ...
    /// for ciet heater v2
    #[inline]
    pub fn ciet_heater_v2_get_air_steel_nodal_shell_conductance(
        &mut self,
        ...
        let steel_air_conductance_interaction: HeatTransferInteractionType =
            HeatTransferInteractionType::CylindricalConductionConvectionLiquidOutside(
                ...
                (h_air_to_steel_surf, od.into(), node_length.into()),
            );
    ...
    #[inline]
    pub fn ciet_heater_v2_get_therminol_node_steel_shell_conductance(
        &mut self,
    ) -> ThermalConductance {
        ...
        let fluid_temperature: ThermodynamicTemperature = therminol_fluid_array_clone
        ...
        let bulk_prandtl_number: Ratio = LiquidMaterial::TherminolVP1
            .try_get_prandtl_liquid(fluid_temperature, atmospheric_pressure)
            .unwrap();
        ...
        let k_fluid_average: ThermalConductivity = LiquidMaterial::TherminolVP1
            .try_get_thermal_conductivity(fluid_temperature)
            .unwrap();
        ...
        let therminol_steel_conductance_interaction: HeatTransferInteractionType =
            HeatTransferInteractionType::CylindricalConductionConvectionLiquidInside(
                ...
                (h_to_therminol, id.into(), node_length.into()),
            );
    ...
    #[inline]
    pub fn ciet_heater_v2_get_therminol_node_twisted_tape_conductance(&self) -> ThermalConductance {
        ...
        let heat_transfer_area_heated_length_plus_heads: Area = Area::new::<square_inch>(719.0);
        ...
        let wakao_correlation = NusseltCorrelation::Wakao(WakaoData {
            reynolds,
    ...
    pub fn ciet_heater_v2_lateral_connection_thread_spawn(
        &self,
        mass_flowrate: MassRate,
        heater_steady_state_power: Power,
    ) -> JoinHandle<Self> {
        ...
        let join_handle = thread::spawn(move || -> Self {
            ...
            heater_clone.ciet_heater_v2_lateral_and_miscellaneous_connections(
                mass_flowrate,
