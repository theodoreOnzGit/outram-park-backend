...
impl NonInsulatedPorousMediaFluidComponent {
    ...
    pub fn lateral_and_miscellaneous_connections(
        ...
        let ambient_to_pipe_shell_nodal_conductance: ThermalConductance =
            self.get_ambient_to_pipe_shell_nodal_conductance(heat_transfer_to_ambient)?;
    ...
    #[inline]
    pub fn get_ambient_to_pipe_shell_nodal_conductance(
        &mut self,
        ...
        let mut pipe_shell_clone: SolidColumn = self.pipe_shell.clone().try_into().unwrap();
        ...
        let pipe_shell_material_conductivity: ThermalConductivity = pipe_shell_clone
            ...
            .try_get_thermal_conductivity(pipe_bulk_temp)?;
        ...
        let nodalised_solid_side_thermal_conductance: ThermalConductance =
            solid_conductance_lengthscale * pipe_shell_material_conductivity / number_of_nodes;
    ...
    pub fn get_interior_to_fluid_nodal_conductance(
        ...
        let nodalised_fluid_side_conductance: ThermalConductance = (tube_h_to_fluid
            * self.convection_heat_transfer_area_to_interior)
    ...
    pub fn get_pipe_shell_to_fluid_nodal_conductance(
        ...
        let nusselt_hydraulic_diameter = self.nusselt_correlation_lengthscale_to_ambient;
        ...
        let nodalised_fluid_side_conductance: ThermalConductance = (tube_h_to_fluid
            * self.convection_heat_transfer_area_to_pipe)
            / number_of_temperature_nodes;
