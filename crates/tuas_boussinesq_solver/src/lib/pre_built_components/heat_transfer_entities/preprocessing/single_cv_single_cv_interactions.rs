...
pub fn calculate_advection_interaction_between_two_singular_cv_nodes(
    ...
    single_cv_1
        .calculate_advection_interaction_to_front_singular_cv_node(single_cv_2, advection_data)
}
...
pub fn calculate_conductance_interaction_between_two_singular_cv_nodes(
    ...
    single_cv_1
        .calculate_conductance_interaction_to_front_singular_cv_node(single_cv_2, interaction)
}
