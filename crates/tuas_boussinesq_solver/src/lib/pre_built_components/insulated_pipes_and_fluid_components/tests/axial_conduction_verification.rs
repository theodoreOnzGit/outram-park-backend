...
pub fn static_mixer_41_label_6_1_meter_test_reduced_thickness_increased_ua() {
    ...
    let average_expected_temp = ThermodynamicTemperature::new::<degree_celsius>(95.0);
...
pub fn static_mixer_41_label_6_1_meter_test_reduced_thickness_increased_ua_fluid_array_only() {
    ...
    while max_time > simulation_time {
        ...
        let mut therminol_array_clone: FluidArray = static_mixer_41_label_6
            .pipe_fluid_array
            .clone()
            .try_into()
            .unwrap();
        ...
        static_mixer_41_label_6.pipe_fluid_array = therminol_array_clone.into();
...
pub fn reduced_thickness_increased_ua_test_interal_thermal_resistance_check_fluid_array_only() {
    ...
    while max_time > simulation_time {
        ...
        let nodalised_thermal_resistance = static_mixer_41_label_6
            .clone()
            ...
            + static_mixer_41_label_6
                .clone()
                .get_fluid_array_node_to_pipe_shell_conductance(prandtl_wall_correction_setting)
                .unwrap()
                .recip();
...
pub fn reduced_thickness_increased_ua_test_check_fluid_array_and_insulation_array() {
    ...
    while max_time > simulation_time {
        ...
        let mut therminol_array_clone: FluidArray = static_mixer_41_label_6
            ...
            .try_into()
            .unwrap();
        let mut insulation_array_clone: SolidColumn = static_mixer_41_label_6
            .insulation
            .clone()
            .try_into()
            .unwrap();
        ...
        let nodalised_thermal_resistance_fluid_to_insulation = static_mixer_41_label_6
            .clone()
            .get_pipe_shell_to_insulation_nodal_conductance()
            .unwrap()
            .recip()
        ...
        static_mixer_41_label_6.insulation = insulation_array_clone.into();
