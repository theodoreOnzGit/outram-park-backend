...
pub fn fluid_mechanics_get_mass_flowrate_from_pressure_chg() {
    ...
    let pipe_1 = InsulatedFluidComponent::new_insulated_pipe(
        initial_temperature,
        ambient_temperature,
        fluid_pressure,
        solid_pressure,
    ...
    let test_pressure_drop_from_tutorial_1 =
        pipe_1.get_pressure_loss_immutable(test_mass_flowrate_100_kg_per_s);

    let test_pressure_change =
        pipe_1.get_pressure_change_immutable(test_mass_flowrate_100_kg_per_s);
    ...
    let pipe_2_incline_angle = Angle::new::<degree>(70.0);

    let pipe_2 = InsulatedFluidComponent::new_insulated_pipe(
        initial_temperature,
        ambient_temperature,
        fluid_pressure,
        solid_pressure,
    ...
    let test_pressure_drop_for_pipe_2 =
        pipe_2.get_pressure_loss_immutable(test_mass_flowrate_100_kg_per_s);
    ...
    let hydrstatic_pressure_pipe_2 =
        pipe_2.get_hydrostatic_pressure_change_immutable_at_ref_temperature();
    ...
    let total_pressure_chg_test =
        pipe_2.get_pressure_change_immutable(test_mass_flowrate_100_kg_per_s);
