...
pub fn fluid_mechanics_get_mass_flowrate_from_pressure_drop() {
    ...
    let test_mass_flowrate_from_tutorial_1 = MassRate::new::<kilogram_per_second>(100.0);

    let test_pressure_drop_from_tutorial_1 =
        pipe_1.get_pressure_loss_immutable(test_mass_flowrate_from_tutorial_1);
    ...
    let test_mass_flowrate_for_tutorial_2 =
        pipe_1.get_mass_flowrate_from_pressure_loss_immutable(pressure_loss);
    ...
    let test_mass_flowrate_for_tutorial_2_reverse =
        pipe_1.get_mass_flowrate_from_pressure_loss_immutable(pressure_loss_reverse);
    //
    // so in this case
