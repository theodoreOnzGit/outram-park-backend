use crate::{
    heat_transfer_correlations::nusselt_number_correlations::enums::NusseltCorrelation,
    prelude::beta_testing::FluidArray,
};
...
impl NonInsulatedFluidComponent {
    ...
    pub fn calibrate_nusselt_correlation_for_fluid_within_pipe(
        ...
        let mut fluid_array_local: FluidArray = self.pipe_fluid_array.clone().try_into().unwrap();
