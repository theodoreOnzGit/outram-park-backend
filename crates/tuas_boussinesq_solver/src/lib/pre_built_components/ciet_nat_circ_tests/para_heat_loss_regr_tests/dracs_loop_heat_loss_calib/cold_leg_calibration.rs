...
pub fn cold_leg_regression_set_c1() {
    ...
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.86;
...
pub fn cold_leg_regression_set_c2() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.75;
...
pub fn cold_leg_regression_set_c3() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.29;
...
pub fn cold_leg_regression_set_c4() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.83;
...
pub fn cold_leg_regression_set_c5() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.96;
...
pub fn cold_leg_regression_set_c6() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.60;
...
pub fn cold_leg_regression_set_c7() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.88;
...
pub fn cold_leg_regression_set_c8() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.79;
...
pub fn cold_leg_regression_set_c9() {
    ...
    // regression performed to within 0.05K
    let dhx_tube_bottom_inlet_regression_temperature_degc = 39.54;
...
pub fn dracs_cold_leg_insulation_thickness_calibration_validation_test_v1(
    ...
    let tchx_outlet_temperature =
        ThermodynamicTemperature::new::<degree_celsius>(tchx_outlet_temperature_degc);

    let dhx_tube_bottom_inlet_temperature_set_point = ThermodynamicTemperature::new::<degree_celsius>(
        dhx_tube_bottom_inlet_temperature_set_point_degc,
    );
    ...
    let initial_temperature: ThermodynamicTemperature = dhx_tube_bottom_inlet_temperature_set_point;
    ...
    let mut tchx_outlet_bc = HeatTransferEntity::new_const_temperature_bc(tchx_outlet_temperature);

    let mut dhx_tube_bottom_inlet_bc = HeatTransferEntity::new_adiabatic_bc();
    ...
    while current_simulation_time < max_simulation_time {
        ...
        dhx_tube_bottom_inlet_actual_temperature = {
            let dhx_tube_30a_fluid_arr_clone: FluidArray = dhx_tube_side_30a
                .pipe_fluid_array
                .clone()
                .try_into()
                .unwrap();
            ...
            let dhx_tube_30a_front_single_cv_temperature: ThermodynamicTemperature =
                dhx_tube_30a_fluid_arr_clone.front_single_cv.temperature;
        ...
        static_mixer_60_label_36.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_36a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_37.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_38.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_39.calibrate_insulation_thickness(calibrated_insulation_thickness);

        // link the HTEs up

        static_mixer_60_label_36
            .pipe_fluid_array
            .link_to_back(&mut tchx_outlet_bc, advection_heat_transfer_interaction)
            .unwrap();
