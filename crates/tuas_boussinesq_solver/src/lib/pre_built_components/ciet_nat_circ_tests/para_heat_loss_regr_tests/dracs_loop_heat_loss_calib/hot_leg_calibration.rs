...
pub fn hot_leg_regression_set_c1() {
    ...
    let tchx_inlet_regression_temperature_degc = 51.81;
...
pub fn hot_leg_regression_set_c2() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 54.17;
...
pub fn hot_leg_regression_set_c3() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 55.68;
...
pub fn hot_leg_regression_set_c4() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 58.31;
...
pub fn hot_leg_regression_set_c5() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 60.19;
...
pub fn hot_leg_regression_set_c6() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 61.59;
...
pub fn hot_leg_regression_set_c7() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 63.36;
...
pub fn hot_leg_regression_set_c8() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 65.02;
...
pub fn hot_leg_regression_set_c9() {
    ...
    // regression performed to within 0.05K
    let tchx_inlet_regression_temperature_degc = 66.33;
...
pub fn dracs_hot_leg_insulation_thickness_calibration_validation_test_v1(
    ...
    let dhx_tube_top_outlet_temperature =
        ThermodynamicTemperature::new::<degree_celsius>(dhx_tube_top_outlet_temperature_degc);

    let tchx_inlet_temperature_set_point =
        ThermodynamicTemperature::new::<degree_celsius>(tchx_inlet_temperature_set_point_degc);
    ...
    let initial_temperature: ThermodynamicTemperature = tchx_inlet_temperature_set_point;
    ...
    let mut dhx_tube_top_outlet_bc =
        HeatTransferEntity::new_const_temperature_bc(dhx_tube_top_outlet_temperature);

    let mut tchx_inlet_bc = HeatTransferEntity::new_adiabatic_bc();

    let mut tchx_inlet_actual_temperature: ThermodynamicTemperature = initial_temperature;
    ...
    while current_simulation_time < max_simulation_time {
        ...
        pipe_31a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        static_mixer_61_label_31.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_32.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_33.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_34.calibrate_insulation_thickness(calibrated_insulation_thickness);
        ...
        pipe_34
            .pipe_fluid_array
            .link_to_front(&mut tchx_inlet_bc, advection_heat_transfer_interaction)
            .unwrap();
