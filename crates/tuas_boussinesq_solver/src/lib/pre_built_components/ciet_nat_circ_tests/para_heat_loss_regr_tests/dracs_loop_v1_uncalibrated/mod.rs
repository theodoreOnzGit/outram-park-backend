...
pub fn regression_long_test_uncalibrated_dracs_loop_set_c() {
    ...
    let set_c5 = thread::Builder::new()
        .name("set_c5".to_string())
        .spawn(|| {
            let max_simulation_time_seconds: f64 = 3000.0;
            // expect overprediction of mass flowrates in both loops
            // to about 15%
    ...
    let set_c6 = thread::Builder::new()
        .name("set_c6".to_string())
        .spawn(|| {
            let max_simulation_time_seconds: f64 = 3000.0;
            // expect overprediction of mass flowrates in both loops
            // to about 15%
    ...
    let set_c7 = thread::Builder::new()
        .name("set_c7".to_string())
        .spawn(|| {
            let max_simulation_time_seconds: f64 = 3000.0;
            // expect overprediction of mass flowrates in both loops
            // to about 15%
    ...
    let set_c8 = thread::Builder::new()
        .name("set_c8".to_string())
        .spawn(|| {
            let max_simulation_time_seconds: f64 = 3000.0;
            // expect overprediction of mass flowrates in both loops
            // to about 15%
    ...
    let set_c9 = thread::Builder::new()
        .name("set_c9".to_string())
        .spawn(|| {
            let max_simulation_time_seconds: f64 = 3000.0;
            // expect overprediction of mass flowrates in both loops
            // to about 10%
