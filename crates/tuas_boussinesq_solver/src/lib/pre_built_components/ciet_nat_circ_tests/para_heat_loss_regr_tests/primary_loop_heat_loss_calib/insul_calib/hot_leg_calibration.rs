...
pub fn hot_leg_insulation_thickness_calibration_v1() {
    ...
    let set_c1 = thread::Builder::new()
        ...
        .spawn(|| {
            ...
            let insulation_thickness_cm_for_regression_testing = 0.27;

            // regression is to within +/- 0.1 K
            let dhx_inlet_regression_temperature_degc = dhx_inlet_temperature_set_point_degc;
...
pub fn hot_leg_validation_set_c1() {
    ...
    let dhx_inlet_regression_temperature_degc = 71.17;
...
pub fn hot_leg_validation_set_c2() {
    ...
    let dhx_inlet_regression_temperature_degc = 78.45;
...
pub fn hot_leg_validation_set_c3() {
    ...
    let dhx_inlet_regression_temperature_degc = 83.89;
...
pub fn hot_leg_validation_set_c4() {
    ...
    let dhx_inlet_regression_temperature_degc = 90.84;
...
pub fn hot_leg_validation_set_c5() {
    ...
    let dhx_inlet_regression_temperature_degc = 96.48;
...
pub fn hot_leg_validation_set_c6() {
    ...
    let dhx_inlet_regression_temperature_degc = 101.38;
...
pub fn hot_leg_validation_set_c7() {
    ...
    let dhx_inlet_regression_temperature_degc = 106.41;
...
pub fn hot_leg_validation_set_c8() {
    ...
    let dhx_inlet_regression_temperature_degc = 111.41;
...
pub fn hot_leg_validation_set_c9() {
    ...
    let dhx_inlet_regression_temperature_degc = 115.63;
...
pub fn pri_loop_hot_leg_insulation_thickness_calibration_regression_test_v1(
    ...
    let heater_outlet_temperature =
        ThermodynamicTemperature::new::<degree_celsius>(heater_outlet_temperature_degc);

    let dhx_inlet_temperature_set_point =
        ThermodynamicTemperature::new::<degree_celsius>(dhx_inlet_temperature_set_point_degc);
    ...
    let initial_temperature: ThermodynamicTemperature = dhx_inlet_temperature_set_point;
    ...
    let advection_heat_transfer_interaction: HeatTransferInteractionType =
        HeatTransferInteractionType::new_advection_interaction(
            experimental_primary_mass_flowrate,
    ...
    let mut heater_outlet_bc =
        HeatTransferEntity::new_const_temperature_bc(heater_outlet_temperature);

    let mut dhx_inlet_bc = HeatTransferEntity::new_adiabatic_bc();

    let mut dhx_inlet_actual_temperature: ThermodynamicTemperature = initial_temperature;

    // calculation loop
    while current_simulation_time < max_simulation_time {
        // take the actual outlet temperature
        dhx_inlet_actual_temperature = {
            let static_mixer_21_pipe_fluid_arr_clone: FluidArray = static_mixer_21_label_25
                .pipe_fluid_array
                .clone()
                .try_into()
                .unwrap();
        ...
        calibrated_insulation_thickness = {
            ...
            let set_point_abs_error_deg_celsius = dhx_inlet_temperature_set_point.get::<kelvin>()
            ...
            let mut dimensionless_insulation_thickness: Ratio = pid_controller
            ...
            // unphysical
            let minimum_dimensionless_insulation_thickness = Ratio::new::<ratio>(0.01);
        ...
        heater_top_head_1a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        static_mixer_10_label_2.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_2a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_3.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_4.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_5a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_26.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_25a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        static_mixer_21_label_25.calibrate_insulation_thickness(calibrated_insulation_thickness);

        // link the HTEs up

        heater_top_head_1a
            .pipe_fluid_array
            .link_to_back(&mut heater_outlet_bc, advection_heat_transfer_interaction)
            .unwrap();
        ...
        static_mixer_21_label_25
            .pipe_fluid_array
            .link_to_front(&mut dhx_inlet_bc, advection_heat_transfer_interaction)
            .unwrap();
