...
pub fn cold_leg_regression_set_c1() {
    ...
    let heater_inlet_regression_temperature_degc = 50.55;
...
pub fn cold_leg_regression_set_c2() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 53.91;
...
pub fn cold_leg_validation_set_c3() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 57.00;
...
pub fn cold_leg_validation_set_c4() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 61.16;
...
pub fn cold_leg_validation_set_c5() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 64.25;
...
pub fn cold_leg_validation_set_c6() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 67.07;
...
pub fn cold_leg_validation_set_c7() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 70.36;
...
pub fn cold_leg_validation_set_c8() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 73.16;
...
pub fn cold_leg_validation_set_c9() {
    ...
    // regression performed to within 0.05K
    let heater_inlet_regression_temperature_degc = 76.14;
...
pub fn cold_leg_insulation_thickness_validation_test_v1(
    ...
    let initial_temperature: ThermodynamicTemperature = heater_inlet_temperature_set_point;
    ...
    let mut heater_inlet_bc = HeatTransferEntity::new_adiabatic_bc();

    let mut heater_inlet_actual_temperature: ThermodynamicTemperature = initial_temperature;

    // calculation loop
    while current_simulation_time < max_simulation_time {
        // take the actual outlet temperature
        heater_inlet_actual_temperature = {
            let heater_bottom_head_1b_pipe_fluid_arr_clone: FluidArray = heater_bottom_head_1b
                .pipe_fluid_array
                .clone()
                .try_into()
                .unwrap();
        ...
        calibrated_insulation_thickness = {
            ...
            let set_point_abs_error_deg_celsius = heater_inlet_temperature_set_point
                .get::<kelvin>()
        ...
        static_mixer_20_label_23.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_23a.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_22.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_21.calibrate_insulation_thickness(calibrated_insulation_thickness);
        // note that flowmeter is considered not insulated
        pipe_20.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_19.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_17b.calibrate_insulation_thickness(calibrated_insulation_thickness);
        pipe_18.calibrate_insulation_thickness(calibrated_insulation_thickness);
        heater_bottom_head_1b.calibrate_insulation_thickness(calibrated_insulation_thickness);
        ...
        heater_bottom_head_1b
            .pipe_fluid_array
            .link_to_front(&mut heater_inlet_bc, advection_heat_transfer_interaction)
            .unwrap();
