...
/// CIET Case C1 isolated-DRACS natural-circulation regression, TCHX outlet
/// 40 degC / 313 K band, mesh refined 5 times vs the SAM nodalisation.
...
fn verify_isolated_dhx_sam_solution(
    ...
    let tchx_outlet_temperature_set_point = ThermodynamicTemperature::new::<degree_celsius>(40.0);
    ...
    let mut static_mixer_61_label_31 =
        new_mesh_refined_static_mixer_61_label_31(initial_temperature);
    let mut dhx_tube_side_30b = new_mesh_refined_dhx_tube_side_30b(initial_temperature);
    let mut dhx_tube_side_heat_exchanger_30 =
        new_mesh_refined_isolated_dhx_tube_side_30(initial_temperature);
    ...
    let mut static_mixer_60_label_36 =
        new_mesh_refined_static_mixer_60_label_36(initial_temperature);
    ...
    // fluid mechanics bit
    fn get_dracs_flowrate(dracs_branches: &FluidComponentSuperCollection) -> MassRate {
    ...
    fn calculate_dracs_thermal_hydraulics(
        ...
        {
            // hot branch
            dhx_tube_side_30a.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            dhx_tube_side_heat_exchanger_30.heat_transfer_to_ambient =
                adiabatic_heat_transfer_coeff;
            dhx_tube_side_30b.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;

            static_mixer_61_label_31.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_31a.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;

            pipe_32.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_33.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_34.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;

            // cold branch
            tchx_35a.heat_transfer_to_ambient = tchx_heat_transfer_coeff;
            tchx_35b.heat_transfer_to_ambient = tchx_heat_transfer_coeff;

            static_mixer_60_label_36.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_36a.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            flowmeter_60_37a.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;

            pipe_37.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_38.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
            pipe_39.heat_transfer_to_ambient = adiabatic_heat_transfer_coeff;
        }
        // add lateral heat losses and power through dhx
        {
            ...
            tchx_35a.ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
            tchx_35b.ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    ...
    let mut final_mass_flowrate: MassRate = MassRate::ZERO;
    ...
    while current_simulation_time < max_simulation_time {
        ...
        // fluid first
        //
        let mass_flowrate_absolute: MassRate = dracs_fluid_mechanics_calc_mass_rate(
            &pipe_34,
            &pipe_33,
            &pipe_32,
            &pipe_31a,
        ...
        let mass_flowrate_counter_clockwise = mass_flowrate_absolute;
    ...
    approx::assert_relative_eq!(
        ...
        max_relative = 0.1e-2 // 0.44% is the max error between SAM and analytical
                              // but for mesh refinement, this is regression and I'm making
                              // it much more stringent
    );
    // final assertion
...
///
pub fn new_mesh_refined_pipe_34(
    ...
    let mesh_refined_inner_nodes = 5 * (user_specified_inner_nodes_sam + 2) - 2;
...
///
pub fn new_mesh_refined_pipe_33(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_pipe_32(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
///
pub fn new_mesh_refined_static_mixer_61_label_31(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_pipe_31a(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_dhx_tube_side_30b(
    initial_temperature: ThermodynamicTemperature,
...
///
pub fn new_mesh_refined_isolated_dhx_tube_side_30(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_dhx_tube_side_30a(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
/// has the same loss correlations as the CTAH (horizontal)
///
pub fn new_mesh_refined_ndhx_tchx_vertical_35b(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
/// has the same loss correlations as the CTAH (horizontal)
///
pub fn _new_mesh_refined_ndhx_tchx_vertical_35b_1(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
/// has the same loss correlations as the CTAH (horizontal)
///
pub fn _new_mesh_refined_ndhx_tchx_vertical_35b_2(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_pipe_36a(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_static_mixer_60_label_36(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_pipe_37(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_flowmeter_60_37a(
    initial_temperature: ThermodynamicTemperature,
) -> NonInsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
/// pipe 38
///
pub fn new_mesh_refined_pipe_38(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
...
///
pub fn new_mesh_refined_pipe_39(
    initial_temperature: ThermodynamicTemperature,
) -> InsulatedFluidComponent {
    let ambient_temperature = ThermodynamicTemperature::new::<degree_celsius>(20.0);
    let fluid_pressure = Pressure::new::<atmosphere>(1.0);
