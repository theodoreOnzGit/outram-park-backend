...
pub fn adiabatic_mixing_joint_test_single_cv_only() {
    ...
    let advection_heat_transfer_interaction_pre_joint_cold_data: DataAdvection;
    ...
    let advection_heat_transfer_interaction_pre_joint_hot_data: DataAdvection =
        HeatTransferInteractionType::new_advection_interaction(
            mass_flowrate_inlets,
    ...
    let advection_heat_transfer_interaction_post_joint_data: DataAdvection;
    ...
    while simulation_time < max_time {
        ...
        inlet_pipe_1
            .calculate_advection_interaction_to_front_singular_cv_node(
                &mut mixing_joint_cv,
                advection_heat_transfer_interaction_pre_joint_cold_data,
            )
            .unwrap();
        ...
        outlet_pipe
            .calculate_bc_front_cv_back_advection_non_set_temperature(
                advection_heat_transfer_interaction_post_joint_data,
            )
            .unwrap();
    ...
    let outlet_temp_degc = outlet_pipe_temp.get::<degree_celsius>();
