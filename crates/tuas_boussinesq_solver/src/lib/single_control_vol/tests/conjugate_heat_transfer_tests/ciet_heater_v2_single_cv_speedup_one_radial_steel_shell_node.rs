...
pub fn ciet_heater_v_2_0_test_steady_state_functional_test_v_1_2_one_steel_node() {
    ...
    let calculation_loop = move || {
        ...
        let mut wtr = Writer::from_path(crate::vnv_test_support::vnv_csv_path(
            "ciet_heater_v_2_0_steady_state_one_steel_node.csv",
        ))
        .unwrap();
        ...
        let mut time_wtr = Writer::from_path(crate::vnv_test_support::vnv_csv_path(
            "ciet_heater_v_2_0_steady_state_time_one_steel_node.csv",
        ))
        .unwrap();
        ...
        let mut temp_profile_wtr = Writer::from_path(crate::vnv_test_support::vnv_csv_path(
            "ciet_heater_v_2_0_steady_state_temp_profile_one_steel_node.csv",
        ))
        .unwrap();
        ...
        while current_time_simulation_time <= *max_time_ptr_in_loop {
            ...
            for (index, fluid_node_heat_trf_entity_ptr) in fluid_vec_in_loop.iter_mut().enumerate()
            {
                ...
                // center
                let radial_thickness: Length = (od - id) * 0.5;
                ...
                steel_shell_inner_node_vec_in_loop.iter_mut().enumerate()
            {
                ...
                {
                    node_heater_power = heater_power / fluid_vec_in_loop.len() as f64;
                }
            ...
            // todo:
            {
                ...
                for inner_shell_ptr in steel_shell_inner_node_vec_in_loop.iter_mut() {
                    ...
                    let node_temp: ThermodynamicTemperature =
                        HeatTransferEntity::temperature(inner_shell_ptr).unwrap();
