...
impl SingleCVNode {
    ...
    pub fn calculate_single_cv_node_constant_temperature_conductance(
        ...
        let cv_bc_conductance: ThermalConductance = interaction
        ...
        let bc_temp_minus_cv_temp_kelvin: f64 =
            boundary_condition_temperature.get::<kelvin>() - cv_temperature.get::<kelvin>();

        let bc_temp_mins_cv_temp: TemperatureInterval = TemperatureInterval::new::<
        ...
        //
        let heat_flowrate_from_cv_to_bc: Power = -cv_bc_conductance * bc_temp_mins_cv_temp;
    ...
    pub fn calculate_mesh_stability_conduction_timestep_for_single_node_and_bc(
        ...
        // control volume
        let mut cv_timestep: Time = self.calculate_conduction_timestep()?;
        ...
        match interaction {
            ...
            HeatTransferInteractionType::UserSpecifiedHeatFluxCustomArea(area) => {
                ...
                let time_step_max_based_on_volume_to_area: Time =
                    max_mesh_fourier_number * volume_to_area_ratio * volume_to_area_ratio
                        / cv_alpha;
