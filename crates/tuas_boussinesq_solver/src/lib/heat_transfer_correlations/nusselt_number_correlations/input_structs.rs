...
impl NusseltPrandtlReynoldsData {
    ...
    /// Nu = a + b * Re^c * Pr^d (Pr/Pr_wall)^e
    #[inline]
    pub fn custom_reynolds_prandtl(&self) -> Result<Ratio, TuasLibError> {
    ...
    #[inline]
    pub fn ciet_version_2_heater_uncorrected(&self) -> Result<Ratio, TuasLibError> {
        ...
        let nusselt = Ratio::new::<ratio>(0.04179 * reynolds_power_0_836 * prandtl_power_0_333);
    ...
    #[inline]
    pub fn ciet_version_2_heater_prandtl_corrected(&self) -> Result<Ratio, TuasLibError> {
        ...
        let correction_factor: f64 = prandtl_bulk_to_wall_ratio.get::<ratio>().powf(0.11);
...
impl WakaoData {
    ...
    #[inline]
    pub fn get(&self) -> Result<Ratio, TuasLibError> {
        let reynolds: Ratio = self.reynolds;
        let prandtl_bulk: Ratio = self.prandtl_bulk;
        ...
        let nusselt: Ratio = a + b
            * prandtl_bulk.get::<ratio>().powf(prandtl_power)
...
impl GnielinskiData {
    ...
    /// prandtl number
    #[inline]
    pub fn get_nusselt_for_developing_flow_bulk_fluid_prandtl(
        &self,
        ...
        return Ok(Ratio::new::<ratio>(nusselt_value));
    }
    /// Gnielinski correlation but for developing flows
    ///
    /// suitable for laminar, turbulent and transition flows
    ...
    #[inline]
    pub fn get_nusselt_for_developing_flow(&self) -> Result<Ratio, TuasLibError> {
        let reynolds: Ratio = self.reynolds;
        let prandtl_bulk: Ratio = self.prandtl_bulk;
        let prandtl_wall: Ratio = self.prandtl_wall;
    ...
    #[inline]
    pub fn get_nusselt_for_custom_developing_flow_prandtl_film(
        &self,
    ...
    #[inline]
    pub fn get_nusselt_for_custom_developing_flow_prandtl_bulk(
        &self,
        correlation_coefficient_c: Ratio,
        reynolds_exponent_m: f64,
    ) -> Result<Ratio, TuasLibError> {
