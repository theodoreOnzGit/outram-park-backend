...
impl NusseltCorrelation {
    ...
    pub fn try_get_nusselt(&self) -> Result<Ratio, TuasLibError> {
        let nusselt_number: Ratio = match self {
            ...
            NusseltCorrelation::PipeConstantHeatFluxFullyDeveloped => Ratio::new::<ratio>(4.354),
            NusseltCorrelation::PipeConstantTemperatureFullyDeveloped => Ratio::new::<ratio>(3.66),
            NusseltCorrelation::CIETHeaterVersion2(data) => {
                return data.ciet_version_2_heater_prandtl_corrected();
            }
            NusseltCorrelation::IdealNusseltOneBillion => Ratio::new::<ratio>(1e9_f64),
            NusseltCorrelation::FixedNusselt(value) => *value,
    ...
    pub fn estimate_based_on_prandtl_darcy_and_reynolds_no_wall_correction(
        &self,
        bulk_prandtl_number_input: Ratio,
        darcy_friction_factor: Ratio,
        reynolds_number_input: Ratio,
        ...
        match self {
            ...
            _ => {
                return self.estimate_based_on_prandtl_and_reynolds_no_wall_correction(
                    bulk_prandtl_number_input,
                    reynolds_number_input,
                )
            }
        };
    }
    ...
    #[inline]
    pub fn estimate_based_on_prandtl_and_reynolds_no_wall_correction(
        &self,
        bulk_prandtl_number_input: Ratio,
        reynolds_number_input: Ratio,
    ) -> Result<Ratio, TuasLibError> {
    ...
    pub fn estimate_based_on_prandtl_reynolds_and_wall_correction(
        &self,
        bulk_prandtl_number_input: Ratio,
    ...
    /// bulk prandtl and reynolds number
    /// important for pipe gnielinski type nusseltcorrelations
    pub fn estimate_based_on_prandtl_darcy_and_reynolds_wall_correction(
        &self,
        bulk_prandtl_number_input: Ratio,
        wall_prandtl_number_input: Ratio,
        darcy_friction_factor: Ratio,
        ...
        match self {
            ...
            _ => {
                return self.estimate_based_on_prandtl_reynolds_and_wall_correction(
                    bulk_prandtl_number_input,
                    wall_prandtl_number_input,
                    reynolds_number_input,
                )
            }
        };
