...
impl CIETState {
    ...
    pub fn _set_ctah_pump_pressure(&mut self, ctah_pump_pressure_pascals: f64) {
        let mut user_set_ctah_pump_pressure_pascals = ctah_pump_pressure_pascals;
        ...
        if ctah_pump_pressure_pascals.abs() > max_pump_pressure_pascals {
            ...
            if ctah_pump_pressure_pascals.is_sign_positive() {
                user_set_ctah_pump_pressure_pascals = max_pump_pressure_pascals;
            } else {
                user_set_ctah_pump_pressure_pascals = -max_pump_pressure_pascals;
            }
        }

        self.ctah_pump_pressure_pascals = user_set_ctah_pump_pressure_pascals as f32;
    }
