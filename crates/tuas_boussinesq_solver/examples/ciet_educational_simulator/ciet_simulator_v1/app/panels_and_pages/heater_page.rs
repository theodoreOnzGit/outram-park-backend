    ...
    pub fn ciet_sim_heater_page_graph(&mut self, ui: &mut Ui){
        ...
        egui::ScrollArea::both().show(ui, |ui| {
            ...
            bt11_bt12_temp_plot.show(ui, |plot_ui| {
                plot_ui.line(Line::new("bt11 (heater inlet) temperature deg C", PlotPoints::from(time_bt11_vec.clone())));
                plot_ui.line(Line::new("bt12 (heater outlet) temperature deg C", PlotPoints::from(time_bt12_vec.clone())));
            ...
            power_plot.show(ui, |plot_ui| {
                plot_ui.line(Line::new("Heater Power (kW)", PlotPoints::from(time_heater_power_vec)));
            });
