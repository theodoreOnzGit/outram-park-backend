    ...
    pub fn ciet_sim_ctah_page_graph(&mut self, ui: &mut Ui,){
        ...
        egui::ScrollArea::both().show(ui, |ui| {
            ...
            bt43_bt41_temp_plot.show(ui, |plot_ui| {
                plot_ui.line(Line::new("bt43 (ctah inlet in fwd flow) temperature deg C", PlotPoints::from(time_bt43_vec.clone())));
                plot_ui.line(Line::new("bt41 (ctah outlet in fwd flow) temperature deg C", PlotPoints::from(time_bt41_vec.clone())));


                plot_ui.line(Line::new("bt41 (ctah outlet in fwd flow) set pt deg C", PlotPoints::from(time_bt41_setpt_vec.clone())));
            ...
            power_plot.show(ui, |plot_ui| {
                plot_ui.line(Line::new(
                            "CTAH HTC",
                            PlotPoints::from(time_ctah_htc_vec),
                ));
            });
