use egui::{
    ...
    vec2, Color32, Pos2, Rect, Sense, Stroke, Ui, Vec2,
};
...
pub fn fhr_reactor_vessel_prototype(
    ui: &mut Ui,
    user_rect: egui::Rect,
    ...
    let fhr_core_inlet_coolant_shape =
        PathShape::convex_polygon(core_bottom_inlet_points, coolant_fill, coolant_stroke);
    let fhr_core_mid_coolant_shape =
        PathShape::convex_polygon(core_mid_points, coolant_fill, stroke);
    let fhr_core_top_coolant_shape =
        PathShape::convex_polygon(core_top_points, coolant_fill, coolant_stroke);
    let fhr_core_outlet_coolant_shape =
        PathShape::convex_polygon(core_outlet_points, coolant_fill, coolant_stroke);
    ...
    let left_downcomer_inlet_1_shape =
        PathShape::convex_polygon(downcomer_inlet_left_1_pts, coolant_fill, coolant_stroke);
    let left_downcomer_inlet_2_shape =
        PathShape::convex_polygon(downcomer_inlet_left_2_pts, coolant_fill, coolant_stroke);
    let left_downcomer_mid_shape =
        PathShape::convex_polygon(downcomer_left_mid_pts, coolant_fill, coolant_stroke);
    let left_downcomer_outlet_1_shape =
        PathShape::convex_polygon(downcomer_outlet_left_1_pts, coolant_fill, coolant_stroke);
    let left_downcomer_outlet_2_shape =
        PathShape::convex_polygon(downcomer_outlet_left_2_pts, coolant_fill, coolant_stroke);
    ...
    let right_downcomer_inlet_1_shape =
        PathShape::convex_polygon(downcomer_inlet_right_1_pts, coolant_fill, coolant_stroke);
    let right_downcomer_inlet_2_shape =
        PathShape::convex_polygon(downcomer_inlet_right_2_pts, coolant_fill, coolant_stroke);
    let right_downcomer_mid_shape =
        PathShape::convex_polygon(downcomer_right_mid_pts, coolant_fill, coolant_stroke);
    let right_downcomer_outlet_1_shape =
        PathShape::convex_polygon(downcomer_outlet_right_1_pts, coolant_fill, coolant_stroke);
    let right_downcomer_outlet_2_shape =
        PathShape::convex_polygon(downcomer_outlet_right_2_pts, coolant_fill, coolant_stroke);
    ...
    let cr_left_ref_pt = reflector_curved_edge_top_left + vec2(reactor_half_width_x * 0.15, 0.0);
    ...
    let cr_right_ref_pt = reflector_curved_edge_top_right + vec2(-reactor_half_width_x * 0.15, 0.0);
    ...
    let cr_left_centre = cr_left_ref_pt
        + vec2(
            0.0,
            cr_length * left_control_rod_insertion_frac - cr_length * 0.9,
        );

    let cr_right_centre = cr_right_ref_pt
        + vec2(
            0.0,
            cr_length * right_control_rod_insertion_frac - cr_length * 0.9,
        );
