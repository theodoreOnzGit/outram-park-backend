...
pub fn cram16(a: &DepletionMatrix, n0: &[f64], dt_seconds: f64) -> Vec<f64> {
    ipf_cram(a, n0, dt_seconds, &CRAM16_ALPHA, &CRAM16_THETA, CRAM16_ALPHA0)
}
...
pub fn cram48(a: &DepletionMatrix, n0: &[f64], dt_seconds: f64) -> Vec<f64> {
    ipf_cram(a, n0, dt_seconds, &CRAM48_ALPHA, &CRAM48_THETA, CRAM48_ALPHA0)
}
...
const CRAM16_ALPHA: [Complex64; 8] = [
    Complex64 { re: 5.464930576870210e+3, im: -3.797983575308356e+4 },
    Complex64 { re: 9.045112476907548e+1, im: -1.115537522430261e+3 },
    Complex64 { re: 2.344818070467641e+2, im: -4.228020157070496e+2 },
    Complex64 { re: 9.453304067358312e+1, im: -2.951294291446048e+2 },
    Complex64 { re: 7.283792954673409e+2, im: -1.205646080220011e+5 },
    Complex64 { re: 3.648229059594851e+1, im: -1.155509621409682e+2 },
    Complex64 { re: 2.547321630156819e+1, im: -2.639500283021502e+1 },
    Complex64 { re: 2.394538338734709e+1, im: -5.650522971778156e+0 },
];

/// Order-16 complex poles `c16_theta` (cram.py:120-129), 8 pole-pairs.
const CRAM16_THETA: [Complex64; 8] = [
    Complex64 { re: 3.509103608414918, im: 8.436198985884374 },
    Complex64 { re: 5.948152268951177, im: 3.587457362018322 },
    Complex64 { re: -5.264971343442647, im: 16.22022147316793 },
    Complex64 { re: 1.419375897185666, im: 10.92536348449672 },
    Complex64 { re: 6.416177699099435, im: 1.194122393370139 },
    Complex64 { re: 4.993174737717997, im: 5.996881713603942 },
    Complex64 { re: -1.413928462488886, im: 13.49772569889275 },
    Complex64 { re: -10.84391707869699, im: 19.27744616718165 },
];
...
const CRAM48_THETA: [Complex64; 24] = [
    Complex64 { re: -4.465731934165702e+1, im: 6.233225190695437e+1 },
    Complex64 { re: -5.284616241568964e+0, im: 4.057499381311059e+1 },
    Complex64 { re: -8.867715667624458e+0, im: 4.325515754166724e+1 },
    Complex64 { re: 3.493013124279215e+0, im: 3.281615453173585e+1 },
    Complex64 { re: 1.564102508858634e+1, im: 1.558061616372237e+1 },
    Complex64 { re: 1.742097597385893e+1, im: 1.076629305714420e+1 },
    Complex64 { re: -2.834466755180654e+1, im: 5.492841024648724e+1 },
    Complex64 { re: 1.661569367939544e+1, im: 1.316994930024688e+1 },
    Complex64 { re: 8.011836167974721e+0, im: 2.780232111309410e+1 },
    Complex64 { re: -2.056267541998229e+0, im: 3.794824788914354e+1 },
    Complex64 { re: 1.449208170441839e+1, im: 1.799988210051809e+1 },
    Complex64 { re: 1.853807176907916e+1, im: 5.974332563100539e+0 },
    Complex64 { re: 9.932562704505182e+0, im: 2.532823409972962e+1 },
    Complex64 { re: -2.244223871767187e+1, im: 5.179633600312162e+1 },
    Complex64 { re: 8.590014121680897e-1, im: 3.536456194294350e+1 },
    Complex64 { re: -1.286192925744479e+1, im: 4.600304902833652e+1 },
    Complex64 { re: 1.164596909542055e+1, im: 2.287153304140217e+1 },
    Complex64 { re: 1.806076684783089e+1, im: 8.368200580099821e+0 },
    Complex64 { re: 5.870672154659249e+0, im: 3.029700159040121e+1 },
    Complex64 { re: -3.542938819659747e+1, im: 5.834381701800013e+1 },
    Complex64 { re: 1.901323489060250e+1, im: 1.194282058271408e+0 },
    Complex64 { re: 1.885508331552577e+1, im: 3.583428564427879e+0 },
    Complex64 { re: -1.734689708174982e+1, im: 4.883941101108207e+1 },
    Complex64 { re: 1.316284237125190e+1, im: 2.042951874827759e+1 },
];

/// Order-48 complex residues `c48_alpha = alpha_r + i*alpha_i`
/// (cram.py:169-197), 24 pole-pairs.
const CRAM48_ALPHA: [Complex64; 24] = [
    Complex64 { re: 6.387380733878774e+2, im: -6.743912502859256e+2 },
    Complex64 { re: 1.909896179065730e+2, im: -3.973203432721332e+2 },
    Complex64 { re: 4.236195226571914e+2, im: -2.041233768918671e+3 },
    Complex64 { re: 4.645770595258726e+2, im: -1.652917287299683e+3 },
    Complex64 { re: 7.765163276752433e+2, im: -1.783617639907328e+4 },
    Complex64 { re: 1.907115136768522e+3, im: -5.887068595142284e+4 },
    Complex64 { re: 2.909892685603256e+3, im: -9.953255345514560e+3 },
    Complex64 { re: 1.944772206620450e+2, im: -1.427131226068449e+3 },
    Complex64 { re: 1.382799786972332e+5, im: -3.256885197214938e+6 },
    Complex64 { re: 5.628442079602433e+3, im: -2.924284515884309e+4 },
    Complex64 { re: 2.151681283794220e+2, im: -1.121774011188224e+3 },
    Complex64 { re: 1.324720240514420e+3, im: -6.370088443140973e+4 },
    Complex64 { re: 1.617548476343347e+4, im: -1.008798413156542e+6 },
    Complex64 { re: 1.112729040439685e+2, im: -8.837109731680418e+1 },
    Complex64 { re: 1.074624783191125e+2, im: -1.457246116408180e+2 },
    Complex64 { re: 8.835727765158191e+1, im: -6.388286188419360e+1 },
    Complex64 { re: 9.354078136054179e+1, im: -2.195424319460237e+2 },
    Complex64 { re: 9.418142823531573e+1, im: -6.719055740098035e+2 },
    Complex64 { re: 1.040012390717851e+2, im: -1.693747595553868e+2 },
    Complex64 { re: 6.861882624343235e+1, im: -1.177598523430493e+1 },
    Complex64 { re: 8.766654491283722e+1, im: -4.596464999363902e+3 },
    Complex64 { re: 1.056007619389650e+2, im: -1.738294585524067e+3 },
    Complex64 { re: 7.738987569039419e+1, im: -4.311715386228984e+1 },
    Complex64 { re: 1.041366366475571e+2, im: -2.777743732451969e+2 },
];
