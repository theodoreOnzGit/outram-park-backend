...
# Module `outram_park_fork_cyclus`
...
```
use outram_park_fork_cyclus::comp_math::{add, CompMap};
...
```
use outram_park_fork_cyclus::agent::AgentId;
use outram_park_fork_cyclus::exchange::constraint::CapacityConstraint;
use outram_park_fork_cyclus::exchange::greedy::GreedySolver;
use outram_park_fork_cyclus::exchange::portfolio::{BidPortfolio, RequestPortfolio};
use outram_park_fork_cyclus::exchange::request::{RequestId, DEFAULT_PREF};
use outram_park_fork_cyclus::exchange::translate::ExchangeContext;
use outram_park_fork_cyclus::product::Product;
use outram_park_fork_cyclus::resource::Resource;

# fn main() -> Result<(), outram_park_fork_cyclus::error::CyclusError> {
...
peaker.add_bid(
    outram_park_fork_cyclus::exchange::bid::Bid::new(
...
```
use outram_park_fork_cyclus::toolkit::commodity::{Commodity, CommodityProducer};
