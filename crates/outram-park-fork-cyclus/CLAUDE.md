# CLAUDE.md — `outram-park-fork-cyclus`
...
The maintainer deferred the naming decision. `outram-park-fork-cyclus` follows
...
entry, the `docs/` mirror filename and every `outram_park_fork_cyclus::` path
