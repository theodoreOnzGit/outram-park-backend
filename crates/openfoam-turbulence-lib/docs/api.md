...
# Module `openfoam_turbulence_lib`
...
pub struct LaminarModel {
    pub mesh: std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>,
    // Some fields omitted
}
```
...
| Name | Type | Documentation |
|------|------|---------------|
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
...
pub struct KEpsilon {
    pub mesh: std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>,
    pub k: openfoam_basic_lib::prelude::VolScalarField,
    pub epsilon: openfoam_basic_lib::prelude::VolScalarField,
    pub nu_t: openfoam_basic_lib::prelude::VolScalarField,
    // Some fields omitted
}
```
...
|------|------|---------------|
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
| `k` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent kinetic energy [m²/s²] |
| `epsilon` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent dissipation rate [m²/s³] |
| `nu_t` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent kinematic viscosity ν_t = Cμ k²/ε [m²/s] |
| *private fields* | ... | *Some fields have been omitted* |
...
pub struct KOmega {
    pub mesh: std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>,
    pub k: openfoam_basic_lib::prelude::VolScalarField,
    pub omega: openfoam_basic_lib::prelude::VolScalarField,
    pub nu_t: openfoam_basic_lib::prelude::VolScalarField,
    // Some fields omitted
}
```
...
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
| `k` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent kinetic energy [m²/s²] |
| `omega` | `openfoam_basic_lib::prelude::VolScalarField` | Specific dissipation rate ω [1/s] |
| `nu_t` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent kinematic viscosity ν_t = k/ω [m²/s] |
| *private fields* | ... | *Some fields have been omitted* |
...
pub struct KOmegaSST {
    ...
    pub omega: openfoam_basic_lib::prelude::VolScalarField,
    pub nu_t: openfoam_basic_lib::prelude::VolScalarField,
    pub u: openfoam_basic_lib::prelude::VolVectorField,
    pub phi: openfoam_basic_lib::prelude::SurfaceScalarField,
    pub nu: openfoam_basic_lib::prelude::VolScalarField,
    pub dt: f64,
    pub prt: f64,
    // Some fields omitted
}
...
|------|------|---------------|
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
| `k` | `openfoam_basic_lib::prelude::VolScalarField` |  |
| `omega` | `openfoam_basic_lib::prelude::VolScalarField` |  |
| `nu_t` | `openfoam_basic_lib::prelude::VolScalarField` |  |
| `u` | `openfoam_basic_lib::prelude::VolVectorField` | Velocity field — set by the solver each step before `correct()`. |
| `phi` | `openfoam_basic_lib::prelude::SurfaceScalarField` | Face volumetric flux φ = U·Sf — set by the solver each step. |
| `nu` | `openfoam_basic_lib::prelude::VolScalarField` | Molecular kinematic viscosity ν. |
| `dt` | `f64` | Time step [s]. |
...
pub struct SpalartAllmaras {
    pub mesh: std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>,
    pub nu_tilde: openfoam_basic_lib::prelude::VolScalarField,
    pub nu_t: openfoam_basic_lib::prelude::VolScalarField,
}
```
...
|------|------|---------------|
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
| `nu_tilde` | `openfoam_basic_lib::prelude::VolScalarField` | Working variable ν̃ [m²/s] — NOT equal to ν_t directly. |
| `nu_t` | `openfoam_basic_lib::prelude::VolScalarField` | Turbulent kinematic viscosity ν_t = ν̃ · fv1 [m²/s]. |
...
pub struct Smagorinsky {
    pub mesh: std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>,
    pub nu_sgs: openfoam_basic_lib::prelude::VolScalarField,
    // Some fields omitted
}
```
...
|------|------|---------------|
| `mesh` | `std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>` |  |
| `nu_sgs` | `openfoam_basic_lib::prelude::VolScalarField` | Sub-grid-scale kinematic viscosity ν_sgs [m²/s]. |
| *private fields* | ... | *Some fields have been omitted* |
