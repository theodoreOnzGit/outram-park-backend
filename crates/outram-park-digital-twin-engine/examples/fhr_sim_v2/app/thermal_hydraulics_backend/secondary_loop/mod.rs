...
impl FHRSimulatorApp {
    ...
    pub(crate) fn secondary_loop_single_timestep(
        ...
        let pump_outlet_temperature: ThermodynamicTemperature = feedwater_inlet.temperature;
        ...
        let steam_generator_tube_inlet_enthalpy: AvailableEnergy = feedwater_inlet.enthalpy;
