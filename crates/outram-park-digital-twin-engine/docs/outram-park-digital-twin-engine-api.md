...
#### Struct `DistillationColumnVisual`
...
| Name | Type | Documentation |
|------|------|---------------|
| `stage_temperature_k` | `&'a [f64]` | Per-stage temperature \[K\], stage 0 first (condenser) .. last<br>(reboiler). Drives each tray's colour. |
...
#### Re-export `DistillationColumnVisual`
