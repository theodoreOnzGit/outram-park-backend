...
pub(crate) fn fine_timesteps_proportional_integral_derivative_test() {
    ...
    let mut wtr = pid_controller
        .spawn_writer("fine_timestep_pid_controller_test".to_string())
        .unwrap();
    ...
    let stuff_to_do_in_simulation_loop = move || {
        ...
        let transfer_fn_input = pid_controller
        ...
        measured_output = measurement_delay_block
...
pub(crate) fn proportional_integral_derivative_test() {
    ...
    let mut wtr = pid_controller
        .spawn_writer("demo_pid_controller_test".to_string())
        .unwrap();
...
pub(crate) fn proportional_integral_test() {
    ...
    let mut wtr = pi_controller
        .spawn_writer("demo_pi_controller_test".to_string())
        .unwrap();
...
pub(crate) fn proportional_standalone_feedback_test() {
    ...
    let mut wtr = p_controller
        .spawn_writer("demo_p_controller_test".to_string())
        .unwrap();
    ...
    let stuff_to_do_in_simulation_loop = move || {
        ...
        let transfer_fn_input = p_controller
            .set_user_input_and_calc(set_point_error, current_simulation_time)
            .unwrap();
...
pub(crate) fn integral_controller_ramp_test() {
    ...
    let mut integral_controller: AnalogController =
        IntegralController::new(controller_gain, integral_time)
            .unwrap()
            .into();
    ...
    let mut wtr = integral_controller
        .spawn_writer("demo_ramp_fn".to_string())
        .unwrap();
    ...
    let stuff_to_do_in_simulation_loop = move || {
        ...
        let output = integral_controller
        ...
        let writer_borrow = &mut wtr;
        integral_controller
            .csv_write_values(writer_borrow, current_simulation_time, user_input, output)
            .unwrap();
...
pub(crate) fn derivative_controller_step_test() {
    ...
    let mut wtr = filtered_derivative_controller
        .spawn_writer("demo_filtered_derivative_standalone".to_string())
        .unwrap();
    ...
    let stuff_to_do_in_simulation_loop = move || {
        ...
        let output = filtered_derivative_controller
            .set_user_input_and_calc(user_input, current_simulation_time)
            .unwrap();
...
pub(crate) fn proportional_controller_step_test() {
    ...
    let mut wtr = proportional_controller
        .spawn_writer("openloop_proportional_controller_standalone".to_string())
        .unwrap();
    ...
    let stuff_to_do_in_simulation_loop = move || {
        ...
        let output = proportional_controller
            .set_user_input_and_calc(user_input, current_simulation_time)
            .unwrap();
