...
impl DecayChain {
    ...
    ///
    /// ```
    /// use kaki_bukit::decay::{DecayChain, DecayData};
...
impl UniformTaylor {
    ...
    ///
    /// ```
    /// use kaki_bukit::decay::{UniformTaylor, DEFAULT_TOL};
    /// use petir::linalg::Matrix;
    ///
...
mod tests {
    ...
    ///
    /// ```text
    /// cargo test -p kaki-bukit --release --lib decay::tests::vv_report -- --nocapture
    /// ```
    #[test]
    fn vv_report() {
        use std::println;
