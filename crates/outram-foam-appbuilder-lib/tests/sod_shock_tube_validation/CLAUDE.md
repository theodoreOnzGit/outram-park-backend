...
# Sod Shock Tube V&V — `outram-foam-appbuilder-lib::rho_central_foam`
...
Validate `outram-foam-appbuilder-lib`'s Rust port of OpenFOAM `rhoCentralFoam` (Kurganov-Tadmor
