//! Zaloudek / Saha critical-flow reference states (HEM curves).
//!
//! # Source
//!
//! Digitised (graph-read) Homogeneous-Equilibrium-Model critical-flow curves
//! used throughout this crate's choked-flow verification. **These are read off
//! published HEM curves, not raw experimental points** -- the crate's own
//! `CLAUDE.md` says so explicitly and keeps mass-flux tolerances loose (0.05 on
//! `log10 G`) for exactly that reason.
//!
//! # In-repo source fixture
//!
//! `src/steam_turbine_equations/converging_diverging_nozzles/tests/zaloudek_mass_flux_hom_eqm/in_dome_stagnation.rs`
//! (one `#[test] fn quality_*_in_dome` per throat quality). The sibling
//! `outside_dome_stagnation_subcooled.rs` / `..._superheated.rs` files run the
//! **same** data through a different region filter, so the in-dome file is the
//! single source and nothing is double-counted here.
//!
//! # What the numbers are
//!
//! Each curve fixes a **throat** quality `x_t`; each point on it is
//! `(p_throat_critical_psia, G_crit_lbm_per_s_ft2, h0_btu_it_per_lbm)`.
//!
//! The plottable state is the **throat** state `(p_throat, x_t)` -- a Region-4
//! saturated mixture whose enthalpy/entropy this example computes live from
//! IAPWS-IF97 (`h = h_f(p) + x_t * (h_g(p) - h_f(p))`, and likewise for `s`).
//! The third column is Zaloudek's stagnation enthalpy in BTU(IT)/lbm; the source
//! fixture does not assert on it (it binds it as `_h0_expected_val`), so it is
//! carried here for the CSV export only and is **not** plotted as a state.
...
/// One Zaloudek constant-throat-quality critical-flow curve.
#[derive(Clone, Copy, Debug)]
pub struct ZaloudekQualityCurve {
    /// Name of the `#[test]` function in the source fixture carrying this curve.
    pub test_name: &'static str,
    /// Throat vapour quality `x_t` (dimensionless, 0.0 = bubble point).
    pub throat_quality: f64,
    /// `(p_throat_critical_psia, G_crit_lbm_per_s_ft2, h0_btu_it_per_lbm)`.
    pub points: &'static [(f64, f64, f64)],
}

/// All 21 digitised Zaloudek throat-quality curves.
pub const ZALOUDEK_CURVES: &[ZaloudekQualityCurve] = &[
    ZaloudekQualityCurve {
        test_name: "quality_0_50_in_dome",
        throat_quality: 0.50,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_bubble_point_in_dome",
        throat_quality: 0.0,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_05_in_dome",
        throat_quality: 0.05,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_10_in_dome",
        throat_quality: 0.10,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_15_in_dome",
        throat_quality: 0.15,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_20_in_dome",
        throat_quality: 0.20,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_25_in_dome",
        throat_quality: 0.25,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_30_in_dome",
        throat_quality: 0.30,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_35_in_dome",
        throat_quality: 0.35,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_40_in_dome",
        throat_quality: 0.40,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_45_in_dome",
        throat_quality: 0.45,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_55_in_dome",
        throat_quality: 0.55,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_60_in_dome",
        throat_quality: 0.60,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_65_in_dome",
        throat_quality: 0.65,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_70_in_dome",
        throat_quality: 0.70,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_75_in_dome",
        throat_quality: 0.75,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_80_in_dome",
        throat_quality: 0.80,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_85_in_dome",
        throat_quality: 0.85,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_90_in_dome",
        throat_quality: 0.90,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_0_95_in_dome",
        throat_quality: 0.95,
        points: &[
    ...
    ZaloudekQualityCurve {
        test_name: "quality_1_00_in_dome",
        throat_quality: 1.00,
        points: &[
