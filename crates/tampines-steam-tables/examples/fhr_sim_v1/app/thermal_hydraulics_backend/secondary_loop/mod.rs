...
impl FHRSimulatorApp {
    ...
    pub(crate) fn secondary_loop_single_timestep_steady_state_simplified(
        ...
        //
        let steam_generator_tube_outlet_enthalpy = heat_rate_to_steam_generator_tube
        ...
        let work_done_by_turbine_per_unit_mass = turbine_inlet_enthalpy - turbine_outlet_enthalpy;
