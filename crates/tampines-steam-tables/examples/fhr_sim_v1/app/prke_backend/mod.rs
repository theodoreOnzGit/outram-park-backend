...
use teh_o_prke::{
    feedback_mechanisms::SixFactorFormulaFeedback,
    zero_power_prke::six_group_precursor_prke::SixGroupPRKE,
};
...
impl FHRSimulatorApp {
    ...
    pub fn calculate_prke_loop(fhr_state: Arc<Mutex<FHRState>>) {
        ...
        loop {
            ...
            let time_to_sleep_microseconds: u64 = (prke_timestep.get::<microsecond>()
                - time_taken_for_calculation_loop_microseconds)
                .round()
                .abs() as u64;
    ...
    pub fn calculate_prke_for_one_timestep(
        ...
        if implicit_solver == true {
            let _neutron_pop_and_six_group_precursor_vec = prke_six_group
            ...
            let _neutron_pop_and_six_group_precursor_vec = prke_six_group
                .solve_next_timestep_precursor_concentration_and_neutron_pop_vector_explicit(
                    prke_timestep,
                    reactivity,
                    mean_neutron_time,
                    background_source_rate,
        ...
        let fission_rate: Frequency = fission_rate_density * reactor_volume;
        ...
        let fission_power_instantaneous: Power = power_per_fission * fission_rate;
        ...
        let reactivity_dollars: f64 = (reactivity / beta_delayed_frac_total).get::<ratio>();
