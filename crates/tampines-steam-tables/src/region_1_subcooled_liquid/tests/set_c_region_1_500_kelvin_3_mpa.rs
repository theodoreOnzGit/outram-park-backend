...
use crate::region_1_subcooled_liquid::{
    alpha_v_tp_1, cp_tp_1, cv_tp_1, h_tp_1, kappa_t_tp_1, kappa_tp_1, s_tp_1, u_tp_1, v_tp_1,
    w_tp_1,
};

#[test]
pub fn specific_vol_regression_set_c() {
    let ref_vol_m3_per_kg = 0.120241800e-2;
    let t = ThermodynamicTemperature::new::<kelvin>(500.0);
    let p = Pressure::new::<megapascal>(3.0);

    let specific_vol_test_m3_per_kg = v_tp_1(t, p).get::<cubic_meter_per_kilogram>();
...
pub fn specific_enthalpy_regression_set_c() {
    ...
    let specific_enthalpy_test_kj_per_kg = h_tp_1(t, p).get::<kilojoule_per_kilogram>();
...
pub fn specific_internal_energy_regression_set_c() {
    ...
    let specific_internal_energy_test_kj_per_kg = u_tp_1(t, p).get::<kilojoule_per_kilogram>();
...
pub fn cp_regression_set_c() {
    ...
    let cp_test_kj_per_kg_kelvin = cp_tp_1(t, p).get::<kilojoule_per_kilogram_kelvin>();
...
pub fn cv_regression_set_c() {
    ...
    let cv_test_kj_per_kg_kelvin = cv_tp_1(t, p).get::<kilojoule_per_kilogram_kelvin>();
...
pub fn speed_of_sound_regression_set_c() {
    ...
    let specific_speed_of_sound_test_kj_per_kg_kelvin = w_tp_1(t, p).get::<meter_per_second>();
...
pub fn isentropic_exponent_regression_set_c() {
    ...
    let tested_kappa = kappa_tp_1(t, p).get::<ratio>();
...
pub fn isobaric_cubic_expansion_coeff_regression_set_c() {
    ...
    let tested_alpha_v = alpha_v_tp_1(t, p).get::<per_kelvin>();
...
pub fn isothermal_compressibility_coeff_regression_set_c() {
    ...
    let tested_kappa_t_inverse = kappa_t_tp_1(t, p).recip().get::<megapascal>();
