...
use crate::region_3_single_phase_plus_supercritical_steam::{
    ...
    u_rho_t_3, v_tp_3c, v_tp_3r, v_tp_3s, v_tp_3t, v_tp_3u, v_tp_3x, v_tp_3y, v_tp_3z, w_rho_t_3,
};
...
pub fn region_fwd_eqn_two_phase(
    ...
    let steam_pressure_equal_sat_pressure = ((p / p_sat_reg4).get::<ratio>() - 1.0).abs() < 5e-4;
    ...
    if !temp_above_623_15_k && steam_pressure_equal_sat_pressure && bubble_point {
        return FwdEqnRegion::Region1;
    };
    if !temp_above_623_15_k && steam_pressure_equal_sat_pressure && dew_point {
...
pub fn v_tp_eqm_two_phase(t: ThermodynamicTemperature, p: Pressure, x: f64) -> SpecificVolume {
    ...
    match region {
        ...
        FwdEqnRegion::Region3 => {
            ...
            let near_saturation_line = (p_mpa - sat_pressure_4(t).get::<megapascal>()).abs() < 5e-4;
...
pub fn alpha_v_tp_eqm_two_phase(
    t: ThermodynamicTemperature,
    p: Pressure,
    x: f64,
    ...
    match region {
        ...
        FwdEqnRegion::Region3 => {
            ...
            let alpha_v_saturated =
                steam_quality * alpha_v_vap + (1.0 - steam_quality) * alpha_v_liq;
...
pub fn kappa_t_tp_eqm(t: ThermodynamicTemperature, p: Pressure, x: f64) -> InversePressure {
    ...
    match region {
        ...
        FwdEqnRegion::Region3 => {
            ...
            let kappa_t_saturated =
                steam_quality * kappa_t_vap + (1.0 - steam_quality) * kappa_t_liq;
