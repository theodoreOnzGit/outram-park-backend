...
pub fn region_determination_saturated_steam() {
    ...
    let steam_table: Vec<[f64; 10]> = vec![
        ...
        [
            0.01, 273.16, 0.00611657, 0.00100021, 205.997, 0.00061178, 2500.91, 2500.91, 0.0,
            9.1555,
        ],
        [
...
fn assert_region_sat_point(
    t_deg_c: f64,
    t_kelvin: f64,
    psat_bar: f64,
    _v_liq_m3_per_kg: f64,
    _v_vap_m3_per_kg: f64,
    _h_liq_kj_per_kg: f64,
    _h_vap_kj_per_kg: f64,
    _enthalpy_of_vap_kj_per_kg: f64,
    _s_liq_kj_per_kg_k: f64,
    _s_vap_kj_per_kg_k: f64,
) {
    dbg!(&t_deg_c);
    ...
    let test_reg_sat_water_1 = region_fwd_eqn_two_phase(t, p, x1);
    let test_reg_vle_2 = region_fwd_eqn_two_phase(t, p, x2);
    let test_reg_sat_steam_3 = region_fwd_eqn_two_phase(t, p, x3);
    let test_reg_sat_water_4 = region_fwd_eqn_two_phase(t, p, x4);
    let test_reg_sat_steam_5 = region_fwd_eqn_two_phase(t, p, x5);
    ...
    if t_kelvin <= 623.15 {
        ...
        assert_eq!(reference_region_sat_water, test_reg_sat_water_1);
        assert_eq!(reference_region_vle, test_reg_vle_2);
        assert_eq!(reference_region_sat_steam, test_reg_sat_steam_3);
        assert_eq!(reference_region_sat_water, test_reg_sat_water_4);
        assert_eq!(reference_region_sat_steam, test_reg_sat_steam_5);
