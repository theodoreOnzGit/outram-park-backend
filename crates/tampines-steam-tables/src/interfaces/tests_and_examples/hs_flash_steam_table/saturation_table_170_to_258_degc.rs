...
pub fn saturation_table_170_to_258_degc() {
    ...
    let steam_table: Vec<[f64; 10]> = vec![
        ...
        [
            218.0, 491.15, 22.3187, 0.00118656, 0.0894214, 934.409, 2800.45, 1866.04, 2.4993,
            6.2986,
        ],
        [
            220.0, 493.15, 23.1929, 0.00119016, 0.0861007, 943.642, 2801.05, 1857.41, 2.5178,
            6.2842,
        ],
        [
        ...
        [
            224.0, 497.15, 25.0205, 0.00119752, 0.0798826, 962.185, 2802.05, 1839.87, 2.5548,
            6.2557,
        ],
        [
        ...
        [
            228.0, 501.15, 26.9572, 0.00120512, 0.0741823, 980.839, 2802.76, 1821.93, 2.5917,
            6.2272,
        ],
        [
        ...
        [
            232.0, 505.15, 29.0075, 0.00121297, 0.0689492, 999.609, 2803.18, 1803.57, 2.6285,
            6.1989,
        ],
        [
            234.0, 507.15, 30.0767, 0.00121699, 0.0664936, 1009.04, 2803.27, 1794.23, 2.6469,
            6.1848,
        ],
        [
        ...
        [
            240.0, 513.15, 33.4665, 0.00122946, 0.0597101, 1037.52, 2803.06, 1765.54, 2.7019,
            6.1425,
        ],
        [
        ...
        [
            250.0, 523.15, 39.7594, 0.00125174, 0.0500866, 1085.69, 2801.01, 1715.33, 2.7934,
            6.0722,
        ],
        [
        ...
        [
            254.0, 527.15, 42.5154, 0.00126122, 0.0467386, 1105.22, 2799.56, 1694.34, 2.8299,
            6.0441,
        ],
        [
...
fn assert_hs_flash_high_quality_steam(
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 1e-1);
...
fn assert_hs_flash_low_quality_steam(
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 0.2);
    approx::assert_relative_eq!(t_kelvin, t.get::<kelvin>(), max_relative = 1e-3);
