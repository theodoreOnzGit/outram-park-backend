...
use crate::region_3_single_phase_plus_supercritical_steam::{
    h_rho_t_3, v_tp_3c, v_tp_3r, v_tp_3s, v_tp_3t, v_tp_3u, v_tp_3x, v_tp_3y, v_tp_3z,
};
...
pub fn saturation_table_260_degc_to_350_degc() {
    ...
    let steam_table: Vec<[f64; 10]> = vec![
        [
            260.0, 533.15, 46.9207, 0.00127613, 0.0421755, 1134.83, 2796.64, 1661.82, 2.8847,
            6.0017,
        ],
        [
        ...
        [
            288.0, 561.15, 72.2724, 0.00135928, 0.0264152, 1279.03, 2769.56, 1490.53, 3.1421,
            5.7984,
        ],
        [
        ...
        [
            294.0, 567.15, 78.8502, 0.00138087, 0.0239231, 1311.54, 2760.31, 1448.76, 3.1982,
            5.7526,
        ],
        [
        ...
        [
            298.0, 571.15, 83.4835, 0.00139622, 0.0223924, 1333.61, 2753.33, 1419.72, 3.2358,
            5.7215,
        ],
        [
        ...
        [
            315.0, 588.15, 105.558, 0.00147239, 0.0168557, 1431.63, 2715.08, 1283.45, 3.3994,
            5.5816,
        ],
        [
            320.0, 593.15, 112.839, 0.00149906, 0.0154759, 1462.05, 2700.67, 1238.62, 3.4491,
            5.5373,
        ],
        [
        ...
        [
            340.0, 613.15, 146.002, 0.00163751, 0.0107838, 1594.45, 2622.07, 1027.62, 3.6599,
            5.3359,
        ],
        [
...
fn assert_hs_flash(
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 0.5);
...
fn assert_hs_flash_near_crit(
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 5.0);
    approx::assert_relative_eq!(t_kelvin, t.get::<kelvin>(), max_relative = 1e-2);
