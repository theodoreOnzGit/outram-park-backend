...
pub fn saturation_table_0_to_44_degc() {
    ...
    let steam_table: Vec<[f64; 10]> = vec![
        ...
        [
            1.0, 274.15, 0.00657088, 0.00100015, 192.445, 4.17665, 2502.73, 2498.55, 0.01526,
            9.1291,
        ],
        [
            2.0, 275.15, 0.00705988, 0.00100011, 179.764, 8.3916, 2504.57, 2496.17, 0.030606,
            9.1027,
        ],
        [
        ...
        [
            4.0, 277.15, 0.00813549, 0.00100007, 157.121, 16.8127, 2508.24, 2491.42, 0.061101,
            9.0506,
        ],
        [
            5.0, 278.15, 0.00872575, 0.00100008, 147.017, 21.0194, 2510.07, 2489.05, 0.076252,
            9.0249,
        ],
        [
            6.0, 279.15, 0.00935353, 0.00100011, 137.638, 25.2237, 2511.91, 2486.68, 0.09134,
            8.9994,
        ],
        [
        ...
        [
            10.0, 283.15, 0.0122818, 0.00100035, 106.309, 42.0211, 2519.23, 2477.21, 0.15109,
            8.8998,
        ],
        [
            11.0, 284.15, 0.0131295, 0.00100044, 99.7927, 46.2162, 2521.06, 2474.84, 0.16587,
            8.8755,
        ],
        [
        ...
        [
            13.0, 286.15, 0.0149806, 0.00100067, 88.0698, 54.6024, 2524.71, 2470.11, 0.19528,
            8.8275,
        ],
        [
        ...
        [
            15.0, 288.15, 0.0170574, 0.00100095, 77.8807, 62.9837, 2528.36, 2465.38, 0.22447,
            8.7804,
        ],
        [
        ...
        [
            17.0, 290.15, 0.0193829, 0.00100127, 69.0063, 71.3608, 2532.01, 2460.65, 0.25344,
            8.7341,
        ],
        [
            18.0, 291.15, 0.0206466, 0.00100145, 65.0029, 75.5479, 2533.83, 2458.28, 0.26785,
            8.7112,
        ],
        [
        ...
        [
            25.0, 298.15, 0.0316975, 0.00100301, 43.3414, 104.838, 2546.54, 2441.71, 0.36726,
            8.5568,
        ],
        [
            26.0, 299.15, 0.0336369, 0.00100327, 40.9768, 109.021, 2548.35, 2439.33, 0.38126,
            8.5355,
        ],
        [
            27.0, 300.15, 0.0356789, 0.00100354, 38.7582, 113.202, 2550.16, 2436.96, 0.39521,
            8.5144,
        ],
        [
            28.0, 301.15, 0.0378281, 0.00100382, 36.6754, 117.384, 2551.97, 2434.59, 0.40912,
            8.4934,
        ],
        [
            29.0, 302.15, 0.0400892, 0.00100411, 34.7194, 121.565, 2553.78, 2432.21, 0.42298,
            8.4727,
        ],
        [
            30.0, 303.15, 0.0424669, 0.00100441, 32.8816, 125.745, 2555.58, 2429.84, 0.43679,
            8.4521,
        ],
        [
        ...
        [
            32.0, 305.15, 0.0475925, 0.00100504, 29.5295, 134.106, 2559.19, 2425.08, 0.46428,
            8.4115,
        ],
        [
        ...
        [
            35.0, 308.15, 0.0562862, 0.00100604, 25.2078, 146.645, 2564.58, 2417.94, 0.50517,
            8.3518,
        ],
        [
            36.0, 309.15, 0.0594747, 0.00100639, 23.9318, 150.824, 2566.38, 2415.56, 0.51871,
            8.3323,
        ],
        [
        ...
        [
            38.0, 311.15, 0.0663237, 0.00100712, 21.5954, 159.183, 2569.96, 2410.78, 0.54566,
            8.2936,
        ],
        [
            39.0, 312.15, 0.0699968, 0.00100749, 20.5261, 163.362, 2571.75, 2408.39, 0.55906,
            8.2746,
        ],
        [
        ...
        [
            42.0, 315.15, 0.0820901, 0.00100867, 17.6652, 175.899, 2577.11, 2401.21, 0.59903,
            8.2183,
        ],
        [
            43.0, 316.15, 0.0865026, 0.00100908, 16.8155, 180.079, 2578.89, 2398.82, 0.61227,
            8.1999,
        ],
        [
    ...
    for dataset in steam_table {
        ...
        assert_hs_flash_high_quality_steam(
            t_deg_c,
            t_kelvin,
            psat_bar,
            v_liq_m3_per_kg,
        ...
        assert_hs_flash_low_quality_steam(
            t_deg_c,
            t_kelvin,
            psat_bar,
            v_liq_m3_per_kg,
...
fn assert_hs_flash_high_quality_steam(
    t_deg_c: f64,
    t_kelvin: f64,
    psat_bar: f64,
    v_liq_m3_per_kg: f64,
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 5e-3);
    approx::assert_relative_eq!(t_kelvin, t.get::<kelvin>(), max_relative = 1e-3);
...
fn assert_hs_flash_low_quality_steam(
    t_deg_c: f64,
    t_kelvin: f64,
    psat_bar: f64,
    v_liq_m3_per_kg: f64,
    ...
    approx::assert_abs_diff_eq!(t_deg_c, t.get::<degree_celsius>(), epsilon = 0.1);
    approx::assert_relative_eq!(t_kelvin, t.get::<kelvin>(), max_relative = 1e-3);
