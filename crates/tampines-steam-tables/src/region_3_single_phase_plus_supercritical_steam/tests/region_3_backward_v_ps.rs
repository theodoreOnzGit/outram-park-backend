...
pub fn v3a_ps_test1() {
    ...
    let v_test_m3_per_kg = v_ps_3a(p, s).get::<cubic_meter_per_kilogram>();
...
pub fn v3b_ps_test1() {
    ...
    let v_test_m3_per_kg = v_ps_3b(p, s).get::<cubic_meter_per_kilogram>();
...
pub fn v3_region_a_ps_test1() {
    ...
    let v_test_m3_per_kg = v_ps_3(p, s).get::<cubic_meter_per_kilogram>();
