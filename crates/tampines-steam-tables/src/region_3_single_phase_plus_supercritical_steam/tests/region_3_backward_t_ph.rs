...
use crate::region_3_single_phase_plus_supercritical_steam::{t_ph_3a, t_ph_3b};
#[test]
pub fn t3a_ph_test1() {
    ...
    let t_test_kelvin = t_ph_3a(p, h).get::<kelvin>();
...
pub fn t3b_ph_test1() {
    ...
    let t_test_kelvin = t_ph_3b(p, h).get::<kelvin>();
