...
pub fn ph_3a_3b_boundary() {
    ...
    let h_test_kj_per_kg = h_3a3b_backwards_ph_boundary(p_ref).get::<kilojoule_per_kilogram>();

    approx::assert_relative_eq!(h_ref_kj_per_kg, h_test_kj_per_kg, max_relative = 1e-8);
}
