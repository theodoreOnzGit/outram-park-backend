...
pub fn specific_vol_regression_set_a() {
    ...
    let specific_vol_test_m3_per_kg = v_tp_2(t, p).get::<cubic_meter_per_kilogram>();
...
pub fn specific_enthalpy_regression_set_a() {
    ...
    let specific_enthalpy_test_kj_per_kg = h_tp_2(t, p).get::<kilojoule_per_kilogram>();
...
pub fn specific_internal_energy_regression_set_a() {
    ...
    let specific_internal_energy_test_kj_per_kg = u_tp_2(t, p).get::<kilojoule_per_kilogram>();
...
pub fn cp_regression_set_a() {
    ...
    let cp_test_kj_per_kg_kelvin = cp_tp_2(t, p).get::<kilojoule_per_kilogram_kelvin>();
...
pub fn cv_regression_set_a() {
    ...
    let cv_test_kj_per_kg_kelvin = cv_tp_2(t, p).get::<kilojoule_per_kilogram_kelvin>();
...
pub fn speed_of_sound_regression_set_a() {
    ...
    let specific_speed_of_sound_test_kj_per_kg_kelvin = w_tp_2(t, p).get::<meter_per_second>();
...
pub fn isentropic_exponent_regression_set_a() {
    ...
    let tested_kappa = kappa_tp_2(t, p).get::<ratio>();
...
pub fn isobaric_cubic_expansion_coeff_regression_set_a() {
    ...
    let tested_alpha_v = alpha_v_tp_2(t, p).get::<per_kelvin>();
...
pub fn isothermal_compressibility_coeff_regression_set_a() {
    ...
    let tested_kappa_t_inverse = kappa_t_tp_2(t, p).recip().get::<megapascal>();
