use uom::si::{
    f64::*, force::newton, length::meter, radiant_exposure::joule_per_square_meter,
...
fn surf_tension_unit_test_1() {
    ...
    let sigma_ref = Force::new::<newton>(0.716_859_625e-1) / Length::new::<meter>(1.0);
...
fn surf_tension_unit_test_2() {
    ...
    let sigma_ref = Force::new::<newton>(0.428_914_992e-1) / Length::new::<meter>(1.0);
...
fn surf_tension_unit_test_3() {
    ...
    let sigma_ref = Force::new::<newton>(0.837_561_087e-2) / Length::new::<meter>(1.0);
