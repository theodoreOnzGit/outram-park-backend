...
use uom::si::{
    f64::*, heat_capacity::joule_per_kelvin, mass_density::kilogram_per_cubic_meter,
...
pub fn specific_gas_constant_of_water() -> SpecificHeatCapacity {
    let r = SpecificHeatCapacity::new::<kilojoule_per_kilogram_kelvin>(R_KJ_PER_KG_KELVIN);
