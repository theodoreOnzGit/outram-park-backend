...
pub(crate) fn pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(
    ...
    let degree_of_superheat_kelvin: f64 = delta_t.get::<uom::si::temperature_interval::kelvin>();
...
fn pool_boiling_assert_test_1() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(1.0);
    let expected_fraction_of_max_htc = 0.023629084;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_2() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(5.0);
    let expected_fraction_of_max_htc = 0.032133374;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_3() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(12.0);
    let expected_fraction_of_max_htc = 0.124350868;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_4() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(30.0);
    let expected_fraction_of_max_htc = 1.000846847;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_5() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(100.0);
    let expected_fraction_of_max_htc = 0.023584906;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_6() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(320.0);
    let expected_fraction_of_max_htc = 0.000536758;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_7() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(1000.0);
    let expected_fraction_of_max_htc = 0.006734827;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
...
fn pool_boiling_assert_test_8() {
    let degree_of_superheat_kelvin = TemperatureInterval::new::<kelvin>(2000.0);
    let expected_fraction_of_max_htc = 0.017310593;
    let actual_fraction_of_max_htc =
        pool_boiling_improvised_correlation_as_fraction_of_maximum_lib(degree_of_superheat_kelvin);
