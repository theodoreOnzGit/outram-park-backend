...
use crate::region_1_subcooled_liquid::{v_tp_1, h_tp_1, s_tp_1};
use crate::region_2_vapour::{v_tp_2, h_tp_2, s_tp_2};
...
pub fn w_ps_eqm_region4_kieffer(p: Pressure, s: SpecificHeatCapacity) -> Velocity {
    ...
    let l_plus = h_tp_2(sat_temp_4(p + dp), p + dp) - h_tp_1(sat_temp_4(p + dp), p + dp);
    let l_minus = h_tp_2(sat_temp_4(p - dp), p - dp) - h_tp_1(sat_temp_4(p - dp), p - dp);
    ...
    let bracket = v_mix / l - dh_f_dp / l - eta * dl_dp / l;
