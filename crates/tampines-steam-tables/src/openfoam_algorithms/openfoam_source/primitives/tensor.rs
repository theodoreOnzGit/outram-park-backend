...
impl Tensor {
    ...
    /// Build a tensor from its nine components directly (row-major:
...
// around the identically-named inherent method above (see there for the
// definition); provided so callers can write `tensor::tr(t)` OpenFOAM-style
// as well as `t.tr()`. ---

/// Free-function form of [`Tensor::tr`]: the trace `xx + yy + zz`.
#[inline]
pub fn tr(t: Tensor) -> f64 {
    t.tr()
}

/// Free-function form of [`Tensor::det`]: the determinant.
#[inline]
pub fn det(t: Tensor) -> f64 {
    t.det()
}

/// Free-function form of [`Tensor::inv`]: the matrix inverse.
#[inline]
pub fn inv(t: Tensor) -> Tensor {
    t.inv()
}

/// Free-function form of [`Tensor::symm`]: the symmetric part.
#[inline]
pub fn symm(t: Tensor) -> SymmTensor {
    t.symm()
}

/// Free-function form of [`Tensor::two_symm`]: twice the symmetric part.
#[inline]
pub fn two_symm(t: Tensor) -> SymmTensor {
    t.two_symm()
}

/// Free-function form of [`Tensor::skew`]: the antisymmetric part.
#[inline]
pub fn skew(t: Tensor) -> Tensor {
    t.skew()
}

/// Free-function form of [`Tensor::dev`]: the deviatoric part (`t - tr(t)/3 * I`).
#[inline]
pub fn dev(t: Tensor) -> Tensor {
    t.dev()
}

/// Free-function form of [`Tensor::dev2`]: the "2/3" deviatoric part
/// (`t - 2*tr(t)/3 * I`).
#[inline]
...
/// Free-function form of [`Tensor::dev_symm`]: deviatoric part of the
/// symmetric part.
#[inline]
...
/// Free-function form of [`Tensor::dev_two_symm`]: deviatoric part of twice
/// the symmetric part.
#[inline]
...
/// Free-function form of [`Tensor::lerp`]: linear interpolation `(1-t)*a + t*b`.
#[inline]
