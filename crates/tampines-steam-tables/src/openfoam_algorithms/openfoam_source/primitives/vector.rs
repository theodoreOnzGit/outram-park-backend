...
/// Free-function form of [`Vector3::mag_sqr`]: squared magnitude `|v|²`.
#[inline]
pub fn mag_sqr(v: Vector3) -> f64 {
    v.mag_sqr()
}

/// Free-function form of [`Vector3::mag`]: magnitude `|v|`.
#[inline]
...
/// Free-function form of [`Vector3::lerp`]: linear interpolation `(1-t)*a + t*b`.
#[inline]
