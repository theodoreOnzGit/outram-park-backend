...
# Module `openfoam_appbuilder_lib`
...
```rust
pub fn read_vol_vector_field(path: &std::path::Path, n_cells: usize) -> Result<Vec<openfoam_basic_lib::prelude::Vector3>, crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn read_vol_scalar_field_full(path: &std::path::Path, mesh: &std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>) -> Result<openfoam_basic_lib::prelude::VolScalarField, crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn read_vol_vector_field_full(path: &std::path::Path, mesh: &std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>) -> Result<openfoam_basic_lib::prelude::VolVectorField, crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn write_scalar_field(time_dir: &std::path::Path, field: &openfoam_basic_lib::prelude::VolScalarField, dimensions: &str) -> Result<(), crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn write_vector_field(time_dir: &std::path::Path, field: &openfoam_basic_lib::prelude::VolVectorField, dimensions: &str) -> Result<(), crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn write_vtk(out_path: &std::path::Path, mesh_points: &[[f64; 3]], scalar_fields: &[(&str, &openfoam_basic_lib::prelude::VolScalarField)]) -> Result<(), crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn read_poly_mesh(poly_mesh_dir: &std::path::Path) -> Result<std::sync::Arc<openfoam_basic_lib::prelude::FvMesh>, crate::error::AppBuilderError> { /* ... */ }
```
...
```rust
pub fn parse_boundary(text: &str, file: &str) -> Result<Vec<openfoam_basic_lib::prelude::BoundaryPatch>, crate::error::AppBuilderError> { /* ... */ }
```
