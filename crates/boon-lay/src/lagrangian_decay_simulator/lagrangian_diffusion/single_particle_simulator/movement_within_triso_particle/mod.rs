...
impl SingleParticleDiffusionSimulatorMC {
        ...
        while remaining_timestep > Time::ZERO {
            ...
            if calc_diffusion_timestep {
                ...
                let triso_layer_lengthscale = match region {
                    ...
                    TrisoRegion::Buffer => {
                        triso_cell.get_buffer_radius() - triso_cell.get_fuel_radius()
                    }
                    TrisoRegion::IPyC => {
                        triso_cell.get_ipyc_radius() - triso_cell.get_buffer_radius()
                    }
                ...
                let mut diffusion_scaled_timestep: Time =
                    triso_layer_lengthscale * triso_layer_lengthscale / diffusion_coeff;
    ...
    pub fn scatter_within_triso_particle_gaussian_simple(
        ...
        self.move_particle_gaussian_sampling_f64(jump_distance, no_of_collisions_f64);
    }
