...
This folder already has `porting-history.md` (hand-maintained porting notes) — untouched by this convention; it stays as free-form history alongside any future `code_structure.md`/`latex/` content.
