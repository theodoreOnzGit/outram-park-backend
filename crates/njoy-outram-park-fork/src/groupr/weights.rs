...
const W9: [f64; 106] = [
    ...
    1.478e8, 1.0e-1, 4.0e7, 1.4e-1, 1.13e7, 1.5e-1, 7.6e6, 4.14e-1, 2.79e6, 1.13e0, 1.02e6, 3.06e0,
    3.77e5, 8.32e0, 1.39e5, 2.26e1, 5.11e4, 6.14e1, 1.88e4, 1.67e2, 6.91e3, 4.54e2, 2.54e3,
    1.235e3, 9.35e2, 3.35e3, 3.45e2, 9.12e3, 1.266e2, 2.48e4, 4.65e1, 6.76e4, 1.71e1, 1.84e5,
    6.27e0, 3.03e5, 3.88e0, 5.0e5, 3.6e0, 8.23e5, 2.87e0, 1.353e6, 1.75e0, 1.738e6, 1.13e0,
    2.232e6, 0.73e0, 2.865e6, 0.4e0, 3.68e6, 2.05e-1, 6.07e6, 3.9e-2, 7.79e6, 1.63e-2, 1.0e7,
    6.5e-3, 1.2e7, 7.6e-3, 1.3e7, 1.23e-2, 1.35e7, 2.64e-2, 1.4e7, 1.14e-1, 1.41e7, 1.14e-1,
    1.42e7, 1.01e-1, 1.43e7, 6.5e-2, 1.46e7, 1.49e-2, 1.5e7, 4.0e-3, 1.6e7, 1.54e-3, 1.7e7,
    0.85e-3, 2.0e7, 1.7279e-4,
];
...
mod tests {
    ...
    fn vitamin_e_segments() {
        ...
        check(
            5.0e6,
            1.44934e-9 * 5.0e6_f64.sqrt() * (-5.0e6 / 1.415e6_f64).exp(),
        );
