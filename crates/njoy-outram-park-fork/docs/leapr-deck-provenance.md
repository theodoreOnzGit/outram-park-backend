...
| Companion tapes (**not** embedded; 4 live in the repo-root `reference-data/endf/`, outside `crates/` so `cargo package` cannot sweep them into a tarball) | `tsl-crystalline-graphite.endf` (8,730,804 B), `-10P` (8,724,040 B), `-30P` (8,722,444 B), `tsl-CinSiC.endf` |
