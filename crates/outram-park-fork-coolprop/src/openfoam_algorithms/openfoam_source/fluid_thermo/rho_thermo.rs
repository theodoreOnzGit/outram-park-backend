...
use crate::openfoam_algorithms::openfoam_source::transport::TransportModel;
...
impl<M: TransportModel> RhoThermo<M> {
    ...
    fn transport_field(
        ...
        let boundary = mesh.patches.iter().enumerate().map(|(pi, patch)| {
            ...
            crate::openfoam_algorithms::openfoam_source::boundary::bc::PatchField {
                bc: crate::openfoam_algorithms::openfoam_source::boundary::bc::BoundaryCondition::ZeroGradient,
                values,
            }
        }).collect();
...
mod tests {
    ...
    fn psi_vs_rho_thermo_match() {
        ...
        use crate::openfoam_algorithms::openfoam_source::PsiThermo;
        let m = tiny_mesh();
