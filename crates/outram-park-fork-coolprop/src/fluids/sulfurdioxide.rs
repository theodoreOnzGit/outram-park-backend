...
pub static SULFURDIOXIDE: FluidEos = FluidEos {
    ...
    residual: &[
        ResidualTerm::Power {
            ...
            t: &[
                1.0, 0.45, 0.9994, 1.0, 0.45, 2.907, 2.992, 0.87, 3.302, 1.002,
            ],
        ...
        ResidualTerm::Gaussian {
            ...
            t: &[1.15, 0.997, 1.36, 2.086, 0.855, 0.785],
            d: &[1.0, 1.0, 3.0, 2.0, 2.0, 1.0],
            eta: &[1.061, 0.945, 1.741, 1.139, 1.644, 0.647],
            epsilon: &[0.832, 0.69, 0.35, 0.961, 0.981, 0.333],
            beta: &[0.967, 2.538, 2.758, 1.062, 1.039, 0.41],
            gamma: &[1.276, 0.738, 0.71, 0.997, 1.35, 0.919],
        },
    ],
    ideal: &[
        IdealTerm::Lead {
        ...
        IdealTerm::PlanckEinstein {
            n: &[1.0875, 1.916],
            t: &[1.8182240386401636, 4.328441389559726],
        },
    ],
};
...
pub static SULFURDIOXIDE_ANCILLARIES: FluidAncillaries = FluidAncillaries {
    p_sat: SatAncillary {
        reducing_value: 7886600.0,
        t_r: 430.64,
        using_tau_r: true,
        exponential: true,
        n: &[-7.303, 1.9794, -2.078, -3.5446, 0.51776],
        t: &[1.0, 1.5, 2.2, 4.7, 6.0],
    },
    rho_l: SatAncillary {
        reducing_value: 8078.0,
        t_r: 430.64,
        using_tau_r: false,
        exponential: false,
        n: &[7.2296, -16.928, 29.832, -27.901, 11.085],
        t: &[0.54, 0.88, 1.23, 1.6, 2.0],
    },
    rho_v: SatAncillary {
        reducing_value: 8078.0,
        t_r: 430.64,
