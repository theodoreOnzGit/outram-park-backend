...
pub static CARBONYLSULFIDE: FluidEos = FluidEos {
    ...
    residual: &[ResidualTerm::Power {
        n: &[
            0.94374, -2.5348, 0.59058, -0.021488, 0.082083, 0.00024689, 0.21226, -0.041251,
            -0.22333, -0.050828, -0.028333, 0.016983,
        ],
        t: &[
    ...
    ideal: &[
        ...
        IdealTerm::PlanckEinstein {
            n: &[2.1651, 0.93456, 1.0623, 0.34269],
            t: &[
                2.027615703461204,
                3.59848984872086,
                8.382395649074637,
...
pub static CARBONYLSULFIDE_ANCILLARIES: FluidAncillaries = FluidAncillaries {
    p_sat: SatAncillary {
        ...
        t: &[0.98, 1.966, 3.287, 3.429, 4.051, 18.959],
    },
    rho_l: SatAncillary {
        reducing_value: 7410.0,
        t_r: 378.77,
        using_tau_r: false,
        exponential: false,
        n: &[
            -0.006565517887508687,
            9.861398057771247,
            -49.28678353119856,
            50.765489904412995,
            -18.836456981431365,
        ...
        t: &[0.187, 0.539, 0.811, 0.921, 1.495, 1.774],
    },
    rho_v: SatAncillary {
        reducing_value: 7410.0,
        t_r: 378.77,
        ...
        t: &[0.376, 0.531, 0.641, 0.783, 2.208, 3.625],
    },
};
