...
- **Project:** ONIX
- **Repository:** <https://github.com/jlanversin/ONIX>
- **License:** MIT (**confirmed 2026-08-04** against the cloned `LICENSE` file)
- **Commit at last sync:** `7328dc6acf705827470819a4367ef2a98c642b74` — shallow (`--depth 1`) clone taken 2026-08-04
  for the MSRE digital-twin port (epic `op-6w0`).
- **Clone command:** `git clone --depth 1 https://github.com/jlanversin/ONIX.git upstream_source/ONIX`
...
Upstream is **MIT**, which is GPLv3-compatible; this crate is distributed as
