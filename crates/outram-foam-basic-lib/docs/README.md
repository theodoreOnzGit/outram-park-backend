...
```bash
python3 scripts/gen_api_docs.py outram-foam-basic-lib
```
...
This folder already has `cpp-source-reference.md` and `porting-roadmap.md` (hand-maintained) — untouched by this convention.
