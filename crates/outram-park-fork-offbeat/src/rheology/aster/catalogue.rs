...
// notice.
//
// @generated -- DO NOT EDIT BY HAND. Generated 2026-08-04 from the upstream
// commit above, by a one-shot importer that has since been retired.
//
// HOW THIS WAS GENERATED, AND HOW TO REGENERATE IT
// ------------------------------------------------
// code_aster declares each constitutive law as a `LoiComportement(...)` call in
// `code_aster/Behaviours/*.py`. Those declarations are pure METADATA -- law
// name, `num_lc` dispatch number, state-variable names, supported modelisations
// and deformations, integration algorithms -- with no algorithm in them. That is
// why this registry is generated rather than hand-transcribed: 231 declarations
// copied by hand would drift from upstream silently, and the drift would stay
// invisible until a law dispatched to the wrong number.
//
// The importer walked `<upstream>/code_aster/Behaviours/*.py` (skipping `__*`
// and `cata_comportement.py`), parsed each file with Python's `ast` module,
// collected every `LoiComportement(...)` call, and evaluated its keyword
// arguments with `ast.literal_eval`. **It never imported or executed upstream
// code** -- deliberately, because the upstream tree is read-only reference
// material and executing it would require its dependencies.
//
// To regenerate after an upstream bump: parse those declarations from a
// code_aster checkout and re-emit this file, preserving the header's upstream
// commit, generation date and declaration count. The parse is ~40 lines against
// Python's own AST; doing it in the language the source is written in is the
// sane approach, and the upstream tree is not vendored here in any case.
//
// WHY THE SCRIPT IS GONE. `scripts/gen_aster_behaviour_registry.py` was deleted
// on 2026-08-14 under the workspace's "no Python for documentation or
// accounting" rule. It was a ONE-SHOT IMPORTER whose input -- an external
// code_aster checkout -- is not part of this repository, so it could not be run
// from a clone anyway. Porting it to Rust would have meant writing a Python
// parser for a tool that runs once per upstream bump. The procedure above is
// the record; the provenance that matters (upstream commit, licence, source
// path) is in the header above and is unaffected.
...
impl AsterBehaviour {
    ...
    pub const fn state_variable_names(self) -> &'static [&'static str] {
        match self {
            ...
            Self::Arme => &["DUY"],
            Self::AsseCorn => &[
                "ASSCORN1", "ASSCORN2", "ASSCORN3", "ASSCORN4", "ASSCORN5", "ASSCORN6", "ASSCORN7",
            ],
            Self::Cable => &["VIDE"],
            ...
            Self::CritRupt => &[
                "EPSPVIT", "EDISS", "EDISSCUM", "PDISS", "PDISSCUM", "CRITRUPT",
            ],
            Self::Dashpot => &["VIDE"],
            Self::DdiPlasEndo => &[
                "EPSEDXX", "EPSEDXY", "EPSEDXZ", "EPSEDYY", "EPSEDYZ", "EPSEDZZ",
            ],
            Self::Deborst => &["EPZZ_CP"],
            Self::Dhrc => &[
                "ENDOSUP", "ENDOINF", "GLISXSUP", "GLISYSUP", "GLISXINF", "GLISYINF", "DISSENDO",
                "DISSGLIS", "DISSIP", "ADOUMEMB", "ADOUFLEX",
            ],
            ...
            Self::DisEcroTrac => &[
                "FORCEX", "FORCEY", "FORCEZ", "DEPLX", "DEPLY", "DEPLZ", "DISSTHER", "PCUM",
                "DEPLPX", "DEPLPY", "DEPLPZ", "FORCXX", "FORCXY", "FORCXZ", "RAIDEX", "RAIDEY",
                "RAIDEZ", "PCUMT", "DISSTANG",
            ],
            Self::DisGouj2eElas => &["DIS1"],
            Self::DisGouj2ePlas => &["DIS1", "DIS2"],
            Self::DisGricra => &[
                "DIS1", "DIS2", "DIS3", "DIS4", "DIS5", "DIS6", "DIS7", "IRVECU",
            ],
            ...
            Self::Fondation => &[
                "DASLX", "DASLY", "DASLZ", "DASLRX", "DASLRY", "DACPX", "DACPY", "DACPZ", "DACPRX",
                "DACPRY", "DAQSLX", "DAQSLY", "DAQCPX", "DAQCPY", "DARCP", "DAQCPRX", "DAQCPRY",
                "DAUTRE", "DABSSLX", "DABSSLY", "DABSCPZ",
            ],
            Self::GdefLog => &["TXX", "TYY", "TZZ", "TXY", "TXZ", "TYZ"],
            Self::GlrcDamage => &[
                "EPSP1", "EPSP2", "EPSP3", "KHIP1", "KHIP2", "KHIP3", "DISSIP", "ENDOFL+",
                "ENDOFL-", "DISSENDO", "ANGL1", "ANGL2", "ANGL3", "XMEMB1", "XMEMB2", "XMEMB3",
                "XFLEX1", "XFLEX2", "XFLEX3",
            ],
            Self::GlrcDm => &[
                "ENDOFL+", "ENDOFL-", "INDIEND1", "INDIEND2", "ADOUTRAC", "ADOUCOMP", "ADOUFLEX",
                "ACIXELS", "ACIXELU", "ACIYELS", "ACIYELU", "BETSUP", "BETINF", "TRAMAX", "COMMAX",
                "FLEMAX", "ERRCOM", "ERRFLE",
            ],
            Self::GreenLagrange => &[],
            ...
            Self::JoncEndoPlas => &[
                "ROTATOTA", "ROTAPLAS", "ROTAPLUS", "ROTAMOIN", "XCIN_MZZ", "DISSTOTA", "ENDOPLUS",
                "ENDOMOIN", "INISEUIL",
            ],
            Self::KitCg => &[],
            Self::KitH => &[],
            ...
            Self::KitThv => &[],
            Self::MetaGCine => &[
                "XCINXX", "XCINYY", "XCINZZ", "XCINXY", "XCINXZ", "XCINYZ", "INDIPLAS",
            ],
            Self::MetaGCinePt => &[
                "XCINXX", "XCINYY", "XCINZZ", "XCINXY", "XCINXZ", "XCINYZ", "INDIPLAS",
            ],
            ...
            Self::Pmf => &[],
            Self::ReguViscElas => &[
                "SIVXX", "SIVYY", "SIVZZ", "SIVXY", "SIVXZ", "SIVYZ", "VISCELAS", "VISCDISS",
            ],
            Self::RestEcroCine => &[
                "ECRO_X1", "ECRO_X2", "ECRO_X3", "ECRO_X4", "ECRO_X5", "ECRO_X6",
            ],
            Self::RestEcroEcmi => &[
                "ECRO_EPSEQ",
                "ECRO_X1",
            ...
            Self::VmisCineGc => &[
                "CRITSIG", "CRITEPS", "EPSPEQ", "INDIPLAS", "DISSIP", "DISSTHER", "XCINXX",
            ...
            Self::VmisEcmiLine => &[
                "EPSPEQ", "INDIPLAS", "XCINXX", "XCINYY", "XCINZZ", "XCINXY", "XCINXZ", "XCINYZ",
            ],
            Self::VmisEcmiTrac => &[
                "EPSPEQ", "INDIPLAS", "XCINXX", "XCINYY", "XCINZZ", "XCINXY", "XCINXZ", "XCINYZ",
            ],
            ...
            Self::ViscCin2Memo => &[
                "EPSPEQ", "INDIPLAS", "ALPHAXX", "ALPHAYY", "ALPHAZZ", "ALPHAXY", "ALPHAXZ",
                "ALPHAYZ", "ALPHA2XX", "ALPHA2YY", "ALPHA2ZZ", "ALPHA2XY", "ALPHA2XZ", "ALPHA2YZ",
                "ECROISOT", "MEMOECRO", "KSIXX", "KSIYY", "KSIZZ", "KSIXY", "KSIXZ", "KSIYZ",
                "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ",
            ],
            Self::ViscCin2Nrad => &[
                "EPSPEQ", "INDIPLAS", "ALPHAXX", "ALPHAYY", "ALPHAZZ", "ALPHAXY", "ALPHAXZ",
                "ALPHAYZ", "ALPHA2XX", "ALPHA2YY", "ALPHA2ZZ", "ALPHA2XY", "ALPHA2XZ", "ALPHA2YZ",
            ...
            Self::EndoOrthBeton => &[
                "ENDOXX", "ENDOYY", "ENDOZZ", "ENDOXY", "ENDOXZ", "ENDOYZ", "ENDOCOMP",
            ],
            Self::Mazars => &["ENDO", "INDIENDO", "TEMP_MAX", "EPSEQ"],
            Self::MazarsUnil => &[
                "CRITSIG", "CRITEPS", "ENDO", "EPSEQT", "EPSEQC", "RSIGMA", "TEMP_MAX", "DISSIP",
            ],
            Self::BetonReglePr => &["EPSPEQ"],
            Self::LiquAdGazVape => &["POROSITE", "PVP", "SATLIQ"],
            Self::CzmExpReg => &[
                "SEUILDEP", "INDIDISS", "INDIENDO", "PCENERDI", "DISSIP", "ENEL_RES", "SAUT_N",
                "SAUT_T1", "SAUT_T2",
            ],
            ...
            Self::JointBa => &[
                "ENDONOR", "ENDOTAN", "ECRISOM1", "ECRISOM2", "GLIS", "ECROCINE",
            ],
            Self::KitMeta => &[],
            Self::DruckPrager => &["EPSPEQ", "EPSPVOL", "INDIPLAS"],
            Self::NortonHoff => &["VIDE"],
            Self::ViscTaheri => &[
                "EPSPEQ", "SIGMAPIC", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ",
                "INDIPLAS",
            ],
            Self::ElasHyper => &["VIDE"],
            Self::BetonUmlv => &[
                "ERSP", "EISP", "ERD11", "EID11", "ERD22", "EID22", "ERD33", "EID33", "EFD11",
                "EFD22", "EFD33", "ERD12", "EID12", "ERD23", "EID23", "ERD31", "EID31", "EFD12",
                "EFD23", "EFD31", "ISPH",
            ],
            Self::CamClay => &[
                "PCR", "INDIPLAS", "SIGP", "SIEQ", "EPSPVOL", "EPSPEQ", "INDIVIDE",
            ],
            Self::Cjs => &[
                "SEUILISO", "ANGLEDEV", "XCINXX", "XCINYY", "XCINZZ", "XCINXY", "XCINXZ", "XCINYZ",
                "DISTSDEV", "SDEVCRIT", "DISTSISO", "NBITER", "RESIDU", "NBSSPAS", "SDEVEPSP",
                "INDIPLAS",
            ],
            Self::CorrAcier => &["EPSPEQ", "ENDO", "INDIPLAS"],
            Self::Rankine => &[
                "EPSPVOL", "EPSPEQ", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ",
                "EPSPYZ",
            ],
            Self::BetonGranger => &[
                "VG1", "VG2", "VG3", "VG4", "VG5", "VG6", "VG7", "VG8", "VG9", "VG10", "VG11",
                "VG12", "VG13", "VG14", "VG15", "VG16", "VG17", "VG18", "VG19", "VG20", "VG21",
                "VG22", "VG23", "VG24", "VG25", "VG26", "VG27", "VG28", "VG29", "VG30", "VG31",
            ...
            Self::Irrad3m => &[
                "EPSPEQ", "SEUIL", "EPEQIRRA", "GONF", "INDIPLAS", "IRRA", "TEMP",
            ],
            Self::RoussPr => &["EPSPEQ", "POROSITE", "DISSIP", "EBLOC", "INDIPLAS"],
            Self::RoussVisc => &["EPSPEQ", "POROSITE", "DISSIP", "EBLOC", "INDIPLAS"],
            Self::Vendochab => &[
                "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ", "EPSPEQ", "ECROISOT",
                "ENDO", "INDIPLAS",
            ],
            Self::ViscEndoLema => &[
                "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ", "EPSPEQ", "ECROISOT",
            ...
            Self::Hayhurst => &[
                "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ", "EPSPEQ", "H1", "H2",
                "PHI", "ENDO", "VIDE",
            ],
            Self::Norton => &[
            ...
            Self::Viscochab => &[
                ...
                "VISCHA8", "VISCHA9", "VISCHA10", "VISCHA11", "VISCHA12", "VISCHA13", "VISCHA14",
                "VISCHA15", "VISCHA16", "VISCHA17", "VISCHA18", "VISCHA19", "VISCHA20", "VISCHA21",
                "VISCHA22", "VISCHA23", "VISCHA24", "VISCHA25", "VISCHA26", "VISCHA27", "VISCHA28",
            ],
            ...
            Self::Hujeux => &[
                "FECRDVM1", "FECRDVM2", "FECRDVM3", "FECRISM1", "FECRDVC1", "FECRDVC2", "FECRDVC3",
                "FECRISC1", "HIS9", "HIS10", "HIS11", "HIS12", "HIS13", "HIS14", "HIS15", "HIS16",
                "HIS17", "HIS18", "HIS19", "HIS20", "HIS21", "HIS22", "EPSPVOL", "INDETAM1",
                "INDETAM2", "INDETAM3", "INDETAM4", "INDETAC1", "INDETAC2", "INDETAC3", "INDETAC4",
                "CRITHILL", "DETOPTG", "HIS34", "NBITER", "XHYZ1", "XHYZ2", "THYZ1", "THYZ2",
                "RHYZ", "XHXZ1", "XHXZ2", "THXZ1", "THXZ2", "RHXZ", "XHXY1", "XHXY2", "THXY1",
                "THXY2", "RHYZ",
            ],
            Self::Letk => &[
                "XIP", "GAMMAP", "XIVP", "GAMMAVP", "INDICDIL", "INDIVISC", "INDIPLAS", "DOMAINE",
                "INDIC",
            ],
            Self::EndoIsotBeton => &["ENDO", "INDIENDO"],
            Self::Rousselier => &[
                "EPSPEQ", "POROSITE", "INDIPLAS", "EPSEXX", "EPSEYY", "EPSEZZ", "EPSEXY", "EPSEXZ",
                "EPSEYZ",
            ],
            Self::Sans => &["VIDE"],
            Self::CzmOuvMix => &[
            ...
            Self::DruckPragNA => &[
                "EPSPEQ", "EPSPVOL", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ",
                "EPSPYZ",
            ],
            Self::CzmTacMix => &[
                "SEUILDEP", "INDIDISS", "INDIENDO", "PCENERDI", "DISSIP", "ENEL_RES", "SAUT_N",
            ...
            Self::JointMecaRupt => &[
                "SEUILDEP", "INDIDISS", "INDIENDN", "PCENERDI", "INDIENDT", "PCENDOT", "SAUT_N",
                "SAUT_T1", "SAUT_T2", "EPAISSJO", "SIGN_GLO", "GRADP_X", "GRADP_Y", "GRADP_Z",
                "FH_X", "FH_Y", "FH_Z", "PRESF", "SHIFT_T1", "SHIFT_T2",
            ],
            Self::CzmTuron => &[
                "SAUT_MAX", "VARSEUIL", "VARIENDO", "INDIDISS", "INDIENDO", "SAUT_N", "SAUT_T1",
                "SAUT_T2", "SAUTEQUI", "SAUTTANG", "PCENERDI", "ENERDISS", "MIXITE_S", "MIXITE_G",
                "SAUTINIT", "SAUTRUPT",
            ],
            Self::EndoScalaire => &[
                "ENDO", "INDIENDO", "ENDORIGI", "EPSEXX", "EPSEYY", "EPSEZZ", "EPSEXY", "EPSEXZ",
                "EPSEYZ",
            ],
            Self::EndoHeterogene => &[
                "ENDO", "INDIENDO", "ALEA", "SURF", "ELEP1", "ELEP2", "COMR", "COMPT", "X1", "Y1",
                "X2", "Y2",
            ],
            Self::JointMecaEndo => &[
                "LAMBDA", "INDIPLAS", "DEPPLAS1", "DEPPLAS2", "DEPPLAS3", "ENDO", "SAUT_N",
                "SAUT_T1", "SAUT_T2", "VIDE", "SIGN_GLO", "GRADP_X", "GRADP_Y", "GRADP_Z", "FH_X",
                "FH_Y", "FH_Z", "PRESF", "SIGM_T1", "SIGM_T2",
            ],
            Self::JointMecaFrot => &[
                "LAMBDA", "INDIPLAS", "DEPPLAS1", "DEPPLAS2", "INDIOUV", "SIGT", "SAUT_N",
                "SAUT_T1", "SAUT_T2", "EPAISSJO", "SIGN_GLO", "GRADP_X", "GRADP_Y", "GRADP_Z",
                "FH_X", "FH_Y", "FH_Z", "PRESF",
            ],
            Self::CzmTraMix => &[
                "SEUILDEP", "INDIDISS", "INDIENDO", "PCENERDI", "DISSIP", "ENEL_RES", "SAUT_N",
                "SAUT_T1", "SAUT_T2",
            ...
            Self::ViscIsotPlas => &[],
            Self::Lkr => &[
                "XIP", "GAMMAP", "XIVP", "GAMMAVP", "INDICDIL", "INDIVISC", "INDIPLAS", "EPSVOLME",
                "EPSVOLTH", "EPSPVOL", "EPSVOLVP", "DOMAINE",
            ],
            Self::EndoLocaExp => &["ENDO", "INDIENDO", "ENDORIGI", "ENERTRAC", "ENERCOMP"],
            Self::ViscMaxwell => &["VIDE"],
            Self::Gtn => &[
                "EPSPEQ", "POROSITE", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ",
                "EPSPYZ", "EPCUM", "PORO_NUC", "ENDO", "VIT_ENDO", "SIXX", "SIYY", "SIZZ", "SIXY",
                "SIXZ", "SIYZ", "ENDO_EX", "SIEQ_ERX", "SIEQ_ECR", "SIEQ_VSC", "SIEQ_NLC", "ARRET",
            ],
            Self::ViscGtn => &[
                "EPSPEQ", "POROSITE", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ",
                "EPSPYZ", "EPCUM", "PORO_NUC", "ENDO", "VIT_ENDO", "SIXX", "SIYY", "SIZZ", "SIXY",
            ...
            Self::ViscIsotNl => &[
                "EPSPEQ", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ",
            ],
            Self::VmisIsotNl => &[
                "EPSPEQ", "INDIPLAS", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ",
            ],
            ...
            Self::KicheninNl => &[
                "EPSPEQ", "EPSPXX", "EPSPYY", "EPSPZZ", "EPSPXY", "EPSPXZ", "EPSPYZ", "EPSVEQ",
                "EPVXX", "EPVYY", "EPVZZ", "EPVXY", "EPVXZ", "EPVYZ",
            ],
            Self::CzmFrotMix => &[
                "SAUT_PLAS_T1",
                "SAUT_PLAS_T2",
            ...
            Self::EndoLocaTc => &[
                "ENDO", "ENDOTRAC", "HISTTRAC", "ENERTRAC", "ENDOCOMP", "HISTCOMP", "ENERCOMP",
                "SIGMVISC", "ENDOTOT",
            ],
            ...
            Self::FluaPoroBeton => &[
                "EPE1", "EPE2", "EPE3", "EPE4", "EPE5", "EPE6", "EPK1", "EPK2", "EPK3", "EPK4",
                "EPK5", "EPK6", "EPM1", "EPM2", "EPM3", "EPM4", "EPM5", "EPM6", "SIG1", "SIG2",
                "SIG3", "SIG4", "SIG5", "SIG6", "PHIM", "WELA", "DFLU", "TEPS", "TEPG", "EPT1",
                "EPT2", "EPT3", "EPT4", "EPT5", "EPT6", "EPG1", "EPG2", "EPG3", "EPG4", "EPG5",
                "EPG6", "EPC1", "EPC2", "EPC3", "EPC4", "EPC5", "EPC6", "HYDF", "DTHE", "SKE1",
                "SKE2", "SKE3", "SKE4", "SKE5", "SKE6", "PSHR", "CSHR", "WSHR", "VSHR", "PHIG",
                "PRGI", "AAAR", "ADEF", "PPAS", "BIOG", "BIOW", "EPLC", "EMT1", "EMT2", "EMT3",
                "EMT4", "EMT5", "EMT6", "DSW1", "DSW2", "DSW3", "DSW4", "DSW5", "DSW6", "DTL1",
                "DTL2", "DTL3", "DRL1", "DRL2", "DRL3", "DTG1", "DTG2", "DTG3", "DCG1", "DCG2",
                "DCG3", "WL1", "WL2", "WL3", "DC", "DTPP", "AFT1", "AFM1", "AFT2", "AFM2", "ATIL",
                "STIL", "WID1", "WID2", "WID3", "WID4", "WID5", "WID6", "ERGF", "DT0", "WPL0",
                "DTG0", "DCG0", "PGMAX",
            ],
            Self::EndoPoroBeton => &[
                "EPE1", "EPE2", "EPE3", "EPE4", "EPE5", "EPE6", "EPK1", "EPK2", "EPK3", "EPK4",
            ...
            Self::RgiBetonBa => &[
                ...
                "DCG3", "WL1", "WL2", "WL3", "DC", "DTPP", "AFT1", "AFM1", "AFT2", "AFM2", "ATIL",
                "STIL", "WID1", "WID2", "WID3", "WID4", "WID5", "WID6", "ERGF", "DT0", "WPL0",
                "DTG0", "DCG0", "PGMAX", "EPSIN1", "EPSEQ1", "SNR1", "ERM1", "MUR1", "ERK1",
                "SPR1", "EPSIN2", "EPSEQ2", "SNR2", "ERM2", "MUR2", "ERK2", "SPR2", "EPSIN3",
                "EPSEQ3", "SNR3", "ERM3", "MUR3", "ERK3", "SPR3", "EPSIN4", "EPSEQ4", "SNR4",
                "ERM4", "MUR4", "ERK4", "SPR4", "EPSIN5", "EPSEQ5", "SNR5", "ERM5", "MUR5", "ERK5",
                "SPR5", "SBE1", "SBE2", "SBE3", "SBE4", "SBE5", "SBE6", "SPM1", "SPM2", "SPM3",
            ],
    ...
    pub const fn modelisations(self) -> &'static [&'static str] {
        match self {
            ...
            Self::Hydr => &[
                "KIT_HH", "KIT_HHM", "KIT_HM", "KIT_THHM", "KIT_THH", "KIT_THM", "KIT_THV",
            ],
            Self::HydrEndo => &[
                "KIT_HH", "KIT_HHM", "KIT_HM", "KIT_THHM", "KIT_THH", "KIT_THM", "KIT_THV",
            ],
            ...
            Self::Petit => &[
                "3D", "AXIS", "D_PLAN", "C_PLAN", "1D", "PLAN", "PMF", "GRILLE", "MEMBRANE",
            ],
