# teh-o-prke — notes (read on demand)

Reference material: the planned removal of the `ndarray-linalg` runtime
dependency (a single 7×7 solve), and the 2026-06 OUTRAM PARK consolidation
migration log. Consulted on demand — not per-turn guidance. The crate's purpose,
code layout, and build commands live in CLAUDE.md.
