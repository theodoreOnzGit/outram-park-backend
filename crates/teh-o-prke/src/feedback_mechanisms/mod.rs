...
impl SixFactorFormulaFeedback {
    ...
    pub fn calc_keff(&self) -> Ratio {
        return self.epsilon * self.p_fnl * self.p * self.p_tnl * self.f * self.eta;
    }
    ...
    ///
    pub fn moderator_density_feedback(
        &mut self,
        rho: MassDensity,
    ...
    pub fn reflector_density_feedback(
        &mut self,
        rho: MassDensity,
        mod_void_feedback: fn(MassDensity) -> Ratio,
        resonance_esc_feedback: fn(MassDensity) -> Ratio,
    ...
    pub fn reactor_poison_feedback(
        &mut self,
    ...
    /// it is up to the user to decide to use this for
    /// Xenon, Samarium or some other poison
    pub fn burnable_absorber_posion_feedback(
        &mut self,
    ...
    pub fn fuel_depletion_and_breeding_feedback(
        &mut self,
