...
//! the shader, so the two cannot drift in their 213 coefficients — GSL's
//! single-precision order, where the `f64` order would need 281. See
...
const ATH2: [f32; 17] = [
    ...
    -8.363282288925689e-11, -3.071196075232763e-11,
];
