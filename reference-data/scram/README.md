...
`das9601`'s cut sets are **not** generated by this port — `scram::mocus`
exhausts its expansion ceiling on it. It is kept because its 4,259 products
exercise the quantification layer at a scale nothing else reaches.
